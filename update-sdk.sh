...
# Regenerate the SDK version constant displayed in the frontend, using the
# actual installed version as the source of truth.
INSTALLED_VERSION="$(node -p "require('./node_modules/@windmill-labs/windmill-react-sdk/package.json').version")"
cat > "$SCRIPT_DIR/src/sdkVersion.js" <<EOF
// This file is auto-generated by update-sdk.sh. Do not edit manually.
export const SDK_VERSION = "${INSTALLED_VERSION}";
EOF
