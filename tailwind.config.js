...
const figmaTokens = makeRgb(require("./tokens.json"));
const lightModeName = "light";
const darkModeName = "dark-3";
...
const config = {
  ...
  theme: {
    colors: {
      ...
      "surface-accent-secondary": createColorDefinition(
        "surface-accent-secondary",
      ),
      "surface-accent-secondary-hover": createColorDefinition(
        "surface-accent-secondary-hover",
      ),
      "surface-accent-secondary-clicked": createColorDefinition(
        "surface-accent-secondary-clicked",
      ),
      "surface-accent-selected": createColorDefinition(
      ...
      "surface-secondary-inverse": createColorDefinition(
        "surface-secondary-inverse",
      ),
      "surface-hover-inverse": createColorDefinition("surface-hover-inverse"),
      "surface-disabled-inverse": createColorDefinition(
        "surface-disabled-inverse",
      ),
      "surface-selected-inverse": createColorDefinition(
  ...
  plugins: [
    ...
    plugin(({ addBase, addComponents, addUtilities, theme }) => {
      ...
      addBase({
        ...
        'input:not(.windmillapp):not(.no-default-style),input[type="text"]:not(.windmillapp):not(.no-default-style),input[type="email"]:not(.windmillapp):not(.no-default-style),input[type="url"]:not(.windmillapp):not(.no-default-style),input[type="password"]:not(.windmillapp):not(.no-default-style),input[type="number"]:not(.windmillapp):not(.no-default-style),input[type="date"]:not(.windmillapp):not(.no-default-style),input[type="datetime-local"]:not(.windmillapp):not(.no-default-style),input[type="month"]:not(.windmillapp):not(.no-default-style),input[type="search"]:not(.windmillapp):not(.no-default-style),input[type="tel"]:not(.windmillapp):not(.no-default-style),input[type="time"]:not(.windmillapp):not(.no-default-style),input[type="week"]:not(.windmillapp):not(.no-default-style),textarea:not(.windmillapp):not(.no-default-style):not(.monaco-mouse-cursor-text),select:not(.windmillapp):not(.no-default-style)':
          {
            ...
            "&:disabled,[disabled]": {
              backgroundColor:
                "rgba(var(--color-surface-disabled) / 0.2)" + " !important",
            },
          },
        ...
        input: {
          backgroundColor:
            "rgb(var(--color-surface-secondary) / 30%) !important",
        },
        textarea: {
          backgroundColor:
            "rgb(var(--color-surface-secondary) / 30%) !important",
      ...
      addComponents({
        ...
        ".splitpanes__pane": {
          backgroundColor:
            `rgb(${tokens.light["surface-primary"]})` + " !important",
          overflow: "auto !important",
        },
        ".dark .splitpanes__pane": {
          backgroundColor:
            `rgb(${tokens.dark["surface-primary"]})` + " !important",
          overflow: "auto !important",
        },
        ".splitpanes__splitter": {
          backgroundColor:
            `rgb(${tokens.light["border-light"]})` + " !important",
          margin: "0 !important",
        ...
        ".dark .splitpanes__splitter": {
          backgroundColor:
            `rgb(${tokens.dark["border-light"]})` + " !important",
          "&::after": {
            backgroundColor:
              `rgb(${tokens.dark["border-light"]})` + " !important",
          },
