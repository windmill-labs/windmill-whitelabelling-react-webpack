...
const On = "Canceled";
function Ms(e) {
  return e instanceof Ds ? !0 : e instanceof Error && e.name === On && e.message === On;
}
...
function Rt(e, t, n = 0, i = e.length) {
  let r = n, s = i;
  for (; r < s; ) {
...
function Vn(e, t, n = 0, i = e.length) {
  let r = n, s = i;
  for (; r < s; ) {
    const a = Math.floor((r + s) / 2);
    t(e[a]) ? s = a : r = a + 1;
...
const tt = class tt {
  constructor(t, n) {
    if (this[pi] = "ResourceMap", t instanceof tt)
  ...
  set(t, n) {
    return this.map.set(this.toKey(t), new Vs(t, n)), this;
  }
  get(t) {
    var n;
...
class qs {
  constructor() {
    this[Ni] = "LinkedMap", this._map = /* @__PURE__ */ new Map(), this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0;
  }
  clear() {
...
function zs(e, t = "unexpected state") {
  if (!e)
...
(function(e) {
  ...
  e.length = R;
  function* x(N, T, U = N.length) {
    for (T < -N.length && (T = 0), T < 0 && (T += N.length), U < 0 ? U += N.length : U > N.length && (U = N.length); T < U; T++)
      yield N[T];
  }
  e.slice = x;
  function v(N, T = Number.POSITIVE_INFINITY) {
    const U = [];
    if (T === 0)
      return [U, N];
    const k = N[Symbol.iterator]();
    for (let X = 0; X < T; X++) {
      const te = k.next();
      if (te.done)
        return [U, e.empty()];
...
`)), b = ks([...d].map((A) => r(A)[f]), (A) => A);
        delete b[c[f]];
        for (const [A, R] of Object.entries(b))
          h.unshift(`    - stacktraces of ${R.length} other leaks continue with ${A}`);
        h.unshift(_);
      }
      a += `
...
class Mn {
  ...
  constructor(t) {
    this._now = Zs && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(e) {
  ...
  function n(I) {
    return (M, y = null, P) => {
      ...
      return z = I((J) => {
        if (!V)
          return z ? z.dispose() : V = !0, M.call(y, J);
      }, null, P), V && z.dispose(), z;
    };
  }
  e.once = n;
  function i(I, M) {
  ...
  e.onceIf = i;
  function r(I, M, y) {
    return h((P, V = null, z) => I((J) => P.call(V, M(J)), null, z), y);
  }
  e.map = r;
  function s(I, M, y) {
    return h((P, V = null, z) => I((J) => {
      M(J), P.call(V, J);
    }, null, z), y);
  }
  e.forEach = s;
  function a(I, M, y) {
    return h((P, V = null, z) => I((J) => M(J) && P.call(V, J), null, z), y);
  }
  e.filter = a;
  function u(I) {
    return I;
  ...
  function o(...I) {
    return (M, y = null, P) => {
      const V = Ys(...I.map((z) => z((J) => M.call(y, J))));
      return f(V, P);
    };
  }
  e.any = o;
  ...
  function _(I, M, y = 100, P = !1, V = !1, z, J) {
    let le, me, lt, Jt = 0, Ke;
    const As = {
      leakWarningThreshold: z,
      onWillAddFirstListener() {
        le = I((vs) => {
          Jt++, me = M(me, vs), P && !lt && (Kt.fire(me), me = void 0), Ke = () => {
            const Rs = me;
            me = void 0, lt = void 0, (!P || Jt > 1) && Kt.fire(Rs), Jt = 0;
          }, typeof y == "number" ? (clearTimeout(lt), lt = setTimeout(Ke, y)) : lt === void 0 && (lt = 0, queueMicrotask(Ke));
        });
      },
    ...
    return J == null || J.add(Kt), Kt.event;
  }
  e.debounce = _;
  function p(I, M = 0, y) {
  ...
  function S(I, M, y = (P) => P) {
    const P = (...le) => J.fire(y(...le)), V = () => I.on(M, P), z = () => I.removeListener(M, P), J = new Ae(
      { onWillAddFirstListener: V, onDidRemoveLastListener: z }
    );
    return J.event;
  }
  e.fromNodeEventEmitter = S;
  function N(I, M, y = (P) => P) {
    const P = (...le) => J.fire(y(...le)), V = () => I.addEventListener(M, P), z = () => I.removeEventListener(M, P), J = new Ae(
      { onWillAddFirstListener: V, onDidRemoveLastListener: z }
    );
    return J.event;
  }
  ...
  function Q(I, M) {
    return new te(I, M).emitter.event;
  }
  e.fromObservable = Q;
  function W(I) {
    return (M, y, P) => {
      ...
      const J = {
        ...
        endUpdate() {
          V--, V === 0 && (I.reportChanges(), z && (z = !1, M.call(y)));
        },
      ...
      I.addObserver(J), I.reportChanges();
      const le = {
        dispose() {
          I.removeObserver(J);
        }
      };
      return P instanceof jt ? P.add(le) : Array.isArray(P) && P.push(le), le;
    };
  }
...
class Ae {
  constructor(t) {
    var n, i, r, s;
    this._size = 0, this._options = t, this._leakageMon = (n = this._options) != null && n.leakWarningThreshold ? new Gn(
      (t == null ? void 0 : t.onListenerError) ?? Pt,
      ((i = this._options) == null ? void 0 : i.leakWarningThreshold) ?? Js
    ) : void 0, this._perfMon = (r = this._options) != null && r._profName ? new Wn(this._options._profName) : void 0, this._deliveryQueue = (s = this._options) == null ? void 0 : s.deliveryQueue;
  }
  dispose() {
    var t, n, i, r;
  ...
  get event() {
    return this._event ?? (this._event = (t, n, i) => {
      ...
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(d);
        const b = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], A = new Cs(
          `${d}. HINT: Stack shows most frequent listener (${b[1]}-times)`,
          b[0]
        );
        return (((u = this._options) == null ? void 0 : u.onListenerError) || Pt)(A), Tt.None;
      }
      if (this._disposed)
        return Tt.None;
      n && (t = t.bind(n));
  ...
  _deliver(t, n) {
    ...
    if (!t)
      return;
    const i = ((r = this._options) == null ? void 0 : r.onListenerError) || Pt;
    if (!i) {
      t.value(n);
      return;
    }
  ...
  fire(t) {
    var n, i, r, s;
    if ((n = this._deliveryQueue) != null && n.current && (this._deliverQueue(this._deliveryQueue), (i = this._perfMon) == null || i.stop()), (r = this._perfMon) == null || r.start(this._size), this._listeners) if (this._listeners instanceof Dn)
...
const ra = Kr() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
function xi(e, t) {
  let n;
  ...
  }), ra && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
function H(e, t, ...n) {
  return xi(typeof e == "number" ? sa(e, t) : t, n);
}
function sa(e, t) {
  var i;
  const n = (i = ia()) == null ? void 0 : i[e];
  if (typeof n != "string") {
    if (typeof t == "string")
      return t;
...
const gt = "en";
let Xt = !1, Yt = !1, rn = !1, Cr = !1, fi = !1, es = !1, Ct, sn = gt, Ai = gt, aa, Me;
const qe = globalThis;
let he;
var zr;
typeof qe.vscode < "u" && typeof qe.vscode.process < "u" ? he = qe.vscode.process : typeof process < "u" && typeof ((zr = process == null ? void 0 : process.versions) == null ? void 0 : zr.node) == "string" && (he = process);
var jr;
const la = typeof ((jr = he == null ? void 0 : he.versions) == null ? void 0 : jr.electron) == "string", ua = la && (he == null ? void 0 : he.type) === "renderer";
var Xr;
if (typeof he == "object") {
  Xt = he.platform === "win32", Yt = he.platform === "darwin", rn = he.platform === "linux", rn && he.env.SNAP && he.env.SNAP_REVISION, he.env.CI || he.env.BUILD_ARTIFACTSTAGINGDIRECTORY, Ct = gt, sn = gt;
  const e = he.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      Ct = t.userLocale, Ai = t.osLocale, sn = t.resolvedLanguage || gt, aa = (Xr = t.languagePack) == null ? void 0 : Xr.translationsConfigFile;
    } catch {
    }
  Cr = !0;
} else typeof navigator == "object" && !ua ? (Me = navigator.userAgent, Xt = Me.indexOf("Windows") >= 0, Yt = Me.indexOf("Macintosh") >= 0, es = (Me.indexOf("Macintosh") >= 0 || Me.indexOf("iPad") >= 0 || Me.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, rn = Me.indexOf("Linux") >= 0, (Me == null ? void 0 : Me.indexOf("Mobi")) >= 0, fi = !0, sn = Kr() || gt, Ct = navigator.language.toLowerCase(), Ai = Ct) : console.error("Unable to resolve platform.");
var Et;
(function(e) {
  e[e.Web = 0] = "Web", e[e.Mac = 1] = "Mac", e[e.Linux = 2] = "Linux", e[e.Windows = 3] = "Windows";
})(Et || (Et = {}));
Et.Web;
Yt ? Et.Mac : Xt ? Et.Windows : rn && Et.Linux;
const Ut = Xt, oa = Yt, ca = Cr, ha = fi, fa = fi && typeof qe.importScripts == "function", ma = fa ? qe.origin : void 0, Pe = Me, $e = sn;
var vi;
(function(e) {
  function t() {
    return $e;
...
const ga = typeof qe.postMessage == "function" && !qe.importScripts;
(() => {
  if (ga) {
    const e = [];
...
Yt || es ? Ot.Macintosh : Xt ? Ot.Windows : Ot.Linux;
const _a = !!(Pe && Pe.indexOf("Chrome") >= 0);
Pe && Pe.indexOf("Firefox") >= 0;
!_a && Pe && Pe.indexOf("Safari") >= 0;
Pe && Pe.indexOf("Edg/") >= 0;
Pe && Pe.indexOf("Android") >= 0;
const ts = Object.freeze(function(e, t) {
...
class an {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? ts : (this._emitter || (this._emitter = new Ae()), this._emitter.event);
  }
  dispose() {
...
class wa {
  constructor(t, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof t == "function" ? (this._fn = t, this._computeKey = da) : (this._fn = n, this._computeKey = t.getCacheKey);
  }
  get(t) {
...
function xa(e, t, n = 0, i = e.length, r = 0, s = t.length) {
  for (; n < i && r < s; n++, r++) {
...
function is(e, t, n = 0, i = e.length, r = 0, s = t.length) {
  for (; n < i && r < s; n++, r++) {
    let o = e.charCodeAt(n), c = t.charCodeAt(r);
    if (o === c)
      continue;
    if (o >= 128 || c >= 128)
      return xa(e.toLowerCase(), t.toLowerCase(), n, i, r, s);
    Ui(o) && (o -= 32), Ui(c) && (c -= 32);
    const h = o - c;
    if (h !== 0)
      return h;
...
function Aa(e, t) {
  return e.length === t.length && is(e, t) === 0;
}
function va(e, t) {
  const n = t.length;
  return t.length > e.length ? !1 : is(e, t, 0, n) === 0;
}
function Mi(e, t) {
...
const nt = class nt {
  ...
  getGraphemeBreakType(t) {
    if (t < 32)
      return t === w.LineFeed ? Ce.LF : t === w.CarriageReturn ? Ce.CR : Ce.Control;
    if (t < 127)
      return Ce.Other;
...
const Se = class Se {
  static getInstance(t) {
    return Se.cache.get(Array.from(t));
  }
  static getLocales() {
    return Se._locales.value;
  }
  constructor(t) {
...
Se.ambiguousCharacterData = new Ri(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,1523,96,8242,96,1370,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,118002,50,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,118003,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,118004,52,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,118005,53,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,118006,54,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,118007,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,118008,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,118009,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,117974,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,117975,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71913,67,71922,67,65315,67,8557,67,8450,67,8493,67,117976,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,117977,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,117978,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,117979,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,117980,71,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,117981,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,117983,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,117984,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,118001,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,117982,108,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,117985,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,117986,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,117987,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,118000,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,117988,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,117989,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,117990,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,117991,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,117992,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,117993,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,117994,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,117995,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71910,87,71919,87,117996,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,117997,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,117998,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,71909,90,66293,90,65338,90,8484,90,8488,90,117999,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65283,35,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"cs":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"es":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"fr":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"it":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ja":[8211,45,8218,44,65281,33,8216,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65292,44,65297,49,65307,59],"ko":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pt-BR":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ru":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"zh-hans":[160,32,65374,126,8218,44,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65297,49],"zh-hant":[8211,45,65374,126,8218,44,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89]}')), Se.cache = new wa({ getCacheKey: JSON.stringify }, (t) => {
  ...
  return new Se(c);
}), Se._locales = new Ri(() => Object.keys(Se.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
let Qt = Se;
const it = class it {
  static getRawData() {
  ...
  static containsInvisibleCharacter(t) {
    for (let n = 0; n < t.length; n++) {
      const i = t.codePointAt(n);
      if (typeof i == "number" && (it.isInvisibleCharacter(i) || i === zn.space))
        return !0;
    }
    return !1;
  }
...
it._data = void 0;
let Vt = it;
const kn = "default", ka = "$initialize";
var pe;
(function(e) {
...
class ya {
  ...
  sendMessage(t, n, i) {
    ...
    return new Promise((s, a) => {
      this._pendingReplies[r] = {
        resolve: s,
        reject: a
      }, this._send(new Fa(this._workerId, r, t, n, i));
    });
  }
  listen(t, n, i) {
    let r = null;
    const s = new Ae({
      onWillAddFirstListener: () => {
        r = String(++this._lastSentReq), this._pendingEmitters.set(r, s), this._send(new Sa(this._workerId, r, t, n, i));
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(r), this._send(new Pa(this._workerId, r)), r = null;
      }
    });
    return s.event;
  }
  ...
  createProxyToRemoteChannel(t, n) {
    const i = {
      get: (r, s) => (typeof s == "string" && !r[s] && (ls(s) ? r[s] = (a) => this.listen(t, s, a) : as(s) ? r[s] = this.listen(t, s, void 0) : s.charCodeAt(0) === w.DollarSign && (r[s] = async (...a) => (await (n == null ? void 0 : n()), this.sendMessage(t, s, a)))), r[s])
    };
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.channel, t.method, t.args).then((r) => {
      this._send(new ki(this._workerId, n, r, void 0));
    }, (r) => {
      r.detail instanceof Error && (r.detail = Bn(r.detail)), this._send(new ki(this._workerId, n, void 0, Bn(r)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, i = this._handler.handleEvent(t.channel, t.eventName, t.arg)((r) => {
      this._send(new Ia(this._workerId, n, r));
    });
...
function as(e) {
  return e[0] === "o" && e[1] === "n" && rs(e.charCodeAt(2));
}
function ls(e) {
  return /^onDynamic/.test(e) && rs(e.charCodeAt(9));
}
class Ba {
  constructor(t, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new ya({
      sendMessage: (i, r) => {
        t(i, r);
      },
  ...
  _handleMessage(t, n, i) {
    ...
    const r = t === kn ? this.requestHandler : this._localChannels.get(t);
    if (!r)
...
const Rn = class Rn {
    ...
    for (s !== 0 ? (a = s, u = -1, s = 0) : (a = t.charCodeAt(0), u = 0); ; ) {
      ...
      if (gn(a))
        if (u + 1 < n) {
          ...
          $n(c) ? (u++, o = ss(a, c)) : o = Ee.UNICODE_REPLACEMENT;
        } else {
          s = a;
          break;
        }
      else $n(a) && (o = Ee.UNICODE_REPLACEMENT);
  ...
  digest() {
    return this._finished || (this._finished = !0, this._leftoverHighSurrogate && (this._leftoverHighSurrogate = 0, this._buffLen = this._push(this._buff, this._buffLen, Ee.UNICODE_REPLACEMENT)), this._totalLen += this._buffLen, this._wrapUp()), kt(this._h0) + kt(this._h1) + kt(this._h2) + kt(this._h3) + kt(this._h4);
  }
  _wrapUp() {
  ...
  _step() {
    ...
    for (let f = 0; f < 80; f++)
      f < 20 ? (o = r & s | ~r & a, c = 1518500249) : f < 40 ? (o = r ^ s ^ a, c = 1859775393) : f < 60 ? (o = r & s | r & a | s & a, c = 2400959708) : (o = r ^ s ^ a, c = 3395469782), h = Fn(i, 5) + o + u + c + t.getUint32(f * 4, !1) & 4294967295, u = a, a = s, s = Fn(r, 30), r = i, i = h;
...
function qa(e, t, n) {
  return new Qe(new Ii(e), new Ii(t)).ComputeDiff(n).changes;
}
class ot {
  static Assert(t, n) {
    if (!t)
...
class Qe {
  constructor(t, n, i = null) {
    ...
    const [r, s, a] = Qe._getElements(t), [u, o, c] = Qe._getElements(n);
  ...
  ElementsAreStrictEqual(t, n) {
    if (!this.ElementsAreEqual(t, n))
      return !1;
    const i = Qe._getStrictElement(this._originalSequence, t), r = Qe._getStrictElement(this._modifiedSequence, n);
    return i === r;
  }
  ...
  ComputeDiffRecursive(t, n, i, r, s) {
    ...
    if (t > n || i > r) {
      let f;
      return i <= r ? (ot.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), f = [
        new je(t, 0, i, r - i + 1)
      ]) : t <= n ? (ot.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"), f = [
        new je(t, n - t + 1, i, 0)
      ]) : (ot.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), ot.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"), f = []), f;
    }
  ...
  WALKTRACE(t, n, i, r, s, a, u, o, c, h, f, _, p, d, b, A, R, x) {
    let v = null, S = null, N = new Pi(), T = n, U = i, k = p[0] - A[0] - r, X = Ue.MIN_SAFE_SMALL_INTEGER, te = this.m_forwardHistory.length - 1;
    do {
      const Q = k + t;
      Q === T || Q < U && c[Q - 1] < c[Q + 1] ? (f = c[Q + 1], d = f - k - r, f < X && N.MarkNextChange(), X = f, N.AddModifiedElement(f + 1, d), k = Q + 1 - t) : (f = c[Q - 1] + 1, d = f - k - r, f < X && N.MarkNextChange(), X = f - 1, N.AddOriginalElement(f, d + 1), k = Q - 1 - t), te >= 0 && (c = this.m_forwardHistory[te], t = c[0], T = 1, U = c.length - 1);
    } while (--te >= -1);
    if (v = N.getReverseChanges(), x[0]) {
      let Q = p[0] + 1, W = A[0] + 1;
      if (v !== null && v.length > 0) {
        const I = v[v.length - 1];
        Q = Math.max(Q, I.getOriginalEnd()), W = Math.max(W, I.getModifiedEnd());
      }
      S = [
        new je(
          Q,
      ...
      N = new Pi(), T = a, U = u, k = p[0] - A[0] - o, X = Ue.MAX_SAFE_SMALL_INTEGER, te = R ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const Q = k + s;
        Q === T || Q < U && h[Q - 1] >= h[Q + 1] ? (f = h[Q + 1] - 1, d = f - k - o, f > X && N.MarkNextChange(), X = f + 1, N.AddOriginalElement(f + 1, d + 1), k = Q + 1 - s) : (f = h[Q - 1], d = f - k - o, f > X && N.MarkNextChange(), X = f, N.AddModifiedElement(f + 1, d + 1), k = Q - 1 - s), te >= 0 && (h = this.m_reverseHistory[te], s = h[0], T = 1, U = h.length - 1);
      } while (--te >= -1);
      S = N.getChanges();
    }
  ...
  ComputeRecursionPoint(t, n, i, r, s, a, u) {
    ...
    const d = n - t + (r - i), b = d + 1, A = new Int32Array(b), R = new Int32Array(b), x = r - i, v = n - t, S = t - i, N = n - r, U = (v - x) % 2 === 0;
    A[x] = t, R[v] = n, u[0] = !1;
    for (let k = 1; k <= d / 2 + 1; k++) {
      let X = 0, te = 0;
      h = this.ClipDiagonalBound(x - k, k, x, b), f = this.ClipDiagonalBound(x + k, k, x, b);
      for (let W = h; W <= f; W += 2) {
        W === h || W < f && A[W - 1] < A[W + 1] ? o = A[W + 1] : o = A[W - 1] + 1, c = o - (W - x) - S;
        const I = o;
        for (; o < n && c < r && this.ElementsAreEqual(o + 1, c + 1); )
          o++, c++;
        if (A[W] = o, o + c > X + te && (X = o, te = c), !U && Math.abs(W - v) <= k - 1 && o >= R[W])
          return s[0] = o, a[0] = c, I <= R[W] && Ve.MaxDifferencesHistory > 0 && k <= Ve.MaxDifferencesHistory + 1 ? this.WALKTRACE(x, h, f, S, v, _, p, N, A, R, o, n, s, c, r, a, U, u) : null;
      }
      const Q = (X - t + (te - i) - k) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(X, Q))
        return u[0] = !0, s[0] = X, a[0] = te, Q > 0 && Ve.MaxDifferencesHistory > 0 && k <= Ve.MaxDifferencesHistory + 1 ? this.WALKTRACE(x, h, f, S, v, _, p, N, A, R, o, n, s, c, r, a, U, u) : (t++, i++, [
          new je(
            t,
            n - t + 1,
            i,
      ...
      _ = this.ClipDiagonalBound(v - k, k, v, b), p = this.ClipDiagonalBound(v + k, k, v, b);
      for (let W = _; W <= p; W += 2) {
        W === _ || W < p && R[W - 1] >= R[W + 1] ? o = R[W + 1] - 1 : o = R[W - 1], c = o - (W - v) - N;
        const I = o;
        for (; o > t && c > i && this.ElementsAreEqual(o, c); )
          o--, c--;
        if (R[W] = o, U && Math.abs(W - x) <= k && o <= A[W])
          return s[0] = o, a[0] = c, I >= A[W] && Ve.MaxDifferencesHistory > 0 && k <= Ve.MaxDifferencesHistory + 1 ? this.WALKTRACE(x, h, f, S, v, _, p, N, A, R, o, n, s, c, r, a, U, u) : null;
      }
      if (k <= Ve.MaxDifferencesHistory) {
        let W = new Int32Array(f - h + 2);
        W[0] = x - h + 1, ct.Copy2(A, h, W, 1, f - h + 1), this.m_forwardHistory.push(W), W = new Int32Array(p - _ + 2), W[0] = v - _ + 1, ct.Copy2(R, _, W, 1, p - _ + 1), this.m_reverseHistory.push(W);
      }
    }
    return this.WALKTRACE(x, h, f, S, v, _, p, N, A, R, o, n, s, c, r, a, U, u);
  }
  PrettifyChanges(t) {
    for (let n = 0; n < t.length; n++) {
  ...
  ConcatenateChanges(t, n) {
    ...
    if (this.ChangesOverlap(t[t.length - 1], n[0], i)) {
      ...
      return ct.Copy(t, 0, r, 0, t.length - 1), r[t.length - 1] = i[0], ct.Copy(n, 1, r, t.length, n.length - 1), r;
    } else {
      const r = new Array(t.length + n.length);
      return ct.Copy(t, 0, r, 0, t.length), ct.Copy(n, 0, r, t.length, n.length), r;
    }
  }
...
function $a() {
  return Sn === null && (Sn = new Ga([
    ...
    [O.HTT, w.p, O.HTTP],
    [O.HTT, w.P, O.HTTP],
    [O.HTTP, w.s, O.BeforeColon],
    [O.HTTP, w.S, O.BeforeColon],
    [O.HTTP, w.Colon, O.AfterColon],
    [O.F, w.i, O.FI],
    [O.F, w.I, O.FI],
    [O.FI, w.l, O.FIL],
    [O.FI, w.L, O.FIL],
    [O.FIL, w.e, O.BeforeColon],
    [O.FIL, w.E, O.BeforeColon],
    [O.BeforeColon, w.Colon, O.AfterColon],
    [O.AfterColon, w.Slash, O.AlmostThere],
    [O.AlmostThere, w.Slash, O.End]
  ])), Sn;
}
var C;
(function(e) {
...
function za() {
  if (Ft === null) {
    ...
    const e = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…`;
    for (let n = 0; n < e.length; n++)
      Ft.set(e.charCodeAt(n), C.ForceTermination);
    const t = ".,;:";
    for (let n = 0; n < t.length; n++)
      Ft.set(t.charCodeAt(n), C.CannotEndIn);
  }
  return Ft;
}
class _n {
        ...
        if (_ === O.Accept) {
          ...
          switch (x) {
            case w.OpenParen:
              ...
              break;
            case w.CloseParen:
              v = p ? C.None : C.ForceTermination;
              break;
            case w.OpenSquareBracket:
              b = !0, d = !0, v = C.None;
              break;
            case w.CloseSquareBracket:
              b = !1, v = d ? C.None : C.ForceTermination;
              break;
            case w.OpenCurlyBrace:
              A = !0, v = C.None;
              break;
            case w.CloseCurlyBrace:
              v = A ? C.None : C.ForceTermination;
              break;
            case w.SingleQuote:
            case w.DoubleQuote:
            case w.BackTick:
              f === x ? v = C.ForceTermination : f === w.SingleQuote || f === w.DoubleQuote || f === w.BackTick ? v = C.None : v = C.ForceTermination;
              break;
            case w.Asterisk:
              v = f === w.Asterisk ? C.ForceTermination : C.None;
              break;
            case w.Pipe:
              v = f === w.Pipe ? C.ForceTermination : C.None;
              break;
            case w.Space:
              v = b ? C.None : C.ForceTermination;
              break;
            default:
              v = i.get(x);
          }
          v === C.ForceTermination && (r.push(_n._createLink(i, u, s, h, c)), R = !0);
        } else if (_ === O.End) {
          let v;
          x === w.OpenSquareBracket ? (d = !0, v = C.None) : v = i.get(x), v === C.ForceTermination ? R = !0 : _ = O.Accept;
        } else
          _ = n.nextState(_, x), _ === O.Invalid && (R = !0);
        R && (_ = O.Start, p = !1, d = !1, A = !1, h = c + 1, f = x), c++;
      }
...
const ln = new gi(), Yn = new gi(), Qn = new gi(), Xa = new Array(230), Ya = /* @__PURE__ */ Object.create(null), Qa = /* @__PURE__ */ Object.create(null), Zn = [];
for (let e = 0; e <= g.MAX_VALUE; e++)
  m.DependsOnKbLayout;
for (let e = 0; e <= m.MAX_VALUE; e++)
  Zn[e] = g.DependsOnKbLayout;
(function() {
  const e = "", t = [
  ...
  for (const r of t) {
    ...
    if (i[a] || (i[a] = !0, Ya[u] = a, Qa[u.toLowerCase()] = a, s && o !== m.Unknown && o !== m.Enter && o !== m.Ctrl && o !== m.Shift && o !== m.Alt && o !== m.Meta && (Zn[o] = a)), !n[o]) {
      if (n[o] = !0, !c)
        throw new Error(
          `String representation missing for key code ${o} around scan code ${u}`
        );
      ln.define(o, c), Yn.define(o, _ || c), Qn.define(o, p || _ || c);
    }
    h && (Xa[h] = o);
  }
  Zn[m.Enter] = g.Enter;
...
(function(e) {
  ...
  function r(u) {
    return Qn.keyCodeToStr(u);
  }
  e.toUserSettingsGeneral = r;
  function s(u) {
    return Yn.strToKeyCode(u) || Qn.strToKeyCode(u);
  }
...
let st;
const In = globalThis.vscode;
var Yr;
if (typeof In < "u" && typeof In.process < "u") {
  const e = In.process;
  st = {
    get platform() {
      return e.platform;
...
} else typeof process < "u" && typeof ((Yr = process == null ? void 0 : process.versions) == null ? void 0 : Yr.node) == "string" ? st = {
  get platform() {
  ...
  get platform() {
    return Ut ? "win32" : oa ? "darwin" : "linux";
  },
  get arch() {
  },
  get env() {
...
st.arch;
const Ca = 65, el = 97, tl = 90, nl = 122, at = 46, ue = 47, we = 92, ye = 58, il = 63;
...
const ce = {
    ...
    for (let r = e.length - 1; r >= -1; r--) {
      ...
      if (a === 1)
        ...
        if (c = !0, G(s.charCodeAt(1))) {
          ...
          u = 1;
      else Be(h) && s.charCodeAt(1) === ye && (o = s.slice(0, 2), u = 2, a > 2 && G(s.charCodeAt(2)) && (c = !0, u = 3));
      if (o.length > 0)
        if (t.length > 0) {
  ...
  normalize(e) {
    ...
    if (G(s))
      if (r = !0, G(e.charCodeAt(1))) {
        ...
        n = 1;
    else Be(s) && e.charCodeAt(1) === ye && (i = e.slice(0, 2), n = 2, t > 2 && G(e.charCodeAt(2)) && (r = !0, n = 3));
    let a = n < t ? dn(e.slice(n), !r, "\\", G) : "";
    if (a.length === 0 && !r && (a = "."), a.length > 0 && G(e.charCodeAt(t - 1)) && (a += "\\"), !r && i === void 0 && e.includes(":")) {
      if (a.length >= 2 && Be(a.charCodeAt(0)) && a.charCodeAt(1) === ye)
        return `.\\${a}`;
      let u = e.indexOf(":");
      do
        if (u === t - 1 || G(e.charCodeAt(u + 1)))
          return `.\\${a}`;
  ...
  isAbsolute(e) {
    ...
    return G(n) || t > 2 && Be(n) && e.charCodeAt(1) === ye && G(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
  ...
  relative(e, t) {
    ...
    if (n.length !== e.length || i.length !== t.length) {
      ...
      const A = d.length, R = b.length, x = A < R ? A : R;
      let v;
      for (v = 0; v < x && d[v].toLowerCase() === b[v].toLowerCase(); v++)
        ;
      return v === 0 ? i : v === x ? R > x ? b.slice(v).join("\\") : A > x ? "..\\".repeat(A - 1 - v) + ".." : "" : "..\\".repeat(A - v) + b.slice(v).join("\\");
    }
    let r = 0;
  ...
  toNamespacedPath(e) {
    ...
    } else if (Be(t.charCodeAt(0)) && t.charCodeAt(1) === ye && t.charCodeAt(2) === we)
      return `\\\\?\\${t}`;
    return t;
  },
  dirname(e) {
    ...
    } else Be(r) && e.charCodeAt(1) === ye && (n = t > 2 && G(e.charCodeAt(2)) ? 3 : 2, i = n);
    let s = -1, a = !0;
    for (let u = t - 1; u >= i; --u)
      if (G(e.charCodeAt(u))) {
        if (!a) {
  ...
  basename(e, t) {
    ...
    let n = 0, i = -1, r = !0, s;
    if (e.length >= 2 && Be(e.charCodeAt(0)) && e.charCodeAt(1) === ye && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === ye && Be(e.charCodeAt(0)) && (t = i = 2);
    for (let u = e.length - 1; u >= t; --u) {
      ...
      r === -1 && (s = !1, r = u + 1), o === at ? n === -1 ? n = u : a !== 1 && (a = 1) : n !== -1 && (a = -1);
    }
  ...
  parse(e) {
    ...
    } else if (Be(r) && e.charCodeAt(1) === ye) {
      if (n <= 2)
    ...
    for (; c >= i; --c) {
      ...
      u === -1 && (o = !1, u = c + 1), r === at ? s === -1 ? s = c : h !== 1 && (h = 1) : s !== -1 && (h = -1);
    }
  ...
  resolve(...e) {
    ...
    return t = dn(t, !n, "/", Kn), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (se(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === ue, n = e.charCodeAt(e.length - 1) === ue;
    return e = dn(e, !t, "/", Kn), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
  ...
  parse(e) {
    ...
    for (; o >= i; --o) {
      ...
      a === -1 && (u = !1, a = o + 1), h === at ? r === -1 ? r = o : c !== 1 && (c = 1) : r !== -1 && (c = -1);
    }
    if (a !== -1) {
      const h = s === 0 && n ? 1 : s;
...
ee.win32 = ce.win32 = ce;
ee.posix = ce.posix = ee;
const ll = Fe ? ce.normalize : ee.normalize;
Fe ? ce.isAbsolute : ee.isAbsolute;
const ul = Fe ? ce.join : ee.join, ol = Fe ? ce.resolve : ee.resolve, cl = Fe ? ce.relative : ee.relative, hl = Fe ? ce.dirname : ee.dirname;
Fe ? ce.basename : ee.basename;
Fe ? ce.extname : ee.extname;
Fe ? ce.parse : ee.parse;
const un = Fe ? ce.sep : ee.sep, fl = /^\w[\w\d+.-]*$/, ml = /^\//, gl = /^\/\//;
function _l(e, t) {
  if (!e.scheme && t)
    throw new Error(
...
class oe {
  ...
  constructor(t, n, i, r, s, a = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || K, this.authority = t.authority || K, this.path = t.path || K, this.query = t.query || K, this.fragment = t.fragment || K) : (this.scheme = bl(t, a), this.authority = n || K, this.path = dl(this.scheme, i || K), this.query = r || K, this.fragment = s || K, _l(this, a));
  }
  get fsPath() {
    return wn(this, !1);
  }
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = K), i === void 0 ? i = this.authority : i === null && (i = K), r === void 0 ? r = this.path : r === null && (r = K), s === void 0 ? s = this.query : s === null && (s = K), a === void 0 ? a = this.fragment : a === null && (a = K), n === this.scheme && i === this.authority && r === this.path && s === this.query && a === this.fragment ? this : new ht(n, i, r, s, a);
  }
  static parse(t, n = !1) {
    const i = wl.exec(t);
    return i ? new ht(
  ...
  static joinPath(t, ...n) {
    ...
    let i;
    return Ut && t.scheme === "file" ? i = oe.file(ce.join(wn(t, !0), ...n)).path : i = ee.join(t.path, ...n), t.with({ path: i });
  }
  toString(t = !1) {
    return Cn(this, t);
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new ht(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === cs ? t.fsPath ?? null : null, n;
      }
    } else return t;
  }
...
class ht extends oe {
  ...
  toJSON() {
    ...
    return this._fsPath && (t.fsPath = this._fsPath, t._sep = cs), this._formatted && (t.external = this._formatted), this.path && (t.path = this.path), this.scheme && (t.scheme = this.scheme), this.authority && (t.authority = this.authority), this.query && (t.query = this.query), this.fragment && (t.fragment = this.fragment), t;
  }
}
const hs = {
  [w.Colon]: "%3A",
...
function Ll(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const i = e.charCodeAt(n);
    i === w.Hash || i === w.QuestionMark ? (t === void 0 && (t = e.substr(0, n)), t += hs[i]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function wn(e, t) {
  let n;
  return e.authority && e.path.length > 1 && e.scheme === "file" ? n = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === w.Slash && (e.path.charCodeAt(1) >= w.A && e.path.charCodeAt(1) <= w.Z || e.path.charCodeAt(1) >= w.a && e.path.charCodeAt(1) <= w.z) && e.path.charCodeAt(2) === w.Colon ? t ? n = e.path.substr(1) : n = e.path[1].toLowerCase() + e.path.substr(2) : n = e.path, Ut && (n = n.replace(/\//g, "\\")), n;
}
function Cn(e, t) {
  const n = t ? Ll : Oi;
  ...
  return u && (i += "?", i += n(u, !1, !1)), o && (i += "#", i += t ? o : Oi(o, !1, !1)), i;
}
function fs(e) {
  try {
    return decodeURIComponent(e);
  } catch {
    return e.length > 3 ? e.substr(0, 3) + fs(e.substr(3)) : e;
  }
}
const Vi = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function en(e) {
  return e.match(Vi) ? e.replace(Vi, (t) => fs(t)) : e;
}
var Xe;
(function(e) {
...
(function(e) {
  const t = /* @__PURE__ */ new Map();
  t.set(E.Method, B.symbolMethod), t.set(E.Function, B.symbolFunction), t.set(E.Constructor, B.symbolConstructor), t.set(E.Field, B.symbolField), t.set(E.Variable, B.symbolVariable), t.set(E.Class, B.symbolClass), t.set(E.Struct, B.symbolStruct), t.set(E.Interface, B.symbolInterface), t.set(E.Module, B.symbolModule), t.set(E.Property, B.symbolProperty), t.set(E.Event, B.symbolEvent), t.set(E.Operator, B.symbolOperator), t.set(E.Unit, B.symbolUnit), t.set(E.Value, B.symbolValue), t.set(E.Enum, B.symbolEnum), t.set(E.Constant, B.symbolConstant), t.set(E.Enum, B.symbolEnum), t.set(E.EnumMember, B.symbolEnumMember), t.set(E.Keyword, B.symbolKeyword), t.set(E.Snippet, B.symbolSnippet), t.set(E.Text, B.symbolText), t.set(E.Color, B.symbolColor), t.set(E.File, B.symbolFile), t.set(E.Reference, B.symbolReference), t.set(E.Customcolor, B.symbolCustomColor), t.set(E.Folder, B.symbolFolder), t.set(E.TypeParameter, B.symbolTypeParameter), t.set(E.User, B.account), t.set(E.Issue, B.issues);
  function n(a) {
    let u = t.get(a);
    return u || (console.info("No codicon found for CompletionItemKind " + a), u = B.symbolProperty), u;
  }
  e.toIcon = n;
  function i(a) {
    switch (a) {
      case E.Method:
        return H(763, "Method");
      case E.Function:
        return H(764, "Function");
      case E.Constructor:
        return H(765, "Constructor");
      case E.Field:
        return H(766, "Field");
      case E.Variable:
        return H(767, "Variable");
      case E.Class:
        return H(768, "Class");
      case E.Struct:
        return H(769, "Struct");
      case E.Interface:
        return H(770, "Interface");
      case E.Module:
        return H(771, "Module");
      case E.Property:
        return H(772, "Property");
      case E.Event:
        return H(773, "Event");
      case E.Operator:
        return H(774, "Operator");
      case E.Unit:
        return H(775, "Unit");
      case E.Value:
        return H(776, "Value");
      case E.Constant:
        return H(777, "Constant");
      case E.Enum:
        return H(778, "Enum");
      case E.EnumMember:
        return H(779, "Enum Member");
      case E.Keyword:
        return H(780, "Keyword");
      case E.Text:
        return H(781, "Text");
      case E.Color:
        return H(782, "Color");
      case E.File:
        return H(783, "File");
      case E.Reference:
        return H(784, "Reference");
      case E.Customcolor:
        return H(785, "Custom Color");
      case E.Folder:
        return H(786, "Folder");
      case E.TypeParameter:
        return H(787, "Type Parameter");
      case E.User:
        return H(788, "User");
      case E.Issue:
        return H(789, "Issue");
      case E.Snippet:
        return H(790, "Snippet");
      default:
        return "";
    }
  }
  ...
  r.set("method", E.Method), r.set("function", E.Function), r.set("constructor", E.Constructor), r.set("field", E.Field), r.set("variable", E.Variable), r.set("class", E.Class), r.set("struct", E.Struct), r.set("interface", E.Interface), r.set("module", E.Module), r.set("property", E.Property), r.set("event", E.Event), r.set("operator", E.Operator), r.set("unit", E.Unit), r.set("value", E.Value), r.set("constant", E.Constant), r.set("enum", E.Enum), r.set("enum-member", E.EnumMember), r.set("enumMember", E.EnumMember), r.set("keyword", E.Keyword), r.set("snippet", E.Snippet), r.set("text", E.Text), r.set("color", E.Color), r.set("file", E.File), r.set("reference", E.Reference), r.set("customcolor", E.Customcolor), r.set("folder", E.Folder), r.set("type-parameter", E.TypeParameter), r.set("typeParameter", E.TypeParameter), r.set("account", E.User), r.set("issue", E.Issue);
  function s(a, u) {
    let o = r.get(a);
    return typeof o > "u" && !u && (o = E.Property), o;
  }
  e.fromString = s;
})(ji || (ji = {}));
var Xi;
...
D.Array + "", H(791, "array"), D.Boolean + "", H(792, "boolean"), D.Class + "", H(793, "class"), D.Constant + "", H(794, "constant"), D.Constructor + "", H(795, "constructor"), D.Enum + "", H(796, "enumeration"), D.EnumMember + "", H(797, "enumeration member"), D.Event + "", H(798, "event"), D.Field + "", H(799, "field"), D.File + "", H(800, "file"), D.Function + "", H(801, "function"), D.Interface + "", H(802, "interface"), D.Key + "", H(803, "key"), D.Method + "", H(804, "method"), D.Module + "", H(805, "module"), D.Namespace + "", H(806, "namespace"), D.Null + "", H(807, "null"), D.Number + "", H(808, "number"), D.Object + "", H(809, "object"), D.Operator + "", H(810, "operator"), D.Package + "", H(811, "package"), D.Property + "", H(812, "property"), D.String + "", H(813, "string"), D.Struct + "", H(814, "struct"), D.TypeParameter + "", H(815, "type parameter"), D.Variable + "", H(816, "variable");
var n1;
(function(e) {
  e[e.Deprecated = 1] = "Deprecated";
})(n1 || (n1 = {}));
...
(function(e) {
  const t = /* @__PURE__ */ new Map();
  t.set(D.File, B.symbolFile), t.set(D.Module, B.symbolModule), t.set(D.Namespace, B.symbolNamespace), t.set(D.Package, B.symbolPackage), t.set(D.Class, B.symbolClass), t.set(D.Method, B.symbolMethod), t.set(D.Property, B.symbolProperty), t.set(D.Field, B.symbolField), t.set(D.Constructor, B.symbolConstructor), t.set(D.Enum, B.symbolEnum), t.set(D.Interface, B.symbolInterface), t.set(D.Function, B.symbolFunction), t.set(D.Variable, B.symbolVariable), t.set(D.Constant, B.symbolConstant), t.set(D.String, B.symbolString), t.set(D.Number, B.symbolNumber), t.set(D.Boolean, B.symbolBoolean), t.set(D.Array, B.symbolArray), t.set(D.Object, B.symbolObject), t.set(D.Key, B.symbolKey), t.set(D.Null, B.symbolNull), t.set(D.EnumMember, B.symbolEnumMember), t.set(D.Struct, B.symbolStruct), t.set(D.Event, B.symbolEvent), t.set(D.Operator, B.symbolOperator), t.set(D.TypeParameter, B.symbolTypeParameter);
  function n(s) {
    let a = t.get(s);
  ...
  i.set(D.File, E.File), i.set(D.Module, E.Module), i.set(D.Namespace, E.Module), i.set(D.Package, E.Module), i.set(D.Class, E.Class), i.set(D.Method, E.Method), i.set(D.Property, E.Property), i.set(D.Field, E.Field), i.set(D.Constructor, E.Constructor), i.set(D.Enum, E.Enum), i.set(D.Interface, E.Interface), i.set(D.Function, E.Function), i.set(D.Variable, E.Variable), i.set(D.Constant, E.Constant), i.set(D.String, E.Text), i.set(D.Number, E.Value), i.set(D.Boolean, E.Value), i.set(D.Array, E.Value), i.set(D.Object, E.Value), i.set(D.Key, E.Keyword), i.set(D.Null, E.Value), i.set(D.EnumMember, E.EnumMember), i.set(D.Struct, E.Struct), i.set(D.Event, E.Event), i.set(D.Operator, E.Operator), i.set(D.TypeParameter, E.TypeParameter);
  function r(s) {
    let a = i.get(s);
    return a === void 0 && (console.info("No completion kind found for SymbolKind " + s), a = E.File), a;
  }
...
pt.CtrlCmd = _t.CtrlCmd, pt.Shift = _t.Shift, pt.Alt = _t.Alt, pt.WinCtrl = _t.WinCtrl;
let ri = pt;
function Al() {
  return {
    editor: void 0,
...
function Rl(e, t, n, i, r) {
  ...
  if (e.get(s) !== Mt.Regular || s === w.CarriageReturn || s === w.LineFeed)
    return !0;
  if (r > 0) {
...
function Ul(e, t, n, i, r) {
  return Rl(e, t, n, i, r) && Tl(e, t, n, i, r);
}
class Ml {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (r === this._prevMatchStartIndex && s === this._prevMatchLength) {
        if (s === 0) {
          Ta(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = r, this._prevMatchLength = s, !this._wordSeparators || Ul(this._wordSeparators, t, n, r, s))
        return i;
    } while (i);
    return null;
  }
...
function _i(e, t, n, i, r) {
  if (t = _s(t), r || (r = hn.first(bs)), n.length > r.maxLen) {
    let c = e - r.maxLen / 2;
    return c < 0 ? c = 0 : i += c, n = n.substring(c, e + r.maxLen / 2), _i(e, t, n, i, r);
  }
...
class Sl {
  static computeUnicodeHighlights(t, n, i) {
    const r = i ? i.startLineNumber : 1, s = i ? i.endLineNumber : t.getLineCount(), a = new _r(n), u = a.getCandidateCodePoints();
    let o;
    u === "allNonBasicAscii" ? o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : o = new RegExp(`${Il(Array.from(u))}`, "g");
    const c = new Ml(null, o), h = [];
    let f = !1, _, p = 0, d = 0, b = 0;
    e: for (let A = r, R = s; A <= R; A++) {
      const x = t.getLineContent(A), v = x.length;
      c.reset(0);
      do
        if (_ = c.next(x), _) {
          let S = _.index, N = _.index + _[0].length;
          if (S > 0) {
            const X = x.charCodeAt(S - 1);
            gn(X) && S--;
          }
          if (N + 1 < v) {
          ...
          const T = x.substring(S, N);
          let U = _i(S + 1, gs, x, 0);
          U && U.endColumn <= S + 1 && (U = null);
          const k = a.shouldHighlightNonBasicASCII(T, U ? U.word : null);
          if (k !== _e.None) {
            if (k === _e.Ambiguous ? p++ : k === _e.Invisible ? d++ : k === _e.NonBasicASCII ? b++ : $s(), h.length >= 1e3) {
              f = !0;
              break e;
            }
            h.push(new F(A, S + 1, A, N + 1));
          }
        }
      while (_);
    }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (i.shouldHighlightNonBasicASCII(t, null)) {
      case _e.None:
        return null;
      case _e.Invisible:
        return { kind: Ht.Invisible };
      case _e.Ambiguous: {
        const s = t.codePointAt(0), a = i.ambiguousCharacters.getPrimaryConfusable(s), u = Qt.getLocales().filter((o) => !Qt.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, o])).isAmbiguous(s));
        return { kind: Ht.Ambiguous, confusableWith: String.fromCodePoint(a), notAmbiguousInLocales: u };
      }
      case _e.NonBasicASCII:
        return { kind: Ht.NonBasicAscii };
    }
  }
}
function Il(e, t) {
  return `[${La(e.map((i) => String.fromCodePoint(i)).join(""))}]`;
}
var Ht;
(function(e) {
...
class _r {
  constructor(t) {
    this.options = t, this.allowedCodePoints = new Set(t.allowedCodePoints), this.ambiguousCharacters = Qt.getInstance(new Set(t.allowedLocales));
  }
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const a of n) {
        const u = a.codePointAt(0), o = Ma(a);
        r = r || o, !o && !this.ambiguousCharacters.isAmbiguous(u) && !Vt.isInvisibleCharacter(u) && (s = !0);
      }
    return !r && s ? _e.None : this.options.invisibleCharacters && !br(t) && Vt.isInvisibleCharacter(i) ? _e.Invisible : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(i) ? _e.Ambiguous : _e.None;
  }
}
function br(e) {
  return e === " " || e === `
...
class bi {
  ...
  flip() {
    return new bi(this.lineRangeMapping.flip(), this.changes.map((t) => t.flip()));
  }
}
class j {
  static fromTo(t, n) {
...
class q {
  ...
  static joinMany(t) {
    if (t.length === 0)
      return [];
    let n = new Ie(t[0].slice());
    for (let i = 1; i < t.length; i++)
      n = n.getUnion(new Ie(t[i].slice()));
    return n.ranges;
  }
  static join(t) {
    if (t.length === 0)
...
class Ie {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = Vn(this._normalizedRanges, (r) => r.endLineNumberExclusive >= t.startLineNumber), i = Rt(this._normalizedRanges, (r) => r.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
  ...
  subtractFrom(t) {
    const n = Vn(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), i = Rt(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
      return new Ie([t]);
    const r = [];
    ...
    return s < t.endLineNumberExclusive && r.push(new q(s, t.endLineNumberExclusive)), new Ie(r);
  }
  toString() {
  ...
  getWithDelta(t) {
    return new Ie(this._normalizedRanges.map((n) => n.delta(t)));
  }
}
const Le = class Le {
...
` && (this.lineStartOffsetByLineIdx.push(n + 1), n > 0 && t.charAt(n - 1) === "\r" ? this.lineEndOffsetByLineIdx.push(n - 1) : this.lineEndOffsetByLineIdx.push(n));
  ...
  getPosition(t) {
    const n = Rt(this.lineStartOffsetByLineIdx, (s) => s <= t), i = n + 1, r = t - this.lineStartOffsetByLineIdx[n] + 1;
    return new $(i, r);
  }
  getRange(t) {
...
class et {
  ...
  constructor(t) {
    this.edits = t, $t(() => ci(t, (n, i) => n.range.getEndPosition().isBeforeOrEqual(i.range.getStartPosition())));
  }
  normalize() {
    const t = [];
  ...
  getNewRanges() {
    ...
    let n = 0, i = 0, r = 0;
    for (const s of this.edits) {
      const a = Je.ofText(s.text), u = $.lift({
  ...
  equals(t) {
    return Qr(this.edits, t.edits, (n, i) => n.equals(i));
  }
}
class ve {
...
`, `
`), r = Mi(n, i), s = Je.ofText(n.substring(0, r)).addToPosition(this.range.getStartPosition()), a = i.substring(r), u = F.fromPositions(s, this.range.getEndPosition());
    return new ve(u, a);
  }
...
class ws {
  ...
  getTransformer() {
    return this._transformer || (this._transformer = new ds(this.getValue())), this._transformer;
  }
  getLineAt(t) {
...
class Pl extends ws {
  constructor(t, n) {
    zs(n >= 1), super(), this._getLineContent = t, this._lineCount = n;
  }
  getValueOfRange(t) {
...
class yl extends ws {
  constructor(t) {
    super(), this.value = t, this._t = new ds(this.value);
  }
  getValueOfRange(t) {
...
class Te {
  ...
  toRangeMapping2(t, n) {
    if (dr(this.original.endLineNumberExclusive, t) && dr(this.modified.endLineNumberExclusive, n))
      return new de(new F(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new F(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new de(F.fromPositions(new $(this.original.startLineNumber, 1), ft(new $(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), F.fromPositions(new $(this.modified.startLineNumber, 1), ft(new $(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new de(F.fromPositions(ft(new $(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), ft(new $(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), F.fromPositions(ft(new $(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), ft(new $(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new ae();
  }
}
function ft(e, t) {
...
function wr(e, t, n, i = !1) {
  const r = [];
  for (const s of Is(e.map((a) => Bl(a, t, n)), (a, u) => a.original.overlapOrTouch(u.original) || a.modified.overlapOrTouch(u.modified))) {
  ...
  return $t(() => !i && r.length > 0 && (r[0].modified.startLineNumber !== r[0].original.startLineNumber || n.length.lineCount - r[r.length - 1].modified.endLineNumberExclusive !== t.length.lineCount - r[r.length - 1].original.endLineNumberExclusive) ? !1 : ci(r, (s, a) => a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive && s.original.endLineNumberExclusive < a.original.startLineNumber && s.modified.endLineNumberExclusive < a.modified.startLineNumber)), r;
}
function Bl(e, t, n) {
  let i = 0, r = 0;
...
class Vl {
  computeDiff(t, n, i) {
    ...
    for (const c of s.changes) {
      ...
      let _ = new We(h, f, (o = c.charChanges) == null ? void 0 : o.map((p) => new de(new F(
      ...
      u && (u.modified.endLineNumberExclusive === _.modified.startLineNumber || u.original.endLineNumberExclusive === _.original.startLineNumber) && (_ = new We(
    ...
    return $t(() => ci(a, (c, h) => h.original.startLineNumber - c.original.endLineNumberExclusive === h.modified.startLineNumber - c.modified.endLineNumberExclusive && c.original.endLineNumberExclusive < h.original.startLineNumber && c.modified.endLineNumberExclusive < h.modified.startLineNumber)), new on(a, [], s.quitEarly);
  }
}
function Ls(e, t, n, i) {
  return new Qe(e, t, n).ComputeDiff(i);
}
let Lr = class {
  constructor(t) {
    const n = [], i = [];
...
function ql(e) {
  ...
  for (let i = 1, r = e.length; i < r; i++) {
    ...
    Math.min(a, u) < Ol ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
  }
  return t;
}
class qt {
  ...
  static createFromDiffResult(t, n, i, r, s, a, u) {
    ...
    if (n.originalLength === 0 ? (o = i.getStartLineNumber(n.originalStart) - 1, c = 0) : (o = i.getStartLineNumber(n.originalStart), c = i.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (h = r.getStartLineNumber(n.modifiedStart) - 1, f = 0) : (h = r.getStartLineNumber(n.modifiedStart), f = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
      ...
      if (p.getElements().length > 0 && d.getElements().length > 0) {
        let b = Ls(p, d, s, !0).changes;
        u && (b = ql(b)), _ = [];
        for (let A = 0, R = b.length; A < R; A++)
          _.push(xt.createFromDiffChange(b[A], p, d));
      }
    }
    return new qt(
      o,
...
class ps {
  constructor(t, n, i) {
    this.shouldComputeCharChanges = i.shouldComputeCharChanges, this.shouldPostProcessCharChanges = i.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = i.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = i.shouldMakePrettyDiff, this.originalLines = t, this.modifiedLines = n, this.original = new Lr(t), this.modified = new Lr(n), this.continueLineDiff = pr(i.maxComputationTime), this.continueCharDiff = pr(i.maxComputationTime === 0 ? 0 : Math.min(i.maxComputationTime, 5e3));
  }
  computeDiff() {
    ...
    const t = Ls(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, i = t.quitEarly;
        ...
        if (_ !== p) {
          {
            ...
            for (; d > 1 && b > 1; ) {
              const A = _.charCodeAt(d - 2), R = p.charCodeAt(b - 2);
              if (A !== R)
                break;
              d--, b--;
            }
          ...
          }
          {
            ...
            const A = _.length + 1, R = p.length + 1;
            for (; d < A && b < R; ) {
              const x = _.charCodeAt(d - 1), v = _.charCodeAt(b - 1);
              if (x !== v)
                break;
              d++, b++;
            }
            (d < A || b < R) && this._pushTrimWhitespaceCharChange(r, s + 1, d, A, a + 1, b, R);
          }
        }
        s++, a++;
      }
  ...
  _pushTrimWhitespaceCharChange(t, n, i, r, s, a, u) {
    if (this._mergeTrimWhitespaceCharChange(t, n, i, r, s, a, u))
      return;
    let o;
    this.shouldComputeCharChanges && (o = [new xt(
      n,
      i,
      n,
      r,
  ...
  _mergeTrimWhitespaceCharChange(t, n, i, r, s, a, u) {
    ...
    if (o === 0)
      return !1;
    const c = t[o - 1];
    return c.originalEndLineNumber === 0 || c.modifiedEndLineNumber === 0 ? !1 : c.originalEndLineNumber === n && c.modifiedEndLineNumber === s ? (this.shouldComputeCharChanges && c.charChanges && c.charChanges.push(new xt(
      n,
      i,
      n,
      r,
      ...
      s,
      u
    )), !0) : c.originalEndLineNumber + 1 === n && c.modifiedEndLineNumber + 1 === s ? (c.originalEndLineNumber = n, c.modifiedEndLineNumber = s, this.shouldComputeCharChanges && c.charChanges && c.charChanges.push(new xt(
      n,
      i,
      n,
      r,
...
class Ge {
  static trivial(t, n) {
    return new Ge([new re(j.ofLength(t.length), j.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new Ge([new re(j.ofLength(t.length), j.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class re {
  static invert(t, n) {
    const i = [];
    return Ps(t, (r, s) => {
      i.push(re.fromOffsetPairs(r ? r.getEndExclusives() : He.zero, s ? s.getStarts() : new He(
        n,
  ...
  static fromOffsetPairs(t, n) {
    return new re(new j(t.offset1, n.offset1), new j(t.offset2, n.offset2));
  }
  static assertSorted(t) {
    let n;
    for (const i of t) {
  ...
  getStarts() {
    return new He(this.seq1Range.start, this.seq2Range.start);
  }
  getEndExclusives() {
    return new He(this.seq1Range.endExclusive, this.seq2Range.endExclusive);
  }
}
const rt = class rt {
  constructor(t, n) {
...
let pn = Wt;
class Gl {
  compute(t, n, i = Zt.instance, r) {
    if (t.length === 0 || n.length === 0)
      return Ge.trivial(t, n);
    const s = new Pn(t.length, n.length), a = new Pn(t.length, n.length), u = new Pn(t.length, n.length);
    for (let d = 0; d < t.length; d++)
      for (let b = 0; b < n.length; b++) {
        if (!i.isValid())
          return Ge.trivialTimedOut(t, n);
        const A = d === 0 ? 0 : s.get(d - 1, b), R = b === 0 ? 0 : s.get(d, b - 1);
        let x;
        t.getElement(d) === n.getElement(b) ? (d === 0 || b === 0 ? x = 0 : x = s.get(d - 1, b - 1), d > 0 && b > 0 && a.get(d - 1, b - 1) === 3 && (x += u.get(d - 1, b - 1)), x += r ? r(d, b) : 1) : x = -1;
        const v = Math.max(A, R, x);
        if (v === x) {
          const S = d > 0 && b > 0 ? u.get(d - 1, b - 1) : 0;
          u.set(d, b, S + 1), a.set(d, b, 3);
        } else v === A ? (u.set(d, b, 0), a.set(d, b, 1)) : v === R && (u.set(d, b, 0), a.set(d, b, 2));
        s.set(d, b, v);
      }
    const o = [];
    let c = t.length, h = n.length;
    function f(d, b) {
      (d + 1 !== c || b + 1 !== h) && o.push(new re(new j(d + 1, c), new j(b + 1, h))), c = d, h = b;
    }
    let _ = t.length - 1, p = n.length - 1;
    for (; _ >= 0 && p >= 0; )
      a.get(_, p) === 3 ? (f(_, p), _--, p--) : a.get(_, p) === 1 ? _-- : p--;
    return f(-1, -1), o.reverse(), new Ge(o, !1);
  }
}
class Ns {
  compute(t, n, i = Zt.instance) {
    if (t.length === 0 || n.length === 0)
      return Ge.trivial(t, n);
    const r = t, s = n;
    function a(b, A) {
    ...
    o.set(0, a(0, 0));
    const c = new zl();
    c.set(0, o.get(0) === 0 ? null : new Nr(null, 0, 0, o.get(0)));
    let h = 0;
    e: for (; ; ) {
      if (u++, !i.isValid())
        return Ge.trivialTimedOut(r, s);
      const b = -Math.min(u, s.length + u % 2), A = Math.min(u, r.length + u % 2);
      for (h = b; h <= A; h += 2) {
        const R = h === A ? -1 : o.get(h + 1), x = h === b ? -1 : o.get(h - 1) + 1, v = Math.min(Math.max(R, x), r.length), S = v - h;
        if (v > r.length || S > s.length)
          continue;
        const N = a(v, S);
        o.set(h, N);
        const T = v === R ? c.get(h + 1) : c.get(h - 1);
        if (c.set(h, N !== v ? new Nr(T, v, S, N - v) : T), o.get(h) === r.length && o.get(h) - h === s.length)
          break e;
      }
    }
    let f = c.get(h);
    ...
    for (; ; ) {
      ...
      if ((b !== p || A !== d) && _.push(new re(new j(b, p), new j(A, d))), !f)
        break;
      p = f.x, d = f.y, f = f.prev;
    }
    return _.reverse(), new Ge(_, !1);
  }
}
class Nr {
  constructor(t, n, i, r) {
...
class Nn {
  ...
  getBoundaryScore(t) {
    ...
    if (n === ie.LineBreakLF)
      return 150;
    let r = 0;
    return n !== i && (r += 10, n === ie.WordLower && i === ie.WordUpper && (r += 1)), r += xr(n), r += xr(i), r;
  }
  translateOffset(t, n = "right") {
    const i = Rt(this.firstElementOffsetByLineIdx, (s) => s <= t), r = t - this.firstElementOffsetByLineIdx[i];
    return new $(
  ...
  findSubWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !mt(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && mt(this.elements[n - 1]) && !Er(this.elements[n]); )
      n--;
    let i = t;
    for (; i < this.elements.length && mt(this.elements[i]) && !Er(this.elements[i]); )
      i++;
    return new j(n, i);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = vt(this.firstElementOffsetByLineIdx, (r) => r <= t.start) ?? 0, i = Ss(this.firstElementOffsetByLineIdx, (r) => t.endExclusive <= r) ?? this.elements.length;
    return new j(n, i);
  }
}
function mt(e) {
...
function Ar(e) {
  return e === w.LineFeed ? ie.LineBreakLF : e === w.CarriageReturn ? ie.LineBreakCR : li(e) ? ie.Space : e >= w.a && e <= w.z ? ie.WordLower : e >= w.A && e <= w.Z ? ie.WordUpper : e >= w.Digit0 && e <= w.Digit9 ? ie.WordNumber : e === -1 ? ie.End : e === w.Comma || e === w.Semicolon ? ie.Separator : ie.Other;
}
function Xl(e, t, n, i, r, s) {
  let { moves: a, excludedChanges: u } = Ql(e, t, n, s);
  if (!s.isValid())
    return [];
  const o = e.filter((h) => !u.has(h)), c = Zl(o, i, r, t, n, s);
  return Bs(a, c), a = Jl(a), a = a.filter((h) => {
    const f = h.original.toOffsetRange().slice(t).map((p) => p.trim());
    return f.join(`
`).length >= 15 && Yl(f, (p) => p.length >= 2) >= 2;
  }), a = Kl(e, a), a;
}
function Yl(e, t) {
  let n = 0;
...
function Zl(e, t, n, i, r, s) {
  ...
  const o = [];
  e.sort(yt((_) => _.modified.startLineNumber, Bt));
  for (const _ of e) {
    let p = [];
    for (let d = _.modified.startLineNumber; d < _.modified.endLineNumberExclusive - 2; d++) {
      ...
      u.forEach(b, ({ range: x }) => {
        for (const S of p)
          if (S.originalLineRange.endLineNumberExclusive + 1 === x.endLineNumberExclusive && S.modifiedLineRange.endLineNumberExclusive + 1 === A.endLineNumberExclusive) {
            S.originalLineRange = new q(
              S.originalLineRange.startLineNumber,
              x.endLineNumberExclusive
            ), S.modifiedLineRange = new q(
  ...
  o.sort(Os(yt((_) => _.modifiedLineRange.length, Bt)));
  const c = new Ie(), h = new Ie();
  for (const _ of o) {
    ...
    for (const R of A.ranges) {
      if (R.length < 3)
        continue;
      const x = R, v = R.delta(-p);
      a.push(new Te(v, x)), c.addRange(x), h.addRange(v);
    }
  }
  a.sort(yt((_) => _.original.startLineNumber, Bt));
  const f = new cn(e);
  for (let _ = 0; _ < a.length; _++) {
    const p = a[_], d = f.findLastMonotonous((T) => T.original.startLineNumber <= p.original.startLineNumber), b = vt(e, (T) => T.modified.startLineNumber <= p.modified.startLineNumber), A = Math.max(p.original.startLineNumber - d.original.startLineNumber, p.modified.startLineNumber - b.modified.startLineNumber), R = f.findLastMonotonous((T) => T.original.startLineNumber < p.original.endLineNumberExclusive), x = vt(e, (T) => T.modified.startLineNumber < p.modified.endLineNumberExclusive), v = Math.max(R.original.endLineNumberExclusive - p.original.endLineNumberExclusive, x.modified.endLineNumberExclusive - p.modified.endLineNumberExclusive);
    let S;
    for (S = 0; S < A; S++) {
      const T = p.original.startLineNumber - S - 1, U = p.modified.startLineNumber - S - 1;
      if (T > i.length || U > r.length || c.contains(U) || h.contains(T) || !vr(i[T - 1], r[U - 1], s))
        break;
    }
    S > 0 && (h.addRange(new q(p.original.startLineNumber - S, p.original.startLineNumber)), c.addRange(new q(p.modified.startLineNumber - S, p.modified.startLineNumber)));
    let N;
    for (N = 0; N < v; N++) {
      const T = p.original.endLineNumberExclusive + N, U = p.modified.endLineNumberExclusive + N;
      if (T > i.length || U > r.length || c.contains(U) || h.contains(T) || !vr(i[T - 1], r[U - 1], s))
        break;
    }
    N > 0 && (h.addRange(new q(
    ...
    ))), (S > 0 || N > 0) && (a[_] = new Te(new q(
      p.original.startLineNumber - S,
      p.original.endLineNumberExclusive + N
    ), new q(
      p.modified.startLineNumber - S,
      p.modified.endLineNumberExclusive + N
    )));
  }
  return a;
...
function vr(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const r = new Ns().compute(new Nn([e], new F(1, 1, 1, e.length), !1), new Nn([t], new F(1, 1, 1, t.length), !1), n);
  let s = 0;
...
function Jl(e) {
  if (e.length === 0)
    return e;
  e.sort(yt((n) => n.original.startLineNumber, Bt));
  const t = [e[0]];
...
function Kl(e, t) {
  const n = new cn(e);
  return t = t.filter((i) => {
    const r = n.findLastMonotonous((u) => u.original.startLineNumber < i.original.endLineNumberExclusive) || new Te(new q(1, 1), new q(1, 1)), s = vt(e, (u) => u.modified.startLineNumber < i.modified.endLineNumberExclusive);
    return r !== s;
  }), t;
}
function Rr(e, t, n) {
  let i = n;
  return i = Tr(e, t, i), i = Tr(e, t, i), i = Cl(e, t, i), i;
}
function Tr(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  for (let s = 1; s < n.length; s++) {
    ...
    if (u.seq1Range.isEmpty || u.seq2Range.isEmpty) {
      ...
      for (c = 1; c <= o && !(e.getElement(u.seq1Range.start - c) !== e.getElement(u.seq1Range.endExclusive - c) || t.getElement(u.seq2Range.start - c) !== t.getElement(u.seq2Range.endExclusive - c)); c++)
        ;
      if (c--, c === o) {
        i[i.length - 1] = new re(new j(a.seq1Range.start, u.seq1Range.endExclusive - o), new j(a.seq2Range.start, u.seq2Range.endExclusive - o));
        continue;
      }
      u = u.delta(-c);
    }
  ...
  for (let s = 0; s < i.length - 1; s++) {
    ...
    if (u.seq1Range.isEmpty || u.seq2Range.isEmpty) {
      ...
      for (c = 0; c < o && !(!e.isStronglyEqual(u.seq1Range.start + c, u.seq1Range.endExclusive + c) || !t.isStronglyEqual(u.seq2Range.start + c, u.seq2Range.endExclusive + c)); c++)
        ;
      if (c === o) {
        i[s + 1] = new re(new j(u.seq1Range.start + o, a.seq1Range.endExclusive), new j(u.seq2Range.start + o, a.seq2Range.endExclusive));
        continue;
      }
      c > 0 && (u = u.delta(c));
    }
...
function Cl(e, t, n) {
  ...
  for (let i = 0; i < n.length; i++) {
    const r = i > 0 ? n[i - 1] : void 0, s = n[i], a = i + 1 < n.length ? n[i + 1] : void 0, u = new j(
    ...
    s.seq1Range.isEmpty ? n[i] = Ur(s, e, t, u, o) : s.seq2Range.isEmpty && (n[i] = Ur(s.swap(), t, e, o, u).swap());
  }
  return n;
}
...
function Mr(e, t, n, i, r = !1) {
  ...
  function o(h, f) {
    ...
    let A = b.seq1Range.length, R = b.seq2Range.length;
    for (; s.length > 0; ) {
      const x = s[0];
      if (!(x.seq1Range.intersects(d.seq1Range) || x.seq2Range.intersects(d.seq2Range)))
        break;
      const S = i(e, x.seq1Range.start), N = i(t, x.seq2Range.start), T = new re(S, N), U = T.intersect(x);
      if (A += U.seq1Range.length, R += U.seq2Range.length, d = d.join(T), d.seq1Range.endExclusive >= x.seq1Range.endExclusive)
        s.shift();
      else
        break;
    }
    (r && A + R < d.seq1Range.length + d.seq2Range.length || A + R < (d.seq1Range.length + d.seq2Range.length) * 2 / 3) && a.push(d), u = d.getEndExclusives();
  }
  for (; s.length > 0; ) {
    const h = s.shift();
...
function nu(e, t, n) {
  ...
  do {
    ...
    for (let u = 1; u < i.length; u++) {
      let h = function(_, p) {
        const d = new j(c.seq1Range.endExclusive, o.seq1Range.start);
...
function iu(e, t, n) {
  ...
  do {
    ...
    for (let o = 1; o < i.length; o++) {
      let f = function(p, d) {
        const b = new j(h.seq1Range.endExclusive, c.seq1Range.start);
        if (e.countLinesIn(b) > 5 || b.length > 500)
          return !1;
        const R = e.getText(b).trim();
        if (R.length > 20 || R.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const x = e.countLinesIn(p.seq1Range), v = p.seq1Range.length, S = t.countLinesIn(p.seq2Range), N = p.seq2Range.length, T = e.countLinesIn(d.seq1Range), U = d.seq1Range.length, k = t.countLinesIn(d.seq2Range), X = d.seq2Range.length, te = 2 * 40 + 50;
        function Q(W) {
          return Math.min(W, te);
        }
        return Math.pow(Math.pow(Q(x * 40 + v), 1.5) + Math.pow(Q(S * 40 + N), 1.5), 1.5) + Math.pow(Math.pow(Q(T * 40 + U), 1.5) + Math.pow(Q(k * 40 + X), 1.5), 1.5) > (te ** 1.5) ** 1.5 * 1.3;
      };
  ...
  return ys(i, (u, o, c) => {
    let h = o;
    function f(R) {
      return R.length > 0 && R.trim().length <= 3 && o.seq1Range.length + o.seq2Range.length > 100;
    }
    const _ = e.extendToFullLines(o.seq1Range), p = e.getText(new j(_.start, o.seq1Range.start));
    f(p) && (h = h.deltaStart(-p.length));
    const d = e.getText(new j(o.seq1Range.endExclusive, _.endExclusive));
    f(d) && (h = h.deltaEnd(d.length));
    const b = re.fromOffsetPairs(u ? u.getEndExclusives() : He.zero, c ? c.getStarts() : He.max), A = h.intersect(b);
...
class Dr {
  ...
  getBoundaryScore(t) {
    const n = t === 0 ? 0 : kr(this.lines[t - 1]), i = t === this.lines.length ? 0 : kr(this.lines[t]);
    return 1e3 - (n + i);
  }
  getText(t) {
...
class ru {
  constructor() {
    this.dynamicProgrammingDiffing = new Gl(), this.myersDiffingAlgorithm = new Ns();
  }
  computeDiff(t, n, i) {
    if (t.length <= 1 && Qr(t, n, (N, T) => N === T))
      return new on([], [], !1);
    ...
    const r = i.maxComputationTimeMs === 0 ? Zt.instance : new Wl(i.maxComputationTimeMs), s = !i.ignoreTrimWhitespace, a = /* @__PURE__ */ new Map();
    function u(N) {
      let T = a.get(N);
      return T === void 0 && (T = a.size, a.set(N, T)), T;
    }
    const o = t.map((N) => u(N.trim())), c = n.map((N) => u(N.trim())), h = new Dr(o, t), f = new Dr(c, n), _ = h.length + f.length < 1700 ? this.dynamicProgrammingDiffing.compute(h, f, r, (N, T) => t[N] === n[T] ? n[T].length === 0 ? 0.1 : 1 + Math.log(1 + n[T].length) : 0.99) : this.myersDiffingAlgorithm.compute(h, f, r);
    let p = _.diffs, d = _.hitTimeout;
    p = Rr(h, f, p), p = nu(h, f, p);
    const b = [], A = (N) => {
      if (s)
        for (let T = 0; T < N; T++) {
          const U = R + T, k = x + T;
          if (t[U] !== n[k]) {
            const X = this.refineDiff(t, n, new re(new j(U, U + 1), new j(k, k + 1)), r, s, i);
            for (const te of X.mappings)
              b.push(te);
            X.hitTimeout && (d = !0);
          }
        }
    ...
    let R = 0, x = 0;
    for (const N of p) {
      $t(() => N.seq1Range.start - R === N.seq2Range.start - x);
      const T = N.seq1Range.start - R;
      A(T), R = N.seq1Range.endExclusive, x = N.seq2Range.endExclusive;
    ...
    A(t.length - R);
    const v = wr(b, new nn(t), new nn(n));
    let S = [];
    return i.computeMoves && (S = this.computeMoves(v, t, n, o, c, r, s, i)), $t(() => {
      function N(U, k) {
        if (U.lineNumber < 1 || U.lineNumber > k.length)
          return !1;
        const X = k[U.lineNumber - 1];
        return !(U.column < 1 || U.column > X.length + 1);
      }
      function T(U, k) {
        return !(U.startLineNumber < 1 || U.startLineNumber > k.length + 1 || U.endLineNumberExclusive < 1 || U.endLineNumberExclusive > k.length + 1);
      }
      for (const U of v) {
        if (!U.innerChanges)
          return !1;
        for (const k of U.innerChanges)
          if (!(N(k.modifiedRange.getStartPosition(), n) && N(k.modifiedRange.getEndPosition(), n) && N(k.originalRange.getStartPosition(), t) && N(k.originalRange.getEndPosition(), t)))
            return !1;
        if (!T(U.modified, n) || !T(U.original, t))
          return !1;
      }
      return !0;
    }), new on(v, S, d);
  ...
  computeMoves(t, n, i, r, s, a, u, o) {
    return Xl(t, n, i, r, s, a).map((f) => {
      const _ = this.refineDiff(n, i, new re(f.original.toOffsetRange(), f.modified.toOffsetRange()), a, u, o), p = wr(_.mappings, new nn(n), new nn(i), !0);
      return new bi(f, p);
    });
  }
  refineDiff(t, n, i, r, s, a) {
    const o = su(i).toRangeMapping2(t, n), c = new Nn(t, o.originalRange, s), h = new Nn(n, o.modifiedRange, s), f = c.length + h.length < 500 ? this.dynamicProgrammingDiffing.compute(c, h, r) : this.myersDiffingAlgorithm.compute(c, h, r);
    let _ = f.diffs;
    return _ = Rr(c, h, _), _ = Mr(c, h, _, (d, b) => d.findWordContaining(b)), a.extendToSubwords && (_ = Mr(c, h, _, (d, b) => d.findSubWordContaining(b), !0)), _ = eu(c, h, _), _ = iu(c, h, _), {
...
class Re {
  ...
  static toRGBA(t) {
    ...
    return new L(Math.round(a * 255), Math.round(u * 255), Math.round(o * 255), s);
  }
}
class bt {
  constructor(t, n, i, r) {
  ...
  static fromRGBA(t) {
    ...
    let c;
    return u === 0 ? c = 0 : s === n ? c = ((i - r) / u % 6 + 6) % 6 : s === i ? c = (r - n) / u + 2 : c = (n - i) / u + 4, new bt(Math.round(c * 60), o, s, t.a);
  }
  static toRGBA(t) {
    const { h: n, s: i, v: r, a: s } = t, a = r * i, u = a * (1 - Math.abs(n / 60 % 2 - 1)), o = r - a;
    let [c, h, f] = [0, 0, 0];
    return n < 60 ? (c = a, h = u) : n < 120 ? (c = u, h = a) : n < 180 ? (h = a, f = u) : n < 240 ? (h = u, f = a) : n < 300 ? (c = u, f = a) : n <= 360 && (c = a, f = u), c = Math.round((c + o) * 255), h = Math.round((h + o) * 255), f = Math.round((f + o) * 255), new L(c, h, f, s);
  }
}
const Y = class Y {
  static fromHex(t) {
  ...
  equals(t) {
    return !!t && L.equals(this.rgba, t.rgba) && Re.equals(this.hsla, t.hsla) && bt.equals(this.hsva, t.hsva);
  }
  ...
  reduceRelativeLuminace(t, n) {
    ...
    for (; a < n && (i > 0 || r > 0 || s > 0); )
      i -= Math.max(0, Math.ceil(i * 0.1)), r -= Math.max(0, Math.ceil(r * 0.1)), s -= Math.max(0, Math.ceil(s * 0.1)), a = this.getContrastRatio(new Y(new L(i, r, s)));
    return new Y(new L(i, r, s));
  }
  increaseRelativeLuminace(t, n) {
    let { r: i, g: r, b: s } = t.rgba, a = this.getContrastRatio(t);
    for (; a < n && (i < 255 || r < 255 || s < 255); )
      i = Math.min(255, i + Math.ceil((255 - i) * 0.1)), r = Math.min(255, r + Math.ceil((255 - r) * 0.1)), s = Math.min(255, s + Math.ceil((255 - s) * 0.1)), a = this.getContrastRatio(new Y(new L(i, r, s)));
    return new Y(new L(i, r, s));
  }
  ...
  lighten(t) {
    return new Y(new Re(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
  }
  darken(t) {
    return new Y(new Re(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
  }
  ...
  opposite() {
    return new Y(new L(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
  }
  blend(t) {
...
Y.white = new Y(new L(255, 255, 255, 1)), Y.black = new Y(new L(0, 0, 0, 1)), Y.red = new Y(new L(255, 0, 0, 1)), Y.blue = new Y(new L(0, 0, 255, 1)), Y.green = new Y(new L(0, 255, 0, 1)), Y.cyan = new Y(new L(0, 255, 255, 1)), Y.lightgrey = new Y(new L(211, 211, 211, 1)), Y.transparent = new Y(new L(0, 0, 0, 0));
let Dt = Y;
(function(e) {
  (function(t) {
    (function(n) {
      ...
      function f(b) {
        ...
        if (b.startsWith("rgba(")) {
          const U = b.match(/rgba\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+), *(?<a>(?:\+|-)?\d+(\.\d+)?)\)/);
          if (!U)
            throw new Error("Invalid color format " + b);
          const k = parseInt(((A = U.groups) == null ? void 0 : A.r) ?? "0"), X = parseInt(((R = U.groups) == null ? void 0 : R.g) ?? "0"), te = parseInt(((x = U.groups) == null ? void 0 : x.b) ?? "0"), Q = parseFloat(((v = U.groups) == null ? void 0 : v.a) ?? "0");
          return new e(new L(k, X, te, Q));
        }
        if (b.startsWith("rgb(")) {
          const U = b.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/);
          if (!U)
            throw new Error("Invalid color format " + b);
          const k = parseInt(((S = U.groups) == null ? void 0 : S.r) ?? "0"), X = parseInt(((N = U.groups) == null ? void 0 : N.g) ?? "0"), te = parseInt(((T = U.groups) == null ? void 0 : T.b) ?? "0");
          return new e(new L(k, X, te));
        }
        return _(b);
      }
      n.parse = f;
      function _(b) {
        switch (b) {
          case "aliceblue":
            return new e(new L(240, 248, 255, 1));
          case "antiquewhite":
            return new e(new L(250, 235, 215, 1));
          case "aqua":
            return new e(new L(0, 255, 255, 1));
          case "aquamarine":
            return new e(new L(127, 255, 212, 1));
          case "azure":
            return new e(new L(240, 255, 255, 1));
          case "beige":
            return new e(new L(245, 245, 220, 1));
          case "bisque":
            return new e(new L(255, 228, 196, 1));
          case "black":
            return new e(new L(0, 0, 0, 1));
          case "blanchedalmond":
            return new e(new L(255, 235, 205, 1));
          case "blue":
            return new e(new L(0, 0, 255, 1));
          case "blueviolet":
            return new e(new L(138, 43, 226, 1));
          case "brown":
            return new e(new L(165, 42, 42, 1));
          case "burlywood":
            return new e(new L(222, 184, 135, 1));
          case "cadetblue":
            return new e(new L(95, 158, 160, 1));
          case "chartreuse":
            return new e(new L(127, 255, 0, 1));
          case "chocolate":
            return new e(new L(210, 105, 30, 1));
          case "coral":
            return new e(new L(255, 127, 80, 1));
          case "cornflowerblue":
            return new e(new L(100, 149, 237, 1));
          case "cornsilk":
            return new e(new L(255, 248, 220, 1));
          case "crimson":
            return new e(new L(220, 20, 60, 1));
          case "cyan":
            return new e(new L(0, 255, 255, 1));
          case "darkblue":
            return new e(new L(0, 0, 139, 1));
          case "darkcyan":
            return new e(new L(0, 139, 139, 1));
          case "darkgoldenrod":
            return new e(new L(184, 134, 11, 1));
          case "darkgray":
            return new e(new L(169, 169, 169, 1));
          case "darkgreen":
            return new e(new L(0, 100, 0, 1));
          case "darkgrey":
            return new e(new L(169, 169, 169, 1));
          case "darkkhaki":
            return new e(new L(189, 183, 107, 1));
          case "darkmagenta":
            return new e(new L(139, 0, 139, 1));
          case "darkolivegreen":
            return new e(new L(85, 107, 47, 1));
          case "darkorange":
            return new e(new L(255, 140, 0, 1));
          case "darkorchid":
            return new e(new L(153, 50, 204, 1));
          case "darkred":
            return new e(new L(139, 0, 0, 1));
          case "darksalmon":
            return new e(new L(233, 150, 122, 1));
          case "darkseagreen":
            return new e(new L(143, 188, 143, 1));
          case "darkslateblue":
            return new e(new L(72, 61, 139, 1));
          case "darkslategray":
            return new e(new L(47, 79, 79, 1));
          case "darkslategrey":
            return new e(new L(47, 79, 79, 1));
          case "darkturquoise":
            return new e(new L(0, 206, 209, 1));
          case "darkviolet":
            return new e(new L(148, 0, 211, 1));
          case "deeppink":
            return new e(new L(255, 20, 147, 1));
          case "deepskyblue":
            return new e(new L(0, 191, 255, 1));
          case "dimgray":
            return new e(new L(105, 105, 105, 1));
          case "dimgrey":
            return new e(new L(105, 105, 105, 1));
          case "dodgerblue":
            return new e(new L(30, 144, 255, 1));
          case "firebrick":
            return new e(new L(178, 34, 34, 1));
          case "floralwhite":
            return new e(new L(255, 250, 240, 1));
          case "forestgreen":
            return new e(new L(34, 139, 34, 1));
          case "fuchsia":
            return new e(new L(255, 0, 255, 1));
          case "gainsboro":
            return new e(new L(220, 220, 220, 1));
          case "ghostwhite":
            return new e(new L(248, 248, 255, 1));
          case "gold":
            return new e(new L(255, 215, 0, 1));
          case "goldenrod":
            return new e(new L(218, 165, 32, 1));
          case "gray":
            return new e(new L(128, 128, 128, 1));
          case "green":
            return new e(new L(0, 128, 0, 1));
          case "greenyellow":
            return new e(new L(173, 255, 47, 1));
          case "grey":
            return new e(new L(128, 128, 128, 1));
          case "honeydew":
            return new e(new L(240, 255, 240, 1));
          case "hotpink":
            return new e(new L(255, 105, 180, 1));
          case "indianred":
            return new e(new L(205, 92, 92, 1));
          case "indigo":
            return new e(new L(75, 0, 130, 1));
          case "ivory":
            return new e(new L(255, 255, 240, 1));
          case "khaki":
            return new e(new L(240, 230, 140, 1));
          case "lavender":
            return new e(new L(230, 230, 250, 1));
          case "lavenderblush":
            return new e(new L(255, 240, 245, 1));
          case "lawngreen":
            return new e(new L(124, 252, 0, 1));
          case "lemonchiffon":
            return new e(new L(255, 250, 205, 1));
          case "lightblue":
            return new e(new L(173, 216, 230, 1));
          case "lightcoral":
            return new e(new L(240, 128, 128, 1));
          case "lightcyan":
            return new e(new L(224, 255, 255, 1));
          case "lightgoldenrodyellow":
            return new e(new L(250, 250, 210, 1));
          case "lightgray":
            return new e(new L(211, 211, 211, 1));
          case "lightgreen":
            return new e(new L(144, 238, 144, 1));
          case "lightgrey":
            return new e(new L(211, 211, 211, 1));
          case "lightpink":
            return new e(new L(255, 182, 193, 1));
          case "lightsalmon":
            return new e(new L(255, 160, 122, 1));
          case "lightseagreen":
            return new e(new L(32, 178, 170, 1));
          case "lightskyblue":
            return new e(new L(135, 206, 250, 1));
          case "lightslategray":
            return new e(new L(119, 136, 153, 1));
          case "lightslategrey":
            return new e(new L(119, 136, 153, 1));
          case "lightsteelblue":
            return new e(new L(176, 196, 222, 1));
          case "lightyellow":
            return new e(new L(255, 255, 224, 1));
          case "lime":
            return new e(new L(0, 255, 0, 1));
          case "limegreen":
            return new e(new L(50, 205, 50, 1));
          case "linen":
            return new e(new L(250, 240, 230, 1));
          case "magenta":
            return new e(new L(255, 0, 255, 1));
          case "maroon":
            return new e(new L(128, 0, 0, 1));
          case "mediumaquamarine":
            return new e(new L(102, 205, 170, 1));
          case "mediumblue":
            return new e(new L(0, 0, 205, 1));
          case "mediumorchid":
            return new e(new L(186, 85, 211, 1));
          case "mediumpurple":
            return new e(new L(147, 112, 219, 1));
          case "mediumseagreen":
            return new e(new L(60, 179, 113, 1));
          case "mediumslateblue":
            return new e(new L(123, 104, 238, 1));
          case "mediumspringgreen":
            return new e(new L(0, 250, 154, 1));
          case "mediumturquoise":
            return new e(new L(72, 209, 204, 1));
          case "mediumvioletred":
            return new e(new L(199, 21, 133, 1));
          case "midnightblue":
            return new e(new L(25, 25, 112, 1));
          case "mintcream":
            return new e(new L(245, 255, 250, 1));
          case "mistyrose":
            return new e(new L(255, 228, 225, 1));
          case "moccasin":
            return new e(new L(255, 228, 181, 1));
          case "navajowhite":
            return new e(new L(255, 222, 173, 1));
          case "navy":
            return new e(new L(0, 0, 128, 1));
          case "oldlace":
            return new e(new L(253, 245, 230, 1));
          case "olive":
            return new e(new L(128, 128, 0, 1));
          case "olivedrab":
            return new e(new L(107, 142, 35, 1));
          case "orange":
            return new e(new L(255, 165, 0, 1));
          case "orangered":
            return new e(new L(255, 69, 0, 1));
          case "orchid":
            return new e(new L(218, 112, 214, 1));
          case "palegoldenrod":
            return new e(new L(238, 232, 170, 1));
          case "palegreen":
            return new e(new L(152, 251, 152, 1));
          case "paleturquoise":
            return new e(new L(175, 238, 238, 1));
          case "palevioletred":
            return new e(new L(219, 112, 147, 1));
          case "papayawhip":
            return new e(new L(255, 239, 213, 1));
          case "peachpuff":
            return new e(new L(255, 218, 185, 1));
          case "peru":
            return new e(new L(205, 133, 63, 1));
          case "pink":
            return new e(new L(255, 192, 203, 1));
          case "plum":
            return new e(new L(221, 160, 221, 1));
          case "powderblue":
            return new e(new L(176, 224, 230, 1));
          case "purple":
            return new e(new L(128, 0, 128, 1));
          case "rebeccapurple":
            return new e(new L(102, 51, 153, 1));
          case "red":
            return new e(new L(255, 0, 0, 1));
          case "rosybrown":
            return new e(new L(188, 143, 143, 1));
          case "royalblue":
            return new e(new L(65, 105, 225, 1));
          case "saddlebrown":
            return new e(new L(139, 69, 19, 1));
          case "salmon":
            return new e(new L(250, 128, 114, 1));
          case "sandybrown":
            return new e(new L(244, 164, 96, 1));
          case "seagreen":
            return new e(new L(46, 139, 87, 1));
          case "seashell":
            return new e(new L(255, 245, 238, 1));
          case "sienna":
            return new e(new L(160, 82, 45, 1));
          case "silver":
            return new e(new L(192, 192, 192, 1));
          case "skyblue":
            return new e(new L(135, 206, 235, 1));
          case "slateblue":
            return new e(new L(106, 90, 205, 1));
          case "slategray":
            return new e(new L(112, 128, 144, 1));
          case "slategrey":
            return new e(new L(112, 128, 144, 1));
          case "snow":
            return new e(new L(255, 250, 250, 1));
          case "springgreen":
            return new e(new L(0, 255, 127, 1));
          case "steelblue":
            return new e(new L(70, 130, 180, 1));
          case "tan":
            return new e(new L(210, 180, 140, 1));
          case "teal":
            return new e(new L(0, 128, 128, 1));
          case "thistle":
            return new e(new L(216, 191, 216, 1));
          case "tomato":
            return new e(new L(255, 99, 71, 1));
          case "turquoise":
            return new e(new L(64, 224, 208, 1));
          case "violet":
            return new e(new L(238, 130, 238, 1));
          case "wheat":
            return new e(new L(245, 222, 179, 1));
          case "white":
            return new e(new L(255, 255, 255, 1));
          case "whitesmoke":
            return new e(new L(245, 245, 245, 1));
          case "yellow":
            return new e(new L(255, 255, 0, 1));
          case "yellowgreen":
            return new e(new L(154, 205, 50, 1));
          default:
            return null;
        }
      }
      function p(b) {
        const A = b.length;
        if (A === 0 || b.charCodeAt(0) !== w.Hash)
          return null;
        if (A === 7) {
          const R = 16 * d(b.charCodeAt(1)) + d(b.charCodeAt(2)), x = 16 * d(b.charCodeAt(3)) + d(b.charCodeAt(4)), v = 16 * d(b.charCodeAt(5)) + d(b.charCodeAt(6));
          return new e(new L(R, x, v, 1));
        }
        if (A === 9) {
          const R = 16 * d(b.charCodeAt(1)) + d(b.charCodeAt(2)), x = 16 * d(b.charCodeAt(3)) + d(b.charCodeAt(4)), v = 16 * d(b.charCodeAt(5)) + d(b.charCodeAt(6)), S = 16 * d(b.charCodeAt(7)) + d(b.charCodeAt(8));
          return new e(new L(R, x, v, S / 255));
        }
        if (A === 4) {
          const R = d(b.charCodeAt(1)), x = d(b.charCodeAt(2)), v = d(b.charCodeAt(3));
          return new e(new L(16 * R + R, 16 * x + x, 16 * v + v));
        }
        if (A === 5) {
          const R = d(b.charCodeAt(1)), x = d(b.charCodeAt(2)), v = d(b.charCodeAt(3)), S = d(b.charCodeAt(4));
          return new e(new L(16 * R + R, 16 * x + x, 16 * v + v, (16 * S + S) / 255));
        }
        return null;
      }
      n.parseHex = p;
...
function au(e, t) {
  if (!e)
    return;
  const n = Dt.Format.CSS.parseHex(t);
  if (n)
    return {
      range: e,
...
function Fr(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = Es(r);
  return {
    range: e,
    color: di(s[0], s[1], s[2], n ? s[3] : 1)
  };
}
function Sr(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = Es(r), a = new Dt(new Re(
    s[0],
    s[1] / 100,
    s[2] / 100,
    n ? s[3] : 1
  ...
  return {
    range: e,
    color: di(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a)
  };
}
function It(e, t) {
...
function lu(e) {
  const t = [], i = It(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|\s+(#)([A-Fa-f0-9]{6})\b|\s+(#)([A-Fa-f0-9]{8})\b|^(#)([A-Fa-f0-9]{6})\b|^(#)([A-Fa-f0-9]{8})\b/gm);
  if (i.length > 0)
    for (const r of i) {
...
function mu(e, t) {
  const n = [], i = e.getLineCount(), r = vl(t.markSectionHeaderRegex), s = new RegExp(t.markSectionHeaderRegex, `gdm${r ? "s" : ""}`);
  for (let a = 1; a <= i; a += Ir - cu) {
    const u = Math.min(a + Ir - 1, i), o = [];
    for (let f = a; f <= u; f++)
...
`), b = d.length, A = p + b - 1, R = f.lastIndexOf(`
`) + 1, x = h.index - R + 1, v = d[d.length - 1], S = b === 1 ? x + h[0].length : v.length + 1, N = {
        startLineNumber: p,
        startColumn: x,
        endLineNumber: A,
        endColumn: S
      }, T = (h.groups ?? {}).label ?? "", U = ((h.groups ?? {}).separator ?? "") !== "", k = {
        range: N,
        text: T,
        hasSeparatorLine: U,
...
function gu(e) {
  ...
  return e = e.replace(ou, ""), { text: e, hasSeparatorLine: t };
}
function ze(e) {
...
function _u(e) {
  return e.indexOf("/") === -1 && (e = xs(e)), /^[a-zA-Z]:(\/|$)/.test(e) && (e = "/" + e), e;
}
function Pr(e, t = ee.sep) {
  if (!e)
    return "";
  ...
  if (ze(i)) {
    ...
    return t;
  } else if (bu(i) && e.charCodeAt(1) === w.Colon)
...
class wu {
  ...
  setServerRootPath(t, n) {
    this._serverRootPath = ee.join(n ?? "/", pu(t));
  }
  getServerRootPath() {
    return this._serverRootPath;
  }
  get _remoteResourcesPath() {
    return ee.join(this._serverRootPath, fe.vscodeRemoteResource);
  }
  set(t, n, i) {
  ...
  rewrite(t) {
    ...
    return typeof s == "string" && (a += `&${du}=${encodeURIComponent(s)}`), oe.from({
      scheme: ha ? this._preferredWebSchema : fe.vscodeRemoteResource,
      authority: `${i}:${r}`,
...
const Nu = "vscode-app", Nt = class Nt {
  constructor() {
  ...
  uriToBrowserUri(t) {
    return t.scheme === fe.vscodeRemote ? Lu.rewrite(t) : t.scheme === fe.file && (ca || ma === `${fe.vscodeFileResource}://${Nt.FALLBACK_AUTHORITY}`) ? t.with({
      scheme: fe.vscodeFileResource,
      authority: t.authority || Nt.FALLBACK_AUTHORITY,
      query: null,
      fragment: null
  ...
  uriToFileUri(t) {
    return t.scheme === fe.vscodeFileResource ? t.with({
      scheme: fe.file,
      authority: t.authority !== Nt.FALLBACK_AUTHORITY ? t.authority : null,
      query: null,
      fragment: null
    }) : t;
  }
  ...
  registerStaticBrowserUri(t, n) {
    return this.staticBrowserUris.set(t, n), zt(() => {
...
class Eu {
  ...
  compare(t, n, i = !1) {
    return t === n ? 0 : Ea(this.getComparisonKey(t, i), this.getComparisonKey(n, i));
  }
  isEqual(t, n, i = !1) {
  ...
  isEqualOrParent(t, n, i = !1) {
    if (t.scheme === n.scheme) {
      if (t.scheme === fe.file)
        return yr(Oe(t), Oe(n), this._ignorePathCasing(t)) && t.query === n.query && (i || t.fragment === n.fragment);
      if (Or(t.authority, n.authority))
        return yr(t.path, n.path, this._ignorePathCasing(t), "/") && t.query === n.query && (i || t.fragment === n.fragment);
    }
    return !1;
  }
  joinPath(t, ...n) {
  ...
  dirname(t) {
    if (t.path.length === 0)
      return t;
    let n;
    return t.scheme === fe.file ? n = oe.file(hl(Oe(t))).path : (n = ee.dirname(t.path), t.authority && n.length && n.charCodeAt(0) !== w.Slash && (console.error(`dirname("${t.toString})) resulted in a relative path`), n = "/")), t.with({
      path: n
    });
  }
  normalizePath(t) {
    if (!t.path.length)
      return t;
    let n;
    return t.scheme === fe.file ? n = oe.file(ll(Oe(t))).path : n = ee.normalize(t.path), t.with({
      path: n
    });
  }
  relativePath(t, n) {
    if (t.scheme !== n.scheme || !Or(t.authority, n.authority))
      return;
    if (t.scheme === fe.file) {
      const s = cl(Oe(t), Oe(n));
      return Ut ? xs(s) : s;
    }
    let i = t.path || "/";
    const r = n.path || "/";
  ...
  resolvePath(t, n) {
    if (t.scheme === fe.file) {
      const i = oe.file(ol(Oe(t), n));
      return t.with({
        authority: i.authority,
        path: i.path
      });
    }
    return n = _u(n), t.with({
  ...
  isEqualAuthority(t, n) {
    return t === n || t !== void 0 && n !== void 0 && Aa(t, n);
  }
  hasTrailingPathSeparator(t, n = un) {
    if (t.scheme === fe.file) {
      const i = Oe(t);
      return i.length > Pr(i).length && i[i.length - 1] === n;
    } else {
      const i = t.path;
  ...
  removeTrailingPathSeparator(t, n = un) {
    return Vr(t, n) ? t.with({ path: t.path.substr(0, t.path.length - 1) }) : t;
  }
  addTrailingPathSeparator(t, n = un) {
    let i = !1;
    if (t.scheme === fe.file) {
      const r = Oe(t);
      i = r !== void 0 && r.length === Pr(r).length && r[r.length - 1] === n;
    } else {
      n = "/";
      const r = t.path;
      i = r.length === 1 && r.charCodeAt(r.length - 1) === w.Slash;
    }
    return !i && !Vr(t, n) ? t.with({ path: t.path + "/" }) : t;
  }
}
const Z = new Eu(() => !1);
Z.isEqual.bind(Z);
...
const Or = Z.isEqualAuthority.bind(Z), Vr = Z.hasTrailingPathSeparator.bind(Z);
...
const Tu = "workerTextModelSync";
class Uu {
  constructor() {
    this._models = /* @__PURE__ */ Object.create(null);
  }
  bindToServer(t) {
    t.setChannel(Tu, this);
  }
  getModel(t) {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new Mu(oe.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class Mu extends Ru {
  ...
  getWordAtPosition(t, n) {
    const i = _i(t.column, _s(n), this._lines[t.lineNumber - 1], 0);
    return i ? new F(
      t.lineNumber,
      i.startColumn,
      t.lineNumber,
...
const Ye = class Ye {
  constructor(t = null) {
    this._foreignModule = t, this._workerTextModelSyncServer = new Uu();
  }
  dispose() {
  }
  async $ping() {
  ...
  async $computeDiff(t, n, i, r) {
    ...
    return !s || !a ? null : Ye.computeDiff(s, a, i, r);
  }
  static computeDiff(t, n, i, r) {
    const s = r === "advanced" ? yn.getDefault() : yn.getLegacy(), a = t.getLinesContent(), u = n.getLinesContent(), o = s.computeDiff(a, u, i), c = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function h(f) {
      return f.map(
        (_) => {
          var p;
  ...
  async $computeMoreMinimalEdits(t, n, i) {
    ...
    for (let { range: o, text: c, eol: h } of n) {
      ...
      if (c = c.replace(/\r\n|\n|\r/g, r.eol), f === c)
        continue;
      if (Math.max(c.length, f.length) > Ye._diffLimit) {
        s.push({ range: o, text: c });
        continue;
      }
      const _ = qa(f, c, i), p = r.offsetAt(F.lift(o).getStartPosition());
      for (const d of _) {
        const b = r.positionAt(p + d.originalStart), A = r.positionAt(p + d.originalStart + d.originalLength), R = {
        ...
        r.getValueInRange(R.range) !== R.text && s.push(R);
      }
    }
  ...
  $computeHumanReadableDiff(t, n, i) {
    ...
    for (let { range: u, text: o, eol: c } of n) {
      let b = function(R, x) {
        return new $(
          R.lineNumber + x.lineNumber - 1,
          x.lineNumber === 1 ? R.column + x.column - 1 : x.column
        );
      }, A = function(R, x) {
        const v = [];
        for (let S = x.startLineNumber; S <= x.endLineNumber; S++) {
          const N = R[S - 1];
          S === x.startLineNumber && S === x.endLineNumber ? v.push(N.substring(x.startColumn - 1, x.endColumn - 1)) : S === x.startLineNumber ? v.push(N.substring(x.startColumn - 1)) : S === x.endLineNumber ? v.push(N.substring(0, x.endColumn - 1)) : v.push(N);
        }
        return v;
      };
      ...
      if (o = o.replace(/\r\n|\n|\r/g, r.eol), h === o)
        continue;
      if (Math.max(o.length, h.length) > Ye._diffLimit) {
        s.push({ range: u, text: o });
        continue;
      }
      const f = h.split(/\r\n|\n|\r/), _ = o.split(/\r\n|\n|\r/), p = yn.getDefault().computeDiff(f, _, i), d = F.lift(u).getStartPosition();
      for (const R of p.changes)
        if (R.innerChanges)
          for (const x of R.innerChanges)
            s.push({
  ...
  async $textualSuggest(t, n, i, r) {
    const s = new Mn(), a = new RegExp(i, r), u = /* @__PURE__ */ new Set();
    e: for (const o of t) {
      const c = this._getModel(o);
      if (c) {
        for (const h of c.words(a))
          if (!(h === n || !isNaN(Number(h))) && (u.add(h), u.size > Ye._suggestionsLimit))
            break e;
      }
    }
  ...
  async $navigateValueSet(t, n, i, r, s) {
    ...
    return Xn.INSTANCE.navigateValueSet(n, o, c, h, i);
  }
  $fmr(t, n) {
...
Ye._diffLimit = 1e5, Ye._suggestionsLimit = 1e4;
let oi = Ye;
typeof importScripts == "function" && (globalThis.monaco = Al());
Va(() => new oi(null));
const Gt = class Gt {
  static getChannel(t) {
    return t.getChannel(Gt.CHANNEL_NAME);
  }
  static setChannel(t, n) {
    t.setChannel(Gt.CHANNEL_NAME, n);
  }
};
