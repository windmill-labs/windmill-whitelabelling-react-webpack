...
class Jl {
  constructor() {
    this.listeners = [], this.unexpectedErrorHandler = function(t) {
      setTimeout(() => {
        throw t.stack ? Qt.isErrorNoTelemetry(t) ? new Qt(t.message + `
...
function Ei(e) {
  if (e instanceof Error) {
    ...
    return {
      ...
      message: n,
      stack: r,
      noTelemetry: Qt.isErrorNoTelemetry(e),
      cause: i ? Ei(i) : void 0,
      code: e.code
    };
  }
...
const Ri = "Canceled";
function Kl(e) {
  return e instanceof eu ? !0 : e instanceof Error && e.name === Ri && e.message === Ri;
}
class eu extends Error {
  constructor() {
    super(Ri), this.name = this.message;
  }
}
const qt = class qt extends Error {
  static is(t) {
    return t instanceof qt || t instanceof Error && t.name === qt._name;
  }
  constructor(t) {
    super(t), this.name = qt._name;
  }
};
qt._name = "PendingMigrationError";
let Dr = qt;
...
function Zt(e, t, n = 0, i = e.length) {
  let r = n, s = i;
  for (; r < s; ) {
...
const mi = class mi {
  ...
  findLastMonotonous(t) {
    ...
    const n = Zt(this._array, t, this._findLastMonotonousLastIdx);
    return this._findLastMonotonousLastIdx = n + 1, n === -1 ? void 0 : this._array[n];
  }
};
mi.assertInvariants = !1;
let qn = mi;
function dl(e, t, n = (i, r) => i === r) {
  if (e === t)
    return !0;
...
const Vt = class Vt {
  ...
  filter(t) {
    return new Vt((n) => this.iterate((i) => t(i) ? n(i) : !0));
  }
  map(t) {
    return new Vt((n) => this.iterate((i) => n(t(i))));
  }
  some(t) {
    let n = !1;
...
const Lt = class Lt {
  constructor(t, n) {
    if (this[Ir] = "ResourceMap", t instanceof Lt)
  ...
  set(t, n) {
    return this.map.set(this.toKey(t), new uu(t, n)), this;
  }
  get(t) {
...
class hu {
  ...
  get(t, n = Ae.None) {
    ...
    if (i)
      return n !== Ae.None && this.touch(i, n), i.value;
  }
  set(t, n, i = Ae.None) {
    let r = this._map.get(t);
    if (r)
      r.value = n, i !== Ae.None && this.touch(r, i);
    else {
...
class du extends hu {
  ...
  peek(t) {
    return super.get(t, Ae.None);
  }
  set(t, n) {
    return super.set(t, n, Ae.AsNew), this;
  }
  checkTrim() {
...
function pu(e, t = "Unreachable") {
  throw new Error(t);
}
function gu(e, t = "unexpected state") {
  if (!e)
...
const fi = class fi {
  ...
  add(t) {
    ...
    return this._isDisposed ? fi.DISABLE_DISPOSED_WARNING || console.warn(new Error(
...
const Tu = globalThis.performance.now.bind(globalThis.performance);
class _i {
  static create(t) {
    return new _i(t);
  }
  constructor(t) {
    this._now = t === !1 ? Date.now : Tu, this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(e) {
  ...
  function n(U) {
    return (y, M = null, I) => {
      ...
      return C = U((q) => {
        if (!F)
          return C ? C.dispose() : F = !0, y.call(M, q);
      }, null, I), F && C.dispose(), C;
    };
  }
  e.once = n;
  function i(U, y) {
    return e.once(e.filter(U, y));
  }
  e.onceIf = i;
  function r(U, y, M) {
    return c((I, F = null, C) => U((q) => I.call(F, y(q)), null, C), M);
  }
  e.map = r;
  function s(U, y, M) {
    return c((I, F = null, C) => U((q) => {
      y(q), I.call(F, q);
    }, null, C), M);
  }
  e.forEach = s;
  function a(U, y, M) {
    return c((I, F = null, C) => U((q) => y(q) && I.call(F, q), null, C), M);
  }
  e.filter = a;
  function l(U) {
    return U;
  ...
  function o(...U) {
    return (y, M = null, I) => {
      const F = wu(...U.map((C) => C((q) => y.call(M, q))));
      return d(F, I);
    };
  }
  e.any = o;
  ...
  function c(U, y) {
    ...
    return y?.add(F), F.event;
  }
  function d(U, y) {
    return y instanceof Array ? y.push(U) : y && y.add(U), U;
  }
  function m(U, y, M = 100, I = !1, F = !1, C, q) {
    let V, Z, se, be = 0, Oe;
    const wi = {
      leakWarningThreshold: C,
      onWillAddFirstListener() {
        V = U((Yl) => {
          be++, Z = y(Z, Yl), I && !se && (Sn.fire(Z), Z = void 0), Oe = () => {
            const Ql = Z;
            Z = void 0, se = void 0, (!I || be > 1) && Sn.fire(Ql), be = 0;
          }, typeof M == "number" ? (se && clearTimeout(se), se = setTimeout(Oe, M)) : se === void 0 && (se = null, queueMicrotask(Oe));
        });
      },
    ...
    return q?.add(Sn), Sn.event;
  }
  e.debounce = m;
  function g(U, y = 0, M) {
    return e.debounce(U, (I, F) => I ? (I.push(F), I) : [F], y, void 0, !0, void 0, M);
  }
  e.accumulate = g;
  function _(U, y = (I, F) => I === F, M) {
    let I = !0, F;
    return a(U, (C) => {
      const q = I || !y(C, F);
      return I = !1, F = C, q;
  ...
  e.split = p;
  function L(U, y = !1, M = [], I) {
    let F = M.slice(), C = U((Z) => {
      F ? F.push(Z) : V.fire(Z);
    });
    I && I.add(C);
    const q = () => {
      F?.forEach((Z) => V.fire(Z)), F = null;
    }, V = new ze({
      onWillAddFirstListener() {
        C || (C = U((Z) => V.fire(Z)), I && I.add(C));
      },
  ...
  class E {
    ...
    forEach(y) {
      return this.steps.push((M) => (y(M), M)), this;
    }
    filter(y) {
      return this.steps.push((M) => y(M) ? M : w), this;
    }
    reduce(y, M) {
      let I = M;
      return this.steps.push((F) => (I = y(I, F), I)), this;
    }
    latch(y = (M, I) => M === I) {
      let M = !0, I;
      return this.steps.push((F) => {
        const C = M || !y(F, I);
        return M = !1, I = F, C ? F : w;
      }), this;
    }
    evaluate(y) {
  ...
  function H(U, y, M = (I) => I) {
    const I = (...V) => q.fire(M(...V)), F = () => U.on(y, I), C = () => U.removeListener(y, I), q = new ze(
      { onWillAddFirstListener: F, onDidRemoveLastListener: C }
    );
    return q.event;
  }
  e.fromNodeEventEmitter = H;
  function W(U, y, M = (I) => I) {
    const I = (...V) => q.fire(M(...V)), F = () => U.addEventListener(y, I), C = () => U.removeEventListener(y, I), q = new ze(
      { onWillAddFirstListener: F, onDidRemoveLastListener: C }
    );
    return q.event;
  }
  ...
  class P {
    constructor(y, M) {
      ...
      this.emitter = new ze(I), M && M.add(this.emitter);
    }
    beginUpdate(y) {
      this._counter++;
    }
  ...
  function S(U, y) {
    return new P(U, y).emitter.event;
  }
  e.fromObservable = S;
  function k(U) {
    return (y, M, I) => {
      ...
      const q = {
        ...
        endUpdate() {
          F--, F === 0 && (U.reportChanges(), C && (C = !1, y.call(M)));
        },
      ...
      U.addObserver(q), U.reportChanges();
      const V = {
        dispose() {
          U.removeObserver(q);
        }
...
const Ct = class Ct {
  constructor(t) {
    this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${t}_${Ct._idPool++}`, Ct.all.add(this);
  }
  start(t) {
...
Ct.all = /* @__PURE__ */ new Set(), Ct._idPool = 0;
let Di = Ct, xu = -1;
const pi = class pi {
  constructor(t, n, i = (pi._idPool++).toString(16).padStart(3, "0")) {
...
class vi {
  constructor(t) {
    this.value = t, this.id = Lu++;
  }
}
const ku = 2;
class ze {
  constructor(t) {
    this._size = 0, this._options = t, this._leakageMon = this._options?.leakWarningThreshold ? new Ui(
      t?.onListenerError ?? cn,
      this._options?.leakWarningThreshold ?? xu
    ) : void 0, this._perfMon = this._options?._profName ? new Di(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
  ...
  get event() {
    return this._event ??= (t, n, i) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(l);
        const o = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], u = new Au(
          `${l}. HINT: Stack shows most frequent listener (${o[1]}-times)`,
          o[0]
        );
        return (this._options?.onListenerError || cn)(u), Kt.None;
      }
      if (this._disposed)
        return Kt.None;
      n && (t = t.bind(n));
      const r = new vi(t);
      let s;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (r.stack = xr.create(), s = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof vi ? (this._deliveryQueue ??= new Eu(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
      const a = Tn(() => {
  ...
  _deliver(t, n) {
    if (!t)
      return;
    const i = this._options?.onListenerError || cn;
    if (!i) {
      t.value(n);
      return;
    }
  ...
  fire(t) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof vi)
...
const Su = fl() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
function Pr(e, t) {
  let n;
  ...
  }), Su && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
function Q(e, t, ...n) {
  return Pr(typeof e == "number" ? Nu(e, t) : t, n);
}
function Nu(e, t) {
  const n = Ru()?.[e];
  if (typeof n != "string") {
...
const Ot = "en";
let yn = !1, An = !1, Fn = !1, pl = !1, yr = !1, gl = !1, Nn, Pn = Ot, Br = Ot, Mu, at;
const dt = globalThis;
let De;
typeof dt.vscode < "u" && typeof dt.vscode.process < "u" ? De = dt.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (De = process);
const Du = typeof De?.versions?.electron == "string", Uu = Du && De?.type === "renderer";
if (typeof De == "object") {
  yn = De.platform === "win32", An = De.platform === "darwin", Fn = De.platform === "linux", Fn && De.env.SNAP && De.env.SNAP_REVISION, De.env.CI || De.env.BUILD_ARTIFACTSTAGINGDIRECTORY || De.env.GITHUB_WORKSPACE, Nn = Ot, Pn = Ot;
  const e = De.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      Nn = t.userLocale, Br = t.osLocale, Pn = t.resolvedLanguage || Ot, Mu = t.languagePack?.translationsConfigFile;
    } catch {
    }
  pl = !0;
} else typeof navigator == "object" && !Uu ? (at = navigator.userAgent, yn = at.indexOf("Windows") >= 0, An = at.indexOf("Macintosh") >= 0, gl = (at.indexOf("Macintosh") >= 0 || at.indexOf("iPad") >= 0 || at.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Fn = at.indexOf("Linux") >= 0, at?.indexOf("Mobi") >= 0, yr = !0, Pn = fl() || Ot, Nn = navigator.language.toLowerCase(), Br = Nn) : console.error("Unable to resolve platform.");
var Xt;
(function(e) {
  e[e.Web = 0] = "Web", e[e.Mac = 1] = "Mac", e[e.Linux = 2] = "Linux", e[e.Windows = 3] = "Windows";
})(Xt || (Xt = {}));
Xt.Web;
An ? Xt.Mac : yn ? Xt.Windows : Fn && Xt.Linux;
const en = yn, Iu = An, Fu = pl, Pu = yr, Bu = yr && typeof dt.importScripts == "function", Hu = Bu ? dt.origin : void 0, nt = at, ft = Pn;
var Hr;
(function(e) {
  function t() {
    return ft;
  ...
  e.value = t;
  function n() {
    return ft.length === 2 ? ft === "en" : ft.length >= 3 ? ft[0] === "e" && ft[1] === "n" && ft[2] === "-" : !1;
  }
...
const Ou = typeof dt.postMessage == "function" && !dt.importScripts;
(() => {
  if (Ou) {
    const e = [];
...
An || gl ? dn.Macintosh : yn ? dn.Windows : dn.Linux;
const zu = !!(nt && nt.indexOf("Chrome") >= 0);
nt && nt.indexOf("Firefox") >= 0;
!zu && nt && nt.indexOf("Safari") >= 0;
nt && nt.indexOf("Edg/") >= 0;
nt && nt.indexOf("Android") >= 0;
const bl = Object.freeze(function(e, t) {
...
(function(e) {
  function t(n) {
    return n === e.None || n === e.Cancelled || n instanceof Bn ? !0 : !n || typeof n != "object" ? !1 : typeof n.isCancellationRequested == "boolean" && typeof n.onCancellationRequested == "function";
  }
...
class Bn {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? bl : (this._emitter || (this._emitter = new ze()), this._emitter.event);
  }
  dispose() {
...
class Wu {
  ...
  get token() {
    return this._token || (this._token = new Bn()), this._token;
  }
  cancel() {
    this._token ? this._token instanceof Bn && this._token.cancel() : this._token = Gn.Cancelled;
  }
  dispose(t = !1) {
    t && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof Bn && this._token.dispose() : this._token = Gn.None;
  }
}
function qu(e) {
  return e;
...
class Vu {
  constructor(t, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof t == "function" ? (this._fn = t, this._computeKey = qu) : (this._fn = n, this._computeKey = t.getCacheKey);
  }
  get(t) {
...
function Yu(e, t, n = 0, i = e.length, r = 0, s = t.length) {
  for (; n < i && r < s; n++, r++) {
...
function wl(e, t, n = 0, i = e.length, r = 0, s = t.length) {
  for (; n < i && r < s; n++, r++) {
    let o = e.charCodeAt(n), u = t.charCodeAt(r);
    if (o === u)
      continue;
    if (o >= 128 || u >= 128)
      return Yu(e.toLowerCase(), t.toLowerCase(), n, i, r, s);
    Wr(o) && (o -= 32), Wr(u) && (u -= 32);
    const c = o - u;
    if (c !== 0)
      return c;
...
function Qu(e, t) {
  return e.length === t.length && wl(e, t) === 0;
}
function Ju(e, t) {
  const n = t.length;
  return t.length > e.length ? !1 : wl(e, t, 0, n) === 0;
}
function jn(e, t) {
...
String.fromCharCode(N.UTF8_BOM);
var qr;
(function(e) {
...
const Je = class Je {
  static getInstance(t) {
    return Je.cache.get(Array.from(t));
  }
  static getLocales() {
    return Je._locales.value;
  }
  constructor(t) {
...
Je.ambiguousCharacterData = new Or(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,1523,96,8242,96,1370,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,118002,50,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,118003,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,118004,52,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,118005,53,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,118006,54,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,118007,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,118008,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,118009,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,117974,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,117975,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71913,67,71922,67,65315,67,8557,67,8450,67,8493,67,117976,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,117977,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,117978,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,117979,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,117980,71,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,117981,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,117983,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,117984,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,118001,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,117982,108,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,117985,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,117986,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,117987,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,118000,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,117988,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,117989,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,117990,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,117991,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,117992,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,117993,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,117994,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,117995,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71910,87,71919,87,117996,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,117997,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,117998,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,71909,90,66293,90,65338,90,8484,90,8488,90,117999,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65283,35,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"cs":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"es":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"fr":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"it":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ja":[8211,45,8218,44,65281,33,8216,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65292,44,65297,49,65307,59],"ko":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pt-BR":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ru":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"zh-hans":[160,32,65374,126,8218,44,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65297,49],"zh-hant":[8211,45,65374,126,8218,44,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89]}')), Je.cache = new Vu({ getCacheKey: JSON.stringify }, (t) => {
  ...
  const s = Je.ambiguousCharacterData.value;
  ...
  return new Je(u);
}), Je._locales = new Or(() => Object.keys(Je.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
let Ln = Je;
const kt = class kt {
  static getRawData() {
  ...
  static containsInvisibleCharacter(t) {
    for (let n = 0; n < t.length; n++) {
      const i = t.codePointAt(n);
      if (typeof i == "number" && (kt.isInvisibleCharacter(i) || i === Fi.space))
        return !0;
    }
    return !1;
  }
...
kt._data = void 0;
let mn = kt;
const Ti = "default", ic = "$initialize";
var Ie;
(function(e) {
...
class lc {
  ...
  sendMessage(t, n, i) {
    ...
    return new Promise((s, a) => {
      this._pendingReplies[r] = {
        resolve: s,
        reject: a
      }, this._send(new rc(this._workerId, r, t, n, i));
    });
  }
  listen(t, n, i) {
    let r = null;
    const s = new ze({
      onWillAddFirstListener: () => {
        r = String(++this._lastSentReq), this._pendingEmitters.set(r, s), this._send(new sc(this._workerId, r, t, n, i));
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(r), this._send(new oc(this._workerId, r)), r = null;
      }
    });
    return s.event;
  }
  ...
  createProxyToRemoteChannel(t, n) {
    const i = {
      get: (r, s) => (typeof s == "string" && !r[s] && (xl(s) ? r[s] = (a) => this.listen(t, s, a) : Tl(s) ? r[s] = this.listen(t, s, void 0) : s.charCodeAt(0) === N.DollarSign && (r[s] = async (...a) => (await n?.(), this.sendMessage(t, s, a)))), r[s])
    };
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.channel, t.method, t.args).then((r) => {
      this._send(new Vr(this._workerId, n, r, void 0));
    }, (r) => {
      r.detail instanceof Error && (r.detail = Ei(r.detail)), this._send(new Vr(this._workerId, n, void 0, Ei(r)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, i = this._handler.handleEvent(t.channel, t.eventName, t.arg)((r) => {
      this._send(new ac(this._workerId, n, r));
    });
...
function Tl(e) {
  return e[0] === "o" && e[1] === "n" && vl(e.charCodeAt(2));
}
function xl(e) {
  return /^onDynamic/.test(e) && vl(e.charCodeAt(9));
}
class uc {
  constructor(t, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new lc({
      sendMessage: (i, r) => {
        t(i, r);
      },
...
function dc(e, t, n) {
  return new vt(new jr(e), new jr(t)).ComputeDiff(n).changes;
}
class Ut {
  static Assert(t, n) {
    if (!t)
...
class $r {
  ...
  MarkNextChange() {
    (this.m_originalCount > 0 || this.m_modifiedCount > 0) && this.m_changes.push(new gt(
...
class vt {
  constructor(t, n, i = null) {
    ...
    const [r, s, a] = vt._getElements(t), [l, o, u] = vt._getElements(n);
  ...
  ElementsAreStrictEqual(t, n) {
    if (!this.ElementsAreEqual(t, n))
      return !1;
    const i = vt._getStrictElement(this._originalSequence, t), r = vt._getStrictElement(this._modifiedSequence, n);
    return i === r;
  }
  ...
  ComputeDiffRecursive(t, n, i, r, s) {
    ...
    if (t > n || i > r) {
      let d;
      return i <= r ? (Ut.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), d = [
        new gt(t, 0, i, r - i + 1)
      ]) : t <= n ? (Ut.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"), d = [
        new gt(t, n - t + 1, i, 0)
      ]) : (Ut.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), Ut.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"), d = []), d;
    }
  ...
  WALKTRACE(t, n, i, r, s, a, l, o, u, c, d, m, g, _, p, L, A, w) {
    let E = null, H = null, W = new $r(), z = n, b = i, f = g[0] - L[0] - r, v = Ve.MIN_SAFE_SMALL_INTEGER, P = this.m_forwardHistory.length - 1;
    do {
      const S = f + t;
      S === z || S < b && u[S - 1] < u[S + 1] ? (d = u[S + 1], _ = d - f - r, d < v && W.MarkNextChange(), v = d, W.AddModifiedElement(d + 1, _), f = S + 1 - t) : (d = u[S - 1] + 1, _ = d - f - r, d < v && W.MarkNextChange(), v = d - 1, W.AddOriginalElement(d, _ + 1), f = S - 1 - t), P >= 0 && (u = this.m_forwardHistory[P], t = u[0], z = 1, b = u.length - 1);
    } while (--P >= -1);
    if (E = W.getReverseChanges(), w[0]) {
      let S = g[0] + 1, k = L[0] + 1;
      if (E !== null && E.length > 0) {
        const U = E[E.length - 1];
        S = Math.max(S, U.getOriginalEnd()), k = Math.max(k, U.getModifiedEnd());
      }
      H = [
        new gt(
          S,
      ...
      W = new $r(), z = a, b = l, f = g[0] - L[0] - o, v = Ve.MAX_SAFE_SMALL_INTEGER, P = A ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const S = f + s;
        S === z || S < b && c[S - 1] >= c[S + 1] ? (d = c[S + 1] - 1, _ = d - f - o, d > v && W.MarkNextChange(), v = d + 1, W.AddOriginalElement(d + 1, _ + 1), f = S + 1 - s) : (d = c[S - 1], _ = d - f - o, d > v && W.MarkNextChange(), v = d, W.AddModifiedElement(d + 1, _ + 1), f = S - 1 - s), P >= 0 && (c = this.m_reverseHistory[P], s = c[0], z = 1, b = c.length - 1);
      } while (--P >= -1);
      H = W.getChanges();
    }
    ...
    for (let f = 1; f <= _ / 2 + 1; f++) {
      ...
      for (let k = c; k <= d; k += 2) {
        ...
        if (L[k] = o, o + u > v + P && (v = o, P = u), !b && Math.abs(k - E) <= f - 1 && o >= A[k])
          return s[0] = o, a[0] = u, U <= A[k] && ot.MaxDifferencesHistory > 0 && f <= ot.MaxDifferencesHistory + 1 ? this.WALKTRACE(w, c, d, H, E, m, g, W, L, A, o, n, s, u, r, a, b, l) : null;
      }
      const S = (v - t + (P - i) - f) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(v, S))
        return l[0] = !0, s[0] = v, a[0] = P, S > 0 && ot.MaxDifferencesHistory > 0 && f <= ot.MaxDifferencesHistory + 1 ? this.WALKTRACE(w, c, d, H, E, m, g, W, L, A, o, n, s, u, r, a, b, l) : (t++, i++, [
          new gt(
            t,
            n - t + 1,
            i,
      ...
      for (let k = m; k <= g; k += 2) {
        ...
        if (A[k] = o, b && Math.abs(k - w) <= f && o <= L[k])
          return s[0] = o, a[0] = u, U >= L[k] && ot.MaxDifferencesHistory > 0 && f <= ot.MaxDifferencesHistory + 1 ? this.WALKTRACE(w, c, d, H, E, m, g, W, L, A, o, n, s, u, r, a, b, l) : null;
      }
      if (f <= ot.MaxDifferencesHistory) {
        let k = new Int32Array(d - c + 2);
        k[0] = w - c + 1, It.Copy2(L, c, k, 1, d - c + 1), this.m_forwardHistory.push(k), k = new Int32Array(g - m + 2), k[0] = E - m + 1, It.Copy2(A, m, k, 1, g - m + 1), this.m_reverseHistory.push(k);
      }
    }
  ...
  ChangesOverlap(t, n, i) {
    if (Ut.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), Ut.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      ...
      return t.originalStart + t.originalLength >= n.originalStart && (s = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (l = n.modifiedStart + n.modifiedLength - t.modifiedStart), i[0] = new gt(r, s, a, l), !0;
    } else
      return i[0] = null, !1;
  }
...
let te = class At {
  ...
  with(t = this.lineNumber, n = this.column) {
    return t === this.lineNumber && n === this.column ? this : new At(t, n);
  }
  delta(t = 0, n = 0) {
  ...
  static lift(t) {
    return new At(t.lineNumber, t.column);
  }
...
function pc() {
  return xi === null && (xi = new fc([
    ...
    [Y.HTT, N.p, Y.HTTP],
    [Y.HTT, N.P, Y.HTTP],
    [Y.HTTP, N.s, Y.BeforeColon],
    [Y.HTTP, N.S, Y.BeforeColon],
    [Y.HTTP, N.Colon, Y.AfterColon],
    [Y.F, N.i, Y.FI],
    [Y.F, N.I, Y.FI],
    [Y.FI, N.l, Y.FIL],
    [Y.FI, N.L, Y.FIL],
    [Y.FIL, N.e, Y.BeforeColon],
    [Y.FIL, N.E, Y.BeforeColon],
    [Y.BeforeColon, N.Colon, Y.AfterColon],
    [Y.AfterColon, N.Slash, Y.AlmostThere],
    [Y.AlmostThere, N.Slash, Y.End]
  ])), xi;
}
var le;
(function(e) {
...
function gc() {
  if (sn === null) {
    ...
    const e = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…|`;
    for (let n = 0; n < e.length; n++)
      sn.set(e.charCodeAt(n), le.ForceTermination);
    const t = ".,;:";
    for (let n = 0; n < t.length; n++)
      sn.set(t.charCodeAt(n), le.CannotEndIn);
  }
  return sn;
}
class Xn {
  static _createLink(t, n, i, r, s) {
    ...
    if (r > 0) {
      ...
      (l === N.OpenParen && o === N.CloseParen || l === N.OpenSquareBracket && o === N.CloseSquareBracket || l === N.OpenCurlyBrace && o === N.CloseCurlyBrace) && a--;
    }
    return {
      range: {
        startLineNumber: i,
        ...
        if (m === Y.Accept) {
          ...
          switch (w) {
            ...
            case N.CloseSquareBracket:
              ...
              break;
            case N.OpenCurlyBrace:
              L = !0, E = le.None;
              break;
            case N.CloseCurlyBrace:
              E = L ? le.None : le.ForceTermination;
              break;
            case N.SingleQuote:
            case N.DoubleQuote:
            case N.BackTick:
              d === w ? E = le.ForceTermination : d === N.SingleQuote || d === N.DoubleQuote || d === N.BackTick ? E = le.None : E = le.ForceTermination;
              break;
            case N.Asterisk:
              E = d === N.Asterisk ? le.ForceTermination : le.None;
              break;
            case N.Space:
          ...
          E === le.ForceTermination && (r.push(Xn._createLink(i, l, s, c, u)), A = !0);
        } else if (m === Y.End) {
          let E;
          w === N.OpenSquareBracket ? (_ = !0, E = le.None) : E = i.get(w), E === le.ForceTermination ? A = !0 : m = Y.Accept;
        } else
          m = n.nextState(m, w), m === Y.Invalid && (A = !0);
        A && (m = Y.Start, g = !1, _ = !1, L = !1, c = u + 1, d = w), u++;
      }
      m === Y.Accept && r.push(Xn._createLink(i, l, s, c, o));
    }
    return r;
  }
}
...
class Lr {
  ...
  strToKeyCode(t) {
    return this._strToKeyCode[t.toLowerCase()] || T.Unknown;
  }
}
const Hn = new Lr(), Hi = new Lr(), Oi = new Lr(), _c = new Array(230), wc = /* @__PURE__ */ Object.create(null), vc = /* @__PURE__ */ Object.create(null), zi = [];
for (let e = 0; e <= x.MAX_VALUE; e++)
  T.DependsOnKbLayout;
for (let e = 0; e <= T.MAX_VALUE; e++)
  zi[e] = x.DependsOnKbLayout;
(function() {
  const e = "", t = [
    [1, x.None, "None", T.Unknown, "unknown", 0, "VK_UNKNOWN", e, e],
    [1, x.Hyper, "Hyper", T.Unknown, e, 0, e, e, e],
    [1, x.Super, "Super", T.Unknown, e, 0, e, e, e],
    [1, x.Fn, "Fn", T.Unknown, e, 0, e, e, e],
    [1, x.FnLock, "FnLock", T.Unknown, e, 0, e, e, e],
    [1, x.Suspend, "Suspend", T.Unknown, e, 0, e, e, e],
    [1, x.Resume, "Resume", T.Unknown, e, 0, e, e, e],
    [1, x.Turbo, "Turbo", T.Unknown, e, 0, e, e, e],
    [1, x.Sleep, "Sleep", T.Unknown, e, 0, "VK_SLEEP", e, e],
    [1, x.WakeUp, "WakeUp", T.Unknown, e, 0, e, e, e],
    [0, x.KeyA, "KeyA", T.KeyA, "A", 65, "VK_A", e, e],
    [0, x.KeyB, "KeyB", T.KeyB, "B", 66, "VK_B", e, e],
    [0, x.KeyC, "KeyC", T.KeyC, "C", 67, "VK_C", e, e],
    [0, x.KeyD, "KeyD", T.KeyD, "D", 68, "VK_D", e, e],
    [0, x.KeyE, "KeyE", T.KeyE, "E", 69, "VK_E", e, e],
    [0, x.KeyF, "KeyF", T.KeyF, "F", 70, "VK_F", e, e],
    [0, x.KeyG, "KeyG", T.KeyG, "G", 71, "VK_G", e, e],
    [0, x.KeyH, "KeyH", T.KeyH, "H", 72, "VK_H", e, e],
    [0, x.KeyI, "KeyI", T.KeyI, "I", 73, "VK_I", e, e],
    [0, x.KeyJ, "KeyJ", T.KeyJ, "J", 74, "VK_J", e, e],
    [0, x.KeyK, "KeyK", T.KeyK, "K", 75, "VK_K", e, e],
    [0, x.KeyL, "KeyL", T.KeyL, "L", 76, "VK_L", e, e],
    [0, x.KeyM, "KeyM", T.KeyM, "M", 77, "VK_M", e, e],
    [0, x.KeyN, "KeyN", T.KeyN, "N", 78, "VK_N", e, e],
    [0, x.KeyO, "KeyO", T.KeyO, "O", 79, "VK_O", e, e],
    [0, x.KeyP, "KeyP", T.KeyP, "P", 80, "VK_P", e, e],
    [0, x.KeyQ, "KeyQ", T.KeyQ, "Q", 81, "VK_Q", e, e],
    [0, x.KeyR, "KeyR", T.KeyR, "R", 82, "VK_R", e, e],
    [0, x.KeyS, "KeyS", T.KeyS, "S", 83, "VK_S", e, e],
    [0, x.KeyT, "KeyT", T.KeyT, "T", 84, "VK_T", e, e],
    [0, x.KeyU, "KeyU", T.KeyU, "U", 85, "VK_U", e, e],
    [0, x.KeyV, "KeyV", T.KeyV, "V", 86, "VK_V", e, e],
    [0, x.KeyW, "KeyW", T.KeyW, "W", 87, "VK_W", e, e],
    [0, x.KeyX, "KeyX", T.KeyX, "X", 88, "VK_X", e, e],
    [0, x.KeyY, "KeyY", T.KeyY, "Y", 89, "VK_Y", e, e],
    [0, x.KeyZ, "KeyZ", T.KeyZ, "Z", 90, "VK_Z", e, e],
    [0, x.Digit1, "Digit1", T.Digit1, "1", 49, "VK_1", e, e],
    [0, x.Digit2, "Digit2", T.Digit2, "2", 50, "VK_2", e, e],
    [0, x.Digit3, "Digit3", T.Digit3, "3", 51, "VK_3", e, e],
    [0, x.Digit4, "Digit4", T.Digit4, "4", 52, "VK_4", e, e],
    [0, x.Digit5, "Digit5", T.Digit5, "5", 53, "VK_5", e, e],
    [0, x.Digit6, "Digit6", T.Digit6, "6", 54, "VK_6", e, e],
    [0, x.Digit7, "Digit7", T.Digit7, "7", 55, "VK_7", e, e],
    [0, x.Digit8, "Digit8", T.Digit8, "8", 56, "VK_8", e, e],
    [0, x.Digit9, "Digit9", T.Digit9, "9", 57, "VK_9", e, e],
    [0, x.Digit0, "Digit0", T.Digit0, "0", 48, "VK_0", e, e],
    [1, x.Enter, "Enter", T.Enter, "Enter", 13, "VK_RETURN", e, e],
    [1, x.Escape, "Escape", T.Escape, "Escape", 27, "VK_ESCAPE", e, e],
    [1, x.Backspace, "Backspace", T.Backspace, "Backspace", 8, "VK_BACK", e, e],
    [1, x.Tab, "Tab", T.Tab, "Tab", 9, "VK_TAB", e, e],
    [1, x.Space, "Space", T.Space, "Space", 32, "VK_SPACE", e, e],
    [0, x.Minus, "Minus", T.Minus, "-", 189, "VK_OEM_MINUS", "-", "OEM_MINUS"],
    [0, x.Equal, "Equal", T.Equal, "=", 187, "VK_OEM_PLUS", "=", "OEM_PLUS"],
    [0, x.BracketLeft, "BracketLeft", T.BracketLeft, "[", 219, "VK_OEM_4", "[", "OEM_4"],
    [0, x.BracketRight, "BracketRight", T.BracketRight, "]", 221, "VK_OEM_6", "]", "OEM_6"],
    [0, x.Backslash, "Backslash", T.Backslash, "\\", 220, "VK_OEM_5", "\\", "OEM_5"],
    [0, x.IntlHash, "IntlHash", T.Unknown, e, 0, e, e, e],
    [0, x.Semicolon, "Semicolon", T.Semicolon, ";", 186, "VK_OEM_1", ";", "OEM_1"],
    [0, x.Quote, "Quote", T.Quote, "'", 222, "VK_OEM_7", "'", "OEM_7"],
    [0, x.Backquote, "Backquote", T.Backquote, "`", 192, "VK_OEM_3", "`", "OEM_3"],
    [0, x.Comma, "Comma", T.Comma, ",", 188, "VK_OEM_COMMA", ",", "OEM_COMMA"],
    [0, x.Period, "Period", T.Period, ".", 190, "VK_OEM_PERIOD", ".", "OEM_PERIOD"],
    [0, x.Slash, "Slash", T.Slash, "/", 191, "VK_OEM_2", "/", "OEM_2"],
    [1, x.CapsLock, "CapsLock", T.CapsLock, "CapsLock", 20, "VK_CAPITAL", e, e],
    [1, x.F1, "F1", T.F1, "F1", 112, "VK_F1", e, e],
    [1, x.F2, "F2", T.F2, "F2", 113, "VK_F2", e, e],
    [1, x.F3, "F3", T.F3, "F3", 114, "VK_F3", e, e],
    [1, x.F4, "F4", T.F4, "F4", 115, "VK_F4", e, e],
    [1, x.F5, "F5", T.F5, "F5", 116, "VK_F5", e, e],
    [1, x.F6, "F6", T.F6, "F6", 117, "VK_F6", e, e],
    [1, x.F7, "F7", T.F7, "F7", 118, "VK_F7", e, e],
    [1, x.F8, "F8", T.F8, "F8", 119, "VK_F8", e, e],
    [1, x.F9, "F9", T.F9, "F9", 120, "VK_F9", e, e],
    [1, x.F10, "F10", T.F10, "F10", 121, "VK_F10", e, e],
    [1, x.F11, "F11", T.F11, "F11", 122, "VK_F11", e, e],
    [1, x.F12, "F12", T.F12, "F12", 123, "VK_F12", e, e],
    [1, x.PrintScreen, "PrintScreen", T.Unknown, e, 0, e, e, e],
    [1, x.ScrollLock, "ScrollLock", T.ScrollLock, "ScrollLock", 145, "VK_SCROLL", e, e],
    [1, x.Pause, "Pause", T.PauseBreak, "PauseBreak", 19, "VK_PAUSE", e, e],
    [1, x.Insert, "Insert", T.Insert, "Insert", 45, "VK_INSERT", e, e],
    [1, x.Home, "Home", T.Home, "Home", 36, "VK_HOME", e, e],
    [1, x.PageUp, "PageUp", T.PageUp, "PageUp", 33, "VK_PRIOR", e, e],
    [1, x.Delete, "Delete", T.Delete, "Delete", 46, "VK_DELETE", e, e],
    [1, x.End, "End", T.End, "End", 35, "VK_END", e, e],
    [1, x.PageDown, "PageDown", T.PageDown, "PageDown", 34, "VK_NEXT", e, e],
    [1, x.ArrowRight, "ArrowRight", T.RightArrow, "RightArrow", 39, "VK_RIGHT", "Right", e],
    [1, x.ArrowLeft, "ArrowLeft", T.LeftArrow, "LeftArrow", 37, "VK_LEFT", "Left", e],
    [1, x.ArrowDown, "ArrowDown", T.DownArrow, "DownArrow", 40, "VK_DOWN", "Down", e],
    [1, x.ArrowUp, "ArrowUp", T.UpArrow, "UpArrow", 38, "VK_UP", "Up", e],
    [1, x.NumLock, "NumLock", T.NumLock, "NumLock", 144, "VK_NUMLOCK", e, e],
    [1, x.NumpadDivide, "NumpadDivide", T.NumpadDivide, "NumPad_Divide", 111, "VK_DIVIDE", e, e],
    [1, x.NumpadMultiply, "NumpadMultiply", T.NumpadMultiply, "NumPad_Multiply", 106, "VK_MULTIPLY", e, e],
    [1, x.NumpadSubtract, "NumpadSubtract", T.NumpadSubtract, "NumPad_Subtract", 109, "VK_SUBTRACT", e, e],
    [1, x.NumpadAdd, "NumpadAdd", T.NumpadAdd, "NumPad_Add", 107, "VK_ADD", e, e],
    [1, x.NumpadEnter, "NumpadEnter", T.Enter, e, 0, e, e, e],
    [1, x.Numpad1, "Numpad1", T.Numpad1, "NumPad1", 97, "VK_NUMPAD1", e, e],
    [1, x.Numpad2, "Numpad2", T.Numpad2, "NumPad2", 98, "VK_NUMPAD2", e, e],
    [1, x.Numpad3, "Numpad3", T.Numpad3, "NumPad3", 99, "VK_NUMPAD3", e, e],
    [1, x.Numpad4, "Numpad4", T.Numpad4, "NumPad4", 100, "VK_NUMPAD4", e, e],
    [1, x.Numpad5, "Numpad5", T.Numpad5, "NumPad5", 101, "VK_NUMPAD5", e, e],
    [1, x.Numpad6, "Numpad6", T.Numpad6, "NumPad6", 102, "VK_NUMPAD6", e, e],
    [1, x.Numpad7, "Numpad7", T.Numpad7, "NumPad7", 103, "VK_NUMPAD7", e, e],
    [1, x.Numpad8, "Numpad8", T.Numpad8, "NumPad8", 104, "VK_NUMPAD8", e, e],
    [1, x.Numpad9, "Numpad9", T.Numpad9, "NumPad9", 105, "VK_NUMPAD9", e, e],
    [1, x.Numpad0, "Numpad0", T.Numpad0, "NumPad0", 96, "VK_NUMPAD0", e, e],
    [1, x.NumpadDecimal, "NumpadDecimal", T.NumpadDecimal, "NumPad_Decimal", 110, "VK_DECIMAL", e, e],
    [0, x.IntlBackslash, "IntlBackslash", T.IntlBackslash, "OEM_102", 226, "VK_OEM_102", e, e],
    [1, x.ContextMenu, "ContextMenu", T.ContextMenu, "ContextMenu", 93, e, e, e],
    [1, x.Power, "Power", T.Unknown, e, 0, e, e, e],
    [1, x.NumpadEqual, "NumpadEqual", T.Unknown, e, 0, e, e, e],
    [1, x.F13, "F13", T.F13, "F13", 124, "VK_F13", e, e],
    [1, x.F14, "F14", T.F14, "F14", 125, "VK_F14", e, e],
    [1, x.F15, "F15", T.F15, "F15", 126, "VK_F15", e, e],
    [1, x.F16, "F16", T.F16, "F16", 127, "VK_F16", e, e],
    [1, x.F17, "F17", T.F17, "F17", 128, "VK_F17", e, e],
    [1, x.F18, "F18", T.F18, "F18", 129, "VK_F18", e, e],
    [1, x.F19, "F19", T.F19, "F19", 130, "VK_F19", e, e],
    [1, x.F20, "F20", T.F20, "F20", 131, "VK_F20", e, e],
    [1, x.F21, "F21", T.F21, "F21", 132, "VK_F21", e, e],
    [1, x.F22, "F22", T.F22, "F22", 133, "VK_F22", e, e],
    [1, x.F23, "F23", T.F23, "F23", 134, "VK_F23", e, e],
    [1, x.F24, "F24", T.F24, "F24", 135, "VK_F24", e, e],
    [1, x.Open, "Open", T.Unknown, e, 0, e, e, e],
    [1, x.Help, "Help", T.Unknown, e, 0, e, e, e],
    [1, x.Select, "Select", T.Unknown, e, 0, e, e, e],
    [1, x.Again, "Again", T.Unknown, e, 0, e, e, e],
    [1, x.Undo, "Undo", T.Unknown, e, 0, e, e, e],
    [1, x.Cut, "Cut", T.Unknown, e, 0, e, e, e],
    [1, x.Copy, "Copy", T.Unknown, e, 0, e, e, e],
    [1, x.Paste, "Paste", T.Unknown, e, 0, e, e, e],
    [1, x.Find, "Find", T.Unknown, e, 0, e, e, e],
    [1, x.AudioVolumeMute, "AudioVolumeMute", T.AudioVolumeMute, "AudioVolumeMute", 173, "VK_VOLUME_MUTE", e, e],
    [1, x.AudioVolumeUp, "AudioVolumeUp", T.AudioVolumeUp, "AudioVolumeUp", 175, "VK_VOLUME_UP", e, e],
    [1, x.AudioVolumeDown, "AudioVolumeDown", T.AudioVolumeDown, "AudioVolumeDown", 174, "VK_VOLUME_DOWN", e, e],
    [1, x.NumpadComma, "NumpadComma", T.NUMPAD_SEPARATOR, "NumPad_Separator", 108, "VK_SEPARATOR", e, e],
    [0, x.IntlRo, "IntlRo", T.ABNT_C1, "ABNT_C1", 193, "VK_ABNT_C1", e, e],
    [1, x.KanaMode, "KanaMode", T.Unknown, e, 0, e, e, e],
    [0, x.IntlYen, "IntlYen", T.Unknown, e, 0, e, e, e],
    [1, x.Convert, "Convert", T.Unknown, e, 0, e, e, e],
    [1, x.NonConvert, "NonConvert", T.Unknown, e, 0, e, e, e],
    [1, x.Lang1, "Lang1", T.Unknown, e, 0, e, e, e],
    [1, x.Lang2, "Lang2", T.Unknown, e, 0, e, e, e],
    [1, x.Lang3, "Lang3", T.Unknown, e, 0, e, e, e],
    [1, x.Lang4, "Lang4", T.Unknown, e, 0, e, e, e],
    [1, x.Lang5, "Lang5", T.Unknown, e, 0, e, e, e],
    [1, x.Abort, "Abort", T.Unknown, e, 0, e, e, e],
    [1, x.Props, "Props", T.Unknown, e, 0, e, e, e],
    [1, x.NumpadParenLeft, "NumpadParenLeft", T.Unknown, e, 0, e, e, e],
    [1, x.NumpadParenRight, "NumpadParenRight", T.Unknown, e, 0, e, e, e],
    [1, x.NumpadBackspace, "NumpadBackspace", T.Unknown, e, 0, e, e, e],
    [1, x.NumpadMemoryStore, "NumpadMemoryStore", T.Unknown, e, 0, e, e, e],
    [1, x.NumpadMemoryRecall, "NumpadMemoryRecall", T.Unknown, e, 0, e, e, e],
    [1, x.NumpadMemoryClear, "NumpadMemoryClear", T.Unknown, e, 0, e, e, e],
    [1, x.NumpadMemoryAdd, "NumpadMemoryAdd", T.Unknown, e, 0, e, e, e],
    [1, x.NumpadMemorySubtract, "NumpadMemorySubtract", T.Unknown, e, 0, e, e, e],
    [1, x.NumpadClear, "NumpadClear", T.Clear, "Clear", 12, "VK_CLEAR", e, e],
    [1, x.NumpadClearEntry, "NumpadClearEntry", T.Unknown, e, 0, e, e, e],
    [1, x.None, e, T.Ctrl, "Ctrl", 17, "VK_CONTROL", e, e],
    [1, x.None, e, T.Shift, "Shift", 16, "VK_SHIFT", e, e],
    [1, x.None, e, T.Alt, "Alt", 18, "VK_MENU", e, e],
    [1, x.None, e, T.Meta, "Meta", 91, "VK_COMMAND", e, e],
    [1, x.ControlLeft, "ControlLeft", T.Ctrl, e, 0, "VK_LCONTROL", e, e],
    [1, x.ShiftLeft, "ShiftLeft", T.Shift, e, 0, "VK_LSHIFT", e, e],
    [1, x.AltLeft, "AltLeft", T.Alt, e, 0, "VK_LMENU", e, e],
    [1, x.MetaLeft, "MetaLeft", T.Meta, e, 0, "VK_LWIN", e, e],
    [1, x.ControlRight, "ControlRight", T.Ctrl, e, 0, "VK_RCONTROL", e, e],
    [1, x.ShiftRight, "ShiftRight", T.Shift, e, 0, "VK_RSHIFT", e, e],
    [1, x.AltRight, "AltRight", T.Alt, e, 0, "VK_RMENU", e, e],
    [1, x.MetaRight, "MetaRight", T.Meta, e, 0, "VK_RWIN", e, e],
    [1, x.BrightnessUp, "BrightnessUp", T.Unknown, e, 0, e, e, e],
    [1, x.BrightnessDown, "BrightnessDown", T.Unknown, e, 0, e, e, e],
    [1, x.MediaPlay, "MediaPlay", T.Unknown, e, 0, e, e, e],
    [1, x.MediaRecord, "MediaRecord", T.Unknown, e, 0, e, e, e],
    [1, x.MediaFastForward, "MediaFastForward", T.Unknown, e, 0, e, e, e],
    [1, x.MediaRewind, "MediaRewind", T.Unknown, e, 0, e, e, e],
    [1, x.MediaTrackNext, "MediaTrackNext", T.MediaTrackNext, "MediaTrackNext", 176, "VK_MEDIA_NEXT_TRACK", e, e],
    [1, x.MediaTrackPrevious, "MediaTrackPrevious", T.MediaTrackPrevious, "MediaTrackPrevious", 177, "VK_MEDIA_PREV_TRACK", e, e],
    [1, x.MediaStop, "MediaStop", T.MediaStop, "MediaStop", 178, "VK_MEDIA_STOP", e, e],
    [1, x.Eject, "Eject", T.Unknown, e, 0, e, e, e],
    [1, x.MediaPlayPause, "MediaPlayPause", T.MediaPlayPause, "MediaPlayPause", 179, "VK_MEDIA_PLAY_PAUSE", e, e],
    [1, x.MediaSelect, "MediaSelect", T.LaunchMediaPlayer, "LaunchMediaPlayer", 181, "VK_MEDIA_LAUNCH_MEDIA_SELECT", e, e],
    [1, x.LaunchMail, "LaunchMail", T.LaunchMail, "LaunchMail", 180, "VK_MEDIA_LAUNCH_MAIL", e, e],
    [1, x.LaunchApp2, "LaunchApp2", T.LaunchApp2, "LaunchApp2", 183, "VK_MEDIA_LAUNCH_APP2", e, e],
    [1, x.LaunchApp1, "LaunchApp1", T.Unknown, e, 0, "VK_MEDIA_LAUNCH_APP1", e, e],
    [1, x.SelectTask, "SelectTask", T.Unknown, e, 0, e, e, e],
    [1, x.LaunchScreenSaver, "LaunchScreenSaver", T.Unknown, e, 0, e, e, e],
    [1, x.BrowserSearch, "BrowserSearch", T.BrowserSearch, "BrowserSearch", 170, "VK_BROWSER_SEARCH", e, e],
    [1, x.BrowserHome, "BrowserHome", T.BrowserHome, "BrowserHome", 172, "VK_BROWSER_HOME", e, e],
    [1, x.BrowserBack, "BrowserBack", T.BrowserBack, "BrowserBack", 166, "VK_BROWSER_BACK", e, e],
    [1, x.BrowserForward, "BrowserForward", T.BrowserForward, "BrowserForward", 167, "VK_BROWSER_FORWARD", e, e],
    [1, x.BrowserStop, "BrowserStop", T.Unknown, e, 0, "VK_BROWSER_STOP", e, e],
    [1, x.BrowserRefresh, "BrowserRefresh", T.Unknown, e, 0, "VK_BROWSER_REFRESH", e, e],
    [1, x.BrowserFavorites, "BrowserFavorites", T.Unknown, e, 0, "VK_BROWSER_FAVORITES", e, e],
    [1, x.ZoomToggle, "ZoomToggle", T.Unknown, e, 0, e, e, e],
    [1, x.MailReply, "MailReply", T.Unknown, e, 0, e, e, e],
    [1, x.MailForward, "MailForward", T.Unknown, e, 0, e, e, e],
    [1, x.MailSend, "MailSend", T.Unknown, e, 0, e, e, e],
    [1, x.None, e, T.KEY_IN_COMPOSITION, "KeyInComposition", 229, e, e, e],
    [1, x.None, e, T.ABNT_C2, "ABNT_C2", 194, "VK_ABNT_C2", e, e],
    [1, x.None, e, T.OEM_8, "OEM_8", 223, "VK_OEM_8", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_KANA", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_HANGUL", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_JUNJA", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_FINAL", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_HANJA", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_KANJI", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_CONVERT", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_NONCONVERT", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_ACCEPT", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_MODECHANGE", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_SELECT", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_PRINT", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_EXECUTE", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_SNAPSHOT", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_HELP", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_APPS", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_PROCESSKEY", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_PACKET", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_DBE_SBCSCHAR", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_DBE_DBCSCHAR", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_ATTN", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_CRSEL", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_EXSEL", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_EREOF", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_PLAY", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_ZOOM", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_NONAME", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_PA1", e, e],
    [1, x.None, e, T.Unknown, e, 0, "VK_OEM_CLEAR", e, e]
  ], n = [], i = [];
  for (const r of t) {
    const [s, a, l, o, u, c, d, m, g] = r;
    if (i[a] || (i[a] = !0, wc[l] = a, vc[l.toLowerCase()] = a, s && o !== T.Unknown && o !== T.Enter && o !== T.Ctrl && o !== T.Shift && o !== T.Alt && o !== T.Meta && (zi[o] = a)), !n[o]) {
      if (n[o] = !0, !u)
        throw new Error(
          `String representation missing for key code ${o} around scan code ${l}`
        );
      Hn.define(o, u), Hi.define(o, m || u), Oi.define(o, g || m || u);
    }
    c && (_c[c] = o);
  }
  zi[T.Enter] = x.Enter;
...
(function(e) {
  ...
  e.toString = t;
  function n(l) {
    return Hn.strToKeyCode(l);
  }
  e.fromString = n;
  function i(l) {
    return Hi.keyCodeToStr(l);
  }
  ...
  function s(l) {
    return Hi.strToKeyCode(l) || Oi.strToKeyCode(l);
  }
  e.fromUserSettings = s;
  function a(l) {
    if (l >= T.Numpad0 && l <= T.NumpadDivide)
      return null;
    switch (l) {
      case T.UpArrow:
        return "Up";
...
let Nt;
const yi = globalThis.vscode;
if (typeof yi < "u" && typeof yi.process < "u") {
  const e = yi.process;
  Nt = {
    get platform() {
      return e.platform;
...
} else typeof process < "u" && typeof process?.versions?.node == "string" ? Nt = {
  get platform() {
  ...
  get platform() {
    return en ? "win32" : Iu ? "darwin" : "linux";
  },
  get arch() {
  },
  get env() {
...
const Yn = Nt.cwd, xc = Nt.env, yc = Nt.platform;
Nt.arch;
const Ac = 65, Lc = 97, kc = 90, Ec = 122, Mt = 46, _e = 47, Ne = 92, it = 58, Rc = 63;
...
function Sc(e, t) {
  if (e === null || typeof e != "object")
    throw new Al(t, "Object", e);
}
function de(e, t) {
  if (typeof e != "string")
    throw new Al(t, "string", e);
}
const Ye = yc === "win32";
function K(e) {
  return e === _e || e === Ne;
...
function Ll(e, t) {
  Sc(t, "pathObject");
  const n = t.dir || t.root, i = t.base || `${t.name || ""}${Nc(t.ext)}`;
...
const ve = {
    ...
    for (let r = e.length - 1; r >= -1; r--) {
      ...
      if (r >= 0) {
        if (s = e[r], de(s, `paths[${r}]`), s.length === 0)
          continue;
      } else t.length === 0 ? s = Yn() : (s = xc[`=${t}`] || Yn(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === Ne) && (s = `${t}\\`));
      const a = s.length;
      let l = 0, o = "", u = !1;
      ...
      if (a === 1)
        ...
        if (u = !0, K(s.charCodeAt(1))) {
          ...
          l = 1;
      else rt(c) && s.charCodeAt(1) === it && (o = s.slice(0, 2), l = 2, a > 2 && K(s.charCodeAt(2)) && (u = !0, l = 3));
      if (o.length > 0)
        if (t.length > 0) {
  ...
  normalize(e) {
    ...
    if (K(s))
      if (r = !0, K(e.charCodeAt(1))) {
        ...
        n = 1;
    else rt(s) && e.charCodeAt(1) === it && (i = e.slice(0, 2), n = 2, t > 2 && K(e.charCodeAt(2)) && (r = !0, n = 3));
    let a = n < t ? Qn(e.slice(n), !r, "\\", K) : "";
    if (a.length === 0 && !r && (a = "."), a.length > 0 && K(e.charCodeAt(t - 1)) && (a += "\\"), !r && i === void 0 && e.includes(":")) {
      if (a.length >= 2 && rt(a.charCodeAt(0)) && a.charCodeAt(1) === it)
        return `.\\${a}`;
      let l = e.indexOf(":");
      do
  ...
  isAbsolute(e) {
    ...
    return K(n) || t > 2 && rt(n) && e.charCodeAt(1) === it && K(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
  ...
  relative(e, t) {
    ...
    const a = s - r;
    let l = 0;
    for (; l < t.length && t.charCodeAt(l) === Ne; )
      l++;
    let o = t.length;
    for (; o - 1 > l && t.charCodeAt(o - 1) === Ne; )
      o--;
    ...
    if (m !== c) {
      ...
      if (u > c) {
        if (t.charCodeAt(l + m) === Ne)
          return i.slice(l + m + 1);
        if (m === 2)
          return i.slice(l + m);
      }
      a > c && (e.charCodeAt(r + m) === Ne ? d = m : m === 2 && (d = 3)), d === -1 && (d = 0);
    }
    let g = "";
    for (m = r + d + 1; m <= s; ++m)
      (m === s || e.charCodeAt(m) === Ne) && (g += g.length === 0 ? ".." : "\\..");
    return l += d, g.length > 0 ? `${g}${i.slice(l, o)}` : (i.charCodeAt(l) === Ne && ++l, i.slice(l, o));
  },
  toNamespacedPath(e) {
    ...
    } else if (rt(t.charCodeAt(0)) && t.charCodeAt(1) === it && t.charCodeAt(2) === Ne)
      return `\\\\?\\${t}`;
    return t;
  },
  dirname(e) {
    ...
    } else rt(r) && e.charCodeAt(1) === it && (n = t > 2 && K(e.charCodeAt(2)) ? 3 : 2, i = n);
    let s = -1, a = !0;
    for (let l = t - 1; l >= i; --l)
      if (K(e.charCodeAt(l))) {
        if (!a) {
  ...
  basename(e, t) {
    ...
    let n = 0, i = -1, r = !0, s;
    if (e.length >= 2 && rt(e.charCodeAt(0)) && e.charCodeAt(1) === it && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === it && rt(e.charCodeAt(0)) && (t = i = 2);
  ...
  parse(e) {
    ...
    } else if (rt(r) && e.charCodeAt(1) === it) {
      if (n <= 2)
    ...
    for (; u >= i; --u) {
      ...
      l === -1 && (o = !1, l = u + 1), r === Mt ? s === -1 ? s = u : c !== 1 && (c = 1) : s !== -1 && (c = -1);
    }
  ...
  resolve(...e) {
    ...
    return t = Qn(t, !n, "/", qi), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (de(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === _e, n = e.charCodeAt(e.length - 1) === _e;
    return e = Qn(e, !t, "/", qi), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
  ...
  parse(e) {
    ...
    for (; o >= i; --o) {
      ...
      a === -1 && (l = !1, a = o + 1), c === Mt ? r === -1 ? r = o : u !== 1 && (u = 1) : r !== -1 && (u = -1);
    }
    if (a !== -1) {
      const c = s === 0 && n ? 1 : s;
...
oe.win32 = ve.win32 = ve;
oe.posix = ve.posix = oe;
const Dc = Ye ? ve.normalize : oe.normalize;
Ye ? ve.isAbsolute : oe.isAbsolute;
const Uc = Ye ? ve.join : oe.join, Ic = Ye ? ve.resolve : oe.resolve, Fc = Ye ? ve.relative : oe.relative, Pc = Ye ? ve.dirname : oe.dirname;
Ye ? ve.basename : oe.basename;
Ye ? ve.extname : oe.extname;
Ye ? ve.parse : oe.parse;
const On = Ye ? ve.sep : oe.sep, Bc = /^\w[\w\d+.-]*$/, Hc = /^\//, Oc = /^\/\//;
function zc(e, t) {
  if (!e.scheme && t)
    throw new Error(
      `[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`
    );
  if (e.scheme && !Bc.test(e.scheme))
...
let Fe = class zn {
  static isUri(t) {
    return t instanceof zn ? !0 : !t || typeof t != "object" ? !1 : typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function";
  }
  constructor(t, n, i, r, s, a = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || ae, this.authority = t.authority || ae, this.path = t.path || ae, this.query = t.query || ae, this.fragment = t.fragment || ae) : (this.scheme = Wc(t, a), this.authority = n || ae, this.path = qc(this.scheme, i || ae), this.query = r || ae, this.fragment = s || ae, zc(this, a));
  }
  get fsPath() {
    return Jn(this, !1);
  }
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = ae), i === void 0 ? i = this.authority : i === null && (i = ae), r === void 0 ? r = this.path : r === null && (r = ae), s === void 0 ? s = this.query : s === null && (s = ae), a === void 0 ? a = this.fragment : a === null && (a = ae), n === this.scheme && i === this.authority && r === this.path && s === this.query && a === this.fragment ? this : new Ft(n, i, r, s, a);
  }
  static parse(t, n = !1) {
    const i = Vc.exec(t);
    return i ? new Ft(
      ...
      Mn(i[9] || ae),
      n
    ) : new Ft(ae, ae, ae, ae, ae);
  }
  static file(t) {
    let n = ae;
    if (en && (t = t.replace(/\\/g, Xe)), t[0] === Xe && t[1] === Xe) {
      const i = t.indexOf(Xe, 2);
      i === -1 ? (n = t.substring(2), t = Xe) : (n = t.substring(2, i), t = t.substring(i) || Xe);
    }
    return new Ft("file", n, t, ae, ae);
  }
  static from(t, n) {
    return new Ft(
      t.scheme,
  ...
  static joinPath(t, ...n) {
    ...
    let i;
    return en && t.scheme === "file" ? i = zn.file(ve.join(Jn(t, !0), ...n)).path : i = oe.join(t.path, ...n), t.with({ path: i });
  }
  toString(t = !1) {
    return Vi(this, t);
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new Ft(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === kl ? t.fsPath ?? null : null, n;
      }
    } else return t;
  }
...
const kl = en ? 1 : void 0;
class Ft extends Fe {
  constructor() {
    super(...arguments), this._formatted = null, this._fsPath = null;
  }
  get fsPath() {
    return this._fsPath || (this._fsPath = Jn(this, !1)), this._fsPath;
  }
  toString(t = !1) {
    return t ? Vi(this, !0) : (this._formatted || (this._formatted = Vi(this, !1)), this._formatted);
  }
  toJSON() {
    const t = {
      $mid: Wi.Uri
    };
    return this._fsPath && (t.fsPath = this._fsPath, t._sep = kl), this._formatted && (t.external = this._formatted), this.path && (t.path = this.path), this.scheme && (t.scheme = this.scheme), this.authority && (t.authority = this.authority), this.query && (t.query = this.query), this.fragment && (t.fragment = this.fragment), t;
  }
}
const El = {
  [N.Colon]: "%3A",
  ...
  [N.QuestionMark]: "%3F",
  [N.Hash]: "%23",
  [N.OpenSquareBracket]: "%5B",
  [N.CloseSquareBracket]: "%5D",
  [N.AtSign]: "%40",
  [N.ExclamationMark]: "%21",
  [N.DollarSign]: "%24",
  [N.Ampersand]: "%26",
  [N.SingleQuote]: "%27",
  [N.OpenParen]: "%28",
...
function Qr(e, t, n) {
  ...
  for (let s = 0; s < e.length; s++) {
    ...
    if (a >= N.a && a <= N.z || a >= N.A && a <= N.Z || a >= N.Digit0 && a <= N.Digit9 || a === N.Dash || a === N.Period || a === N.Underline || a === N.Tilde || t && a === N.Slash || n && a === N.OpenSquareBracket || n && a === N.CloseSquareBracket || n && a === N.Colon)
...
function Cc(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const i = e.charCodeAt(n);
    i === N.Hash || i === N.QuestionMark ? (t === void 0 && (t = e.substr(0, n)), t += El[i]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function Jn(e, t) {
  let n;
  return e.authority && e.path.length > 1 && e.scheme === "file" ? n = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === N.Slash && (e.path.charCodeAt(1) >= N.A && e.path.charCodeAt(1) <= N.Z || e.path.charCodeAt(1) >= N.a && e.path.charCodeAt(1) <= N.z) && e.path.charCodeAt(2) === N.Colon ? t ? n = e.path.substr(1) : n = e.path[1].toLowerCase() + e.path.substr(2) : n = e.path, en && (n = n.replace(/\//g, "\\")), n;
}
function Vi(e, t) {
  const n = t ? Cc : Qr;
  let i = "", { scheme: r, authority: s, path: a, query: l, fragment: o } = e;
  if (r && (i += r, i += ":"), (s || r === "file") && (i += Xe, i += Xe), s) {
    let u = s.indexOf("@");
    if (u !== -1) {
  ...
  if (a) {
    if (a.length >= 3 && a.charCodeAt(0) === N.Slash && a.charCodeAt(2) === N.Colon) {
      const u = a.charCodeAt(1);
      u >= N.A && u <= N.Z && (a = `/${String.fromCharCode(u + 32)}:${a.substr(3)}`);
    } else if (a.length >= 2 && a.charCodeAt(1) === N.Colon) {
      const u = a.charCodeAt(0);
      u >= N.A && u <= N.Z && (a = `${String.fromCharCode(u + 32)}:${a.substr(2)}`);
    }
    i += n(a, !0, !1);
  }
  return l && (i += "?", i += n(l, !1, !1)), o && (i += "#", i += t ? o : Qr(o, !1, !1)), i;
}
function Rl(e) {
  try {
    return decodeURIComponent(e);
  } catch {
    return e.length > 3 ? e.substr(0, 3) + Rl(e.substr(3)) : e;
  }
}
const Jr = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function Mn(e) {
  return e.match(Jr) ? e.replace(Jr, (t) => Rl(t)) : e;
}
var _t;
(function(e) {
...
class Pe extends X {
  ...
  getDirection() {
    return this.selectionStartLineNumber === this.startLineNumber && this.selectionStartColumn === this.startColumn ? _t.LTR : _t.RTL;
  }
  setEndPosition(t, n) {
    return this.getDirection() === _t.LTR ? new Pe(this.startLineNumber, this.startColumn, t, n) : new Pe(t, n, this.startLineNumber, this.startColumn);
  }
  getPosition() {
  ...
  setStartPosition(t, n) {
    return this.getDirection() === _t.LTR ? new Pe(t, n, this.endLineNumber, this.endColumn) : new Pe(this.endLineNumber, this.endColumn, t, n);
  }
  static fromPositions(t, n = t) {
    return new Pe(t.lineNumber, t.column, n.lineNumber, n.column);
  }
  static fromRange(t, n) {
    return n === _t.LTR ? new Pe(
      t.startLineNumber,
      t.startColumn,
      t.endLineNumber,
      t.endColumn
  ...
  static createWithDirection(t, n, i, r, s) {
    return s === _t.LTR ? new Pe(t, n, i, r) : new Pe(i, r, t, n);
  }
}
...
class $c {
  ...
  getDefaultBackground() {
    return this._colorMap && this._colorMap.length > Zn.DefaultBackground ? this._colorMap[Zn.DefaultBackground] : null;
  }
}
class Xc extends Kt {
  get isResolved() {
...
}, Re.Comment = new Re("comment"), Re.Imports = new Re("imports"), Re.Region = new Re("region"), Re);
var bs;
(function(e) {
...
Gt.CtrlCmd = zt.CtrlCmd, Gt.Shift = zt.Shift, Gt.Alt = zt.Alt, Gt.WinCtrl = zt.WinCtrl;
let Xi = Gt;
function Qc() {
  return {
    editor: void 0,
    languages: void 0,
    CancellationTokenSource: Wu,
    Emitter: ze,
    KeyCode: Ci,
    KeyMod: Xi,
    Position: te,
...
function Zc(e, t, n, i, r) {
  ...
  if (e.get(s) !== tn.Regular || s === N.CarriageReturn || s === N.LineFeed)
    return !0;
  if (r > 0) {
    const a = t.charCodeAt(i);
    if (e.get(a) !== tn.Regular)
      return !0;
  }
  return !1;
}
...
function eh(e, t, n, i, r) {
  return Zc(e, t, n, i, r) && Kc(e, t, n, i, r);
}
class th {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (r === this._prevMatchStartIndex && s === this._prevMatchLength) {
        if (s === 0) {
          ec(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = r, this._prevMatchLength = s, !this._wordSeparators || eh(this._wordSeparators, t, n, r, s))
        return i;
    } while (i);
    return null;
  }
...
function kr(e, t, n, i, r) {
  if (t = Nl(t), r || (r = Vn.first(Ml)), n.length > r.maxLen) {
    let u = e - r.maxLen / 2;
    return u < 0 ? u = 0 : i += u, n = n.substring(u, e + r.maxLen / 2), kr(e, t, n, i, r);
  }
...
class sh {
  static computeUnicodeHighlights(t, n, i) {
    const r = i ? i.startLineNumber : 1, s = i ? i.endLineNumber : t.getLineCount(), a = new Ra(n), l = a.getCandidateCodePoints();
    let o;
    l === "allNonBasicAscii" ? o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : o = new RegExp(`${ah(Array.from(l))}`, "g");
    const u = new th(null, o), c = [];
    ...
    e: for (let L = r, A = s; L <= A; L++) {
      ...
      do
        if (m = u.next(w), m) {
          ...
          const z = w.substring(H, W);
          let b = kr(H + 1, Sl, w, 0);
          b && b.endColumn <= H + 1 && (b = null);
          const f = a.shouldHighlightNonBasicASCII(z, b ? b.word : null);
          if (f !== Le.None) {
            if (f === Le.Ambiguous ? g++ : f === Le.Invisible ? _++ : f === Le.NonBasicASCII ? p++ : pu(), c.length >= 1e3) {
              d = !0;
              break e;
            }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (i.shouldHighlightNonBasicASCII(t, null)) {
      ...
      case Le.NonBasicASCII:
        return { kind: fn.NonBasicAscii };
    }
  }
}
function ah(e, t) {
  return `[${Cu(e.map((i) => String.fromCodePoint(i)).join(""))}]`;
}
var fn;
(function(e) {
...
class Ra {
  ...
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const n of mn.codePoints)
        Sa(String.fromCodePoint(n)) || t.add(n);
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (this.allowedCodePoints.has(i))
      return Le.None;
    if (this.options.nonBasicASCII)
      return Le.NonBasicASCII;
    let r = !1, s = !1;
    if (n)
      for (const a of n) {
        const l = a.codePointAt(0), o = nc(a);
        r = r || o, !o && !this.ambiguousCharacters.isAmbiguous(l) && !mn.isInvisibleCharacter(l) && (s = !0);
      }
    return !r && s ? Le.None : this.options.invisibleCharacters && !Sa(t) && mn.isInvisibleCharacter(i) ? Le.Invisible : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(i) ? Le.Ambiguous : Le.None;
  }
}
function Sa(e) {
  return e === " " || e === `
...
Te.compareByStart = $t((t) => t.startLineNumber, hn);
let ne = Te;
class Ze {
  constructor(t = []) {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = Si(this._normalizedRanges, (r) => r.endLineNumberExclusive >= t.startLineNumber), i = Zt(this._normalizedRanges, (r) => r.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
  ...
  subtractFrom(t) {
    const n = Si(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), i = Zt(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
      return new Ze([t]);
    const r = [];
    ...
    return s < t.endLineNumberExclusive && r.push(new ne(s, t.endLineNumberExclusive)), new Ze(r);
  }
  toString() {
...
` && (this.lineStartOffsetByLineIdx.push(n + 1), n > 0 && t.charAt(n - 1) === "\r" ? this.lineEndOffsetByLineIdx.push(n - 1) : this.lineEndOffsetByLineIdx.push(n));
  ...
  getPosition(t) {
    const n = Zt(this.lineStartOffsetByLineIdx, (s) => s <= t), i = n + 1, r = t - this.lineStartOffsetByLineIdx[n] + 1;
    return new te(i, r);
  }
  getTextLength(t) {
...
class uh extends Ul {
  constructor(t, n) {
    gu(n >= 1), super(), this._getLineContent = t, this._lineCount = n;
  }
  getValueOfRange(t) {
...
` + this._getLineContent(t.endLineNumber).substring(0, t.endColumn - 1), n;
  ...
  get length() {
    ...
    return new yt(this._lineCount - 1, t.length);
  }
}
class Dn extends uh {
  constructor(t) {
...
let Rr = class bt {
  ...
  static replace(t, n) {
    return new bt([new xe(t, n)]);
  }
  static delete(t) {
    return new bt([new xe(t, "")]);
  }
  static insert(t, n) {
    return new bt([new xe(X.fromPositions(t, t), n)]);
  }
  static fromParallelReplacementsUnsorted(t) {
    const n = t.slice().sort($t((i) => i.range, X.compareRangesUsingStarts));
    return new bt(n);
  }
  constructor(t) {
    this.replacements = t, vn(() => Tr(t, (n, i) => n.range.getEndPosition().isBeforeOrEqual(i.range.getStartPosition())));
  }
  normalize() {
    const t = [];
  ...
  apply(t) {
    let n = "", i = new te(1, 1);
    for (const s of this.replacements) {
      const a = s.range, l = a.getStartPosition(), o = a.getEndPosition(), u = Un(i, l);
      u.isEmpty() || (n += t.getValueOfRange(u)), n += s.text, i = o;
    }
    const r = Un(i, t.endPositionExclusive);
  ...
  inverse(t) {
    ...
    return new bt(this.replacements.map((i, r) => new xe(n[r], t.getValueOfRange(i.range))));
  }
  getNewRanges() {
    const t = [];
    let n = 0, i = 0, r = 0;
    for (const s of this.replacements) {
      const a = yt.ofText(s.text), l = te.lift({
  ...
  equals(t) {
    return dl(this.replacements, t.replacements, (n, i) => n.equals(i));
  }
  toString(t) {
...
`, `
`), r = jn(n, i), s = yt.ofText(n.substring(0, r)).addToPosition(this.range.getStartPosition()), a = i.substring(r), l = X.fromPositions(s, this.range.getEndPosition());
    return new xe(l, a);
  }
...
`), i = this.text.replaceAll(`\r
`, `
`), r = $n(n, i), s = yt.ofText(n.substring(0, n.length - r)).addToPosition(this.range.getStartPosition()), a = i.substring(0, i.length - r), l = X.fromPositions(this.range.getStartPosition(), s);
    return new xe(l, a);
  }
...
class qe {
  ...
  toRangeMapping() {
    ...
    if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
      ...
      return new Se(new X(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new X(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    } else
      return new Se(new X(
  ...
  toRangeMapping2(t, n) {
    if (Na(this.original.endLineNumberExclusive, t) && Na(this.modified.endLineNumberExclusive, n))
      return new Se(new X(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new X(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new Se(X.fromPositions(new te(this.original.startLineNumber, 1), Pt(new te(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), X.fromPositions(new te(this.modified.startLineNumber, 1), Pt(new te(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new Se(X.fromPositions(Pt(new te(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), Pt(new te(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), X.fromPositions(Pt(new te(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), Pt(new te(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new me();
  }
}
function Pt(e, t) {
...
class tt extends qe {
  ...
  flip() {
    return new tt(this.modified, this.original, this.innerChanges?.map((t) => t.flip()));
  }
  withInnerChangesFromLineRanges() {
    return new tt(this.original, this.modified, [this.toRangeMapping()]);
  }
}
class Se {
  static fromEdit(t) {
    const n = t.getNewRanges();
    return t.replacements.map((r, s) => new Se(r.range, n[s]));
  }
  static fromEditJoin(t) {
    const n = t.getNewRanges(), i = t.replacements.map((r, s) => new Se(r.range, n[s]));
    return Se.join(i);
  }
  static join(t) {
    if (t.length === 0)
  ...
  flip() {
    return new Se(this.modifiedRange, this.originalRange);
  }
  toTextEdit(t) {
...
function Ma(e, t, n, i = !1) {
  const r = [];
  for (const s of iu(e.map((a) => ch(a, t, n)), (a, l) => a.original.intersectsOrTouches(l.original) || a.modified.intersectsOrTouches(l.modified))) {
...
class dh {
  computeDiff(t, n, i) {
    ...
    for (const o of s.changes) {
      let u;
      o.originalEndLineNumber === 0 ? u = new ne(o.originalStartLineNumber + 1, o.originalStartLineNumber + 1) : u = new ne(o.originalStartLineNumber, o.originalEndLineNumber + 1);
      let c;
      o.modifiedEndLineNumber === 0 ? c = new ne(o.modifiedStartLineNumber + 1, o.modifiedStartLineNumber + 1) : c = new ne(o.modifiedStartLineNumber, o.modifiedEndLineNumber + 1);
      let d = new tt(u, c, o.charChanges?.map((m) => new Se(new X(
      ...
      l && (l.modified.endLineNumberExclusive === d.modified.startLineNumber || l.original.endLineNumberExclusive === d.original.startLineNumber) && (d = new tt(
    ...
    return vn(() => Tr(a, (o, u) => u.original.startLineNumber - o.original.endLineNumberExclusive === u.modified.startLineNumber - o.modified.endLineNumberExclusive && o.original.endLineNumberExclusive < u.original.startLineNumber && o.modified.endLineNumberExclusive < u.modified.startLineNumber)), new Wn(a, [], s.quitEarly);
  }
}
function Il(e, t, n, i) {
  return new vt(e, t, n).ComputeDiff(i);
}
let Da = class {
  constructor(t) {
    const n = [], i = [];
    for (let r = 0, s = t.length; r < s; r++)
      n[r] = Yi(t[r], 1), i[r] = Qi(t[r], 1);
  ...
  createCharSequence(t, n, i) {
    ...
    for (let o = n; o <= i; o++) {
      ...
      !t && o < i && (r[l] = N.LineFeed, s[l] = o + 1, a[l] = u.length + 1, l++);
    }
    return new mh(r, s, a);
  }
};
class mh {
  ...
  getEndLineNumber(t) {
    return t === -1 ? this.getStartLineNumber(t + 1) : (this._assertIndex(t, this._lineNumbers), this._charCodes[t] === N.LineFeed ? this._lineNumbers[t] + 1 : this._lineNumbers[t]);
  }
  getStartColumn(t) {
    return t > 0 && t === this._columns.length ? this.getEndColumn(t - 1) : (this._assertIndex(t, this._columns), this._columns[t]);
  }
  getEndColumn(t) {
    return t === -1 ? this.getStartColumn(t + 1) : (this._assertIndex(t, this._columns), this._charCodes[t] === N.LineFeed ? 1 : this._columns[t] + 1);
  }
}
class Yt {
...
function fh(e) {
  ...
  for (let i = 1, r = e.length; i < r; i++) {
    ...
    Math.min(a, l) < hh ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
  }
  return t;
}
class pn {
  ...
  static createFromDiffResult(t, n, i, r, s, a, l) {
    ...
    if (n.originalLength === 0 ? (o = i.getStartLineNumber(n.originalStart) - 1, u = 0) : (o = i.getStartLineNumber(n.originalStart), u = i.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (c = r.getStartLineNumber(n.modifiedStart) - 1, d = 0) : (c = r.getStartLineNumber(n.modifiedStart), d = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
      ...
      if (g.getElements().length > 0 && _.getElements().length > 0) {
        let p = Il(g, _, s, !0).changes;
        l && (p = fh(p)), m = [];
        for (let L = 0, A = p.length; L < A; L++)
          m.push(Yt.createFromDiffChange(p[L], g, _));
      }
    }
    return new pn(
      o,
...
class Fl {
  constructor(t, n, i) {
    this.shouldComputeCharChanges = i.shouldComputeCharChanges, this.shouldPostProcessCharChanges = i.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = i.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = i.shouldMakePrettyDiff, this.originalLines = t, this.modifiedLines = n, this.original = new Da(t), this.modified = new Da(n), this.continueLineDiff = Ua(i.maxComputationTime), this.continueCharDiff = Ua(i.maxComputationTime === 0 ? 0 : Math.min(i.maxComputationTime, 5e3));
  }
  computeDiff() {
    ...
    const t = Il(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, i = t.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const l = [];
      for (let o = 0, u = n.length; o < u; o++)
        l.push(pn.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[o], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: i,
        changes: l
      };
    ...
    for (let l = -1, o = n.length; l < o; l++) {
      ...
      u && (r.push(pn.createFromDiffResult(this.shouldIgnoreTrimWhitespace, u, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), s += u.originalLength, a += u.modifiedLength);
    }
    return {
      quitEarly: i,
      changes: r
  ...
  _pushTrimWhitespaceCharChange(t, n, i, r, s, a, l) {
    if (this._mergeTrimWhitespaceCharChange(t, n, i, r, s, a, l))
      return;
    let o;
    this.shouldComputeCharChanges && (o = [new Yt(
      n,
      i,
      n,
      r,
  ...
  _mergeTrimWhitespaceCharChange(t, n, i, r, s, a, l) {
    ...
    if (o === 0)
      return !1;
    const u = t[o - 1];
    return u.originalEndLineNumber === 0 || u.modifiedEndLineNumber === 0 ? !1 : u.originalEndLineNumber === n && u.modifiedEndLineNumber === s ? (this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new Yt(
      n,
      i,
      n,
      r,
      ...
      s,
      l
    )), !0) : u.originalEndLineNumber + 1 === n && u.modifiedEndLineNumber + 1 === s ? (u.originalEndLineNumber = n, u.modifiedEndLineNumber = s, this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new Yt(
      n,
      i,
      n,
      r,
...
const Et = class Et {
  ...
  delta(t) {
    return t === 0 ? this : new Et(this.offset1 + t, this.offset2 + t);
  }
  equals(t) {
...
_n.chrKeys = /* @__PURE__ */ new Map();
let Kn = _n;
class gh {
  compute(t, n, i = En.instance, r) {
    if (t.length === 0 || n.length === 0)
      return mt.trivial(t, n);
    const s = new Ai(t.length, n.length), a = new Ai(t.length, n.length), l = new Ai(t.length, n.length);
...
class Pl {
  compute(t, n, i = En.instance) {
    ...
    o.set(0, a(0, 0));
    const u = new _h();
    u.set(0, o.get(0) === 0 ? null : new Ia(null, 0, 0, o.get(0)));
    let c = 0;
    e: for (; ; ) {
      if (l++, !i.isValid())
      ...
      for (c = p; c <= L; c += 2) {
        ...
        const W = a(E, H);
        o.set(c, W);
        const z = E === A ? u.get(c + 1) : u.get(c - 1);
        if (u.set(c, W !== E ? new Ia(z, E, H, W - E) : z), o.get(c) === r.length && o.get(c) - c === s.length)
          break e;
      }
    }
    let d = u.get(c);
...
class ei {
  ...
  getBoundaryScore(t) {
    const n = Ba(t > 0 ? this.elements[t - 1] : -1), i = Ba(t < this.elements.length ? this.elements[t] : -1);
    if (n === ue.LineBreakCR && i === ue.LineBreakLF)
      return 0;
    if (n === ue.LineBreakLF)
      return 150;
    let r = 0;
    return n !== i && (r += 10, n === ue.WordLower && i === ue.WordUpper && (r += 1)), r += Pa(n), r += Pa(i), r;
  }
  translateOffset(t, n = "right") {
    const i = Zt(this.firstElementOffsetByLineIdx, (s) => s <= t), r = t - this.firstElementOffsetByLineIdx[i];
    return new te(
  ...
  findSubWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !Bt(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && Bt(this.elements[n - 1]) && !Fa(this.elements[n]); )
      n--;
    let i = t;
    for (; i < this.elements.length && Bt(this.elements[i]) && !Fa(this.elements[i]); )
      i++;
    return new j(n, i);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = Jt(this.firstElementOffsetByLineIdx, (r) => r <= t.start) ?? 0, i = nu(this.firstElementOffsetByLineIdx, (r) => t.endExclusive <= r) ?? this.elements.length;
    return new j(n, i);
  }
}
function Bt(e) {
  return e >= N.a && e <= N.z || e >= N.A && e <= N.Z || e >= N.Digit0 && e <= N.Digit9;
}
function Fa(e) {
  return e >= N.A && e <= N.Z;
}
...
function Ba(e) {
  return e === N.LineFeed ? ue.LineBreakLF : e === N.CarriageReturn ? ue.LineBreakCR : Ji(e) ? ue.Space : e >= N.a && e <= N.z ? ue.WordLower : e >= N.A && e <= N.Z ? ue.WordUpper : e >= N.Digit0 && e <= N.Digit9 ? ue.WordNumber : e === -1 ? ue.End : e === N.Comma || e === N.Semicolon ? ue.Separator : ue.Other;
}
function vh(e, t, n, i, r, s) {
  let { moves: a, excludedChanges: l } = xh(e, t, n, s);
  if (!s.isValid())
    return [];
  const o = e.filter((c) => !l.has(c)), u = yh(o, i, r, t, n, s);
  return au(a, u), a = Ah(a), a = a.filter((c) => {
    const d = c.original.toOffsetRange().slice(t).map((g) => g.trim());
    return d.join(`
`).length >= 15 && Th(d, (g) => g.length >= 2) >= 2;
  }), a = Lh(e, a), a;
}
function Th(e, t) {
  let n = 0;
...
function xh(e, t, n, i) {
  const r = [], s = e.filter((o) => o.modified.isEmpty && o.original.length >= 3).map((o) => new Kn(o.original, t, o)), a = new Set(e.filter((o) => o.original.isEmpty && o.modified.length >= 3).map((o) => new Kn(o.modified, n, o))), l = /* @__PURE__ */ new Set();
  for (const o of s) {
    let u = -1, c;
    for (const d of a) {
...
function yh(e, t, n, i, r, s) {
  ...
  const o = [];
  e.sort($t((m) => m.modified.startLineNumber, hn));
  for (const m of e) {
    let g = [];
  ...
  o.sort(ou($t((m) => m.modifiedLineRange.length, hn)));
  const u = new Ze(), c = new Ze();
  for (const m of o) {
  ...
  a.sort($t((m) => m.original.startLineNumber, hn));
  const d = new qn(e);
  for (let m = 0; m < a.length; m++) {
    const g = a[m], _ = d.findLastMonotonous((z) => z.original.startLineNumber <= g.original.startLineNumber), p = Jt(e, (z) => z.modified.startLineNumber <= g.modified.startLineNumber), L = Math.max(g.original.startLineNumber - _.original.startLineNumber, g.modified.startLineNumber - p.modified.startLineNumber), A = d.findLastMonotonous((z) => z.original.startLineNumber < g.original.endLineNumberExclusive), w = Jt(e, (z) => z.modified.startLineNumber < g.modified.endLineNumberExclusive), E = Math.max(A.original.endLineNumberExclusive - g.original.endLineNumberExclusive, w.modified.endLineNumberExclusive - g.modified.endLineNumberExclusive);
    let H;
    for (H = 0; H < L; H++) {
      const z = g.original.startLineNumber - H - 1, b = g.modified.startLineNumber - H - 1;
      if (z > i.length || b > r.length || u.contains(b) || c.contains(z) || !Ha(i[z - 1], r[b - 1], s))
        break;
    }
    ...
    let W;
    for (W = 0; W < E; W++) {
      const z = g.original.endLineNumberExclusive + W, b = g.modified.endLineNumberExclusive + W;
      if (z > i.length || b > r.length || u.contains(b) || c.contains(z) || !Ha(i[z - 1], r[b - 1], s))
        break;
    }
...
function Ha(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const r = new Pl().compute(new ei([e], new X(1, 1, 1, e.length), !1), new ei([t], new X(1, 1, 1, t.length), !1), n);
  let s = 0;
...
function Ah(e) {
  if (e.length === 0)
    return e;
  e.sort($t((n) => n.original.startLineNumber, hn));
  const t = [e[0]];
...
function Lh(e, t) {
  const n = new qn(e);
  return t = t.filter((i) => {
    const r = n.findLastMonotonous((l) => l.original.startLineNumber < i.original.endLineNumberExclusive) || new qe(new ne(1, 1), new ne(1, 1)), s = Jt(e, (l) => l.modified.startLineNumber < i.modified.endLineNumberExclusive);
    return r !== s;
  }), t;
}
function Oa(e, t, n) {
  let i = n;
  return i = za(e, t, i), i = za(e, t, i), i = kh(e, t, i), i;
}
function za(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  function o(c, d) {
    ...
    for (; s.length > 0; ) {
      ...
      if (!(w.seq1Range.intersects(_.seq1Range) || w.seq2Range.intersects(_.seq2Range)))
        break;
      const H = i(e, w.seq1Range.start), W = i(t, w.seq2Range.start), z = new he(H, W), b = z.intersect(w);
      if (L += b.seq1Range.length, A += b.seq2Range.length, _ = _.join(z), _.seq1Range.endExclusive >= w.seq1Range.endExclusive)
        s.shift();
      else
        break;
    }
    ...
    for (let o = 1; o < i.length; o++) {
      let d = function(g, _) {
        ...
        if (A.length > 20 || A.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const w = e.countLinesIn(g.seq1Range), E = g.seq1Range.length, H = t.countLinesIn(g.seq2Range), W = g.seq2Range.length, z = e.countLinesIn(_.seq1Range), b = _.seq1Range.length, f = t.countLinesIn(_.seq2Range), v = _.seq2Range.length, P = 2 * 40 + 50;
        function S(k) {
          return Math.min(k, P);
        }
        return Math.pow(Math.pow(S(w * 40 + E), 1.5) + Math.pow(S(H * 40 + W), 1.5), 1.5) + Math.pow(Math.pow(S(z * 40 + b), 1.5) + Math.pow(S(f * 40 + v), 1.5), 1.5) > (P ** 1.5) ** 1.5 * 1.3;
      };
...
class Va {
  ...
  getBoundaryScore(t) {
    const n = t === 0 ? 0 : Ca(this.lines[t - 1]), i = t === this.lines.length ? 0 : Ca(this.lines[t]);
    return 1e3 - (n + i);
  }
  getText(t) {
...
function Ca(e) {
  let t = 0;
  for (; t < e.length && (e.charCodeAt(t) === N.Space || e.charCodeAt(t) === N.Tab); )
    t++;
  return t;
}
class Mh {
  constructor() {
    this.dynamicProgrammingDiffing = new gh(), this.myersDiffingAlgorithm = new Pl();
  }
  computeDiff(t, n, i) {
    if (t.length <= 1 && dl(t, n, (b, f) => b === f))
      return new Wn([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new Wn([
        new tt(new ne(1, t.length + 1), new ne(1, n.length + 1), [
          new Se(new X(
            1,
            1,
            t.length,
    ...
    const r = i.maxComputationTimeMs === 0 ? En.instance : new ph(i.maxComputationTimeMs), s = !i.ignoreTrimWhitespace, a = /* @__PURE__ */ new Map();
    function l(b) {
      let f = a.get(b);
      return f === void 0 && (f = a.size, a.set(b, f)), f;
    }
    const o = t.map((b) => l(b.trim())), u = n.map((b) => l(b.trim())), c = new Va(o, t), d = new Va(u, n), m = c.length + d.length < 1700 ? this.dynamicProgrammingDiffing.compute(c, d, r, (b, f) => t[b] === n[f] ? n[f].length === 0 ? 0.1 : 1 + Math.log(1 + n[f].length) : 0.99) : this.myersDiffingAlgorithm.compute(c, d, r);
    let g = m.diffs, _ = m.hitTimeout;
    g = Oa(c, d, g), g = Sh(c, d, g);
    const p = [], L = (b) => {
      if (s)
        for (let f = 0; f < b; f++) {
          const v = A + f, P = w + f;
          if (t[v] !== n[P]) {
            const S = this.refineDiff(t, n, new he(new j(v, v + 1), new j(P, P + 1)), r, s, i);
            for (const k of S.mappings)
              p.push(k);
            S.hitTimeout && (_ = !0);
          }
        }
    ...
    let A = 0, w = 0;
    for (const b of g) {
      vn(() => b.seq1Range.start - A === b.seq2Range.start - w);
    ...
    L(t.length - A);
    const E = new Dn(t), H = new Dn(n), W = Ma(p, E, H);
    let z = [];
    return i.computeMoves && (z = this.computeMoves(W, t, n, o, u, r, s, i)), vn(() => {
      function b(v, P) {
        if (v.lineNumber < 1 || v.lineNumber > P.length)
          return !1;
        const S = P[v.lineNumber - 1];
  ...
  computeMoves(t, n, i, r, s, a, l, o) {
    return vh(t, n, i, r, s, a).map((d) => {
      const m = this.refineDiff(n, i, new he(d.original.toOffsetRange(), d.modified.toOffsetRange()), a, l, o), g = Ma(m.mappings, new Dn(n), new Dn(i), !0);
      return new Er(d, g);
    });
  }
  refineDiff(t, n, i, r, s, a) {
    const o = Dh(i).toRangeMapping2(t, n), u = new ei(t, o.originalRange, s), c = new ei(n, o.modifiedRange, s), d = u.length + c.length < 500 ? this.dynamicProgrammingDiffing.compute(u, c, r) : this.myersDiffingAlgorithm.compute(u, c, r);
    let m = d.diffs;
    return m = Oa(u, c, m), m = qa(u, c, m, (_, p) => _.findWordContaining(p)), a.extendToSubwords && (m = qa(u, c, m, (_, p) => _.findSubWordContaining(p), !0)), m = Eh(u, c, m), m = Nh(u, c, m), {
      mappings: m.map((_) => new Se(u.translateRange(_.seq1Range), c.translateRange(_.seq2Range))),
...
class Wt {
  ...
  static fromRGBA(t) {
    ...
    let u;
    return l === 0 ? u = 0 : s === n ? u = ((i - r) / l % 6 + 6) % 6 : s === i ? u = (r - n) / l + 2 : u = (n - i) / l + 4, new Wt(Math.round(u * 60), o, s, t.a);
  }
  static toRGBA(t) {
    const { h: n, s: i, v: r, a: s } = t, a = r * i, l = a * (1 - Math.abs(n / 60 % 2 - 1)), o = r - a;
    let [u, c, d] = [0, 0, 0];
    return n < 60 ? (u = a, c = l) : n < 120 ? (u = l, c = a) : n < 180 ? (c = a, d = l) : n < 240 ? (c = l, d = a) : n < 300 ? (u = l, d = a) : n <= 360 && (u = a, d = l), u = Math.round((u + o) * 255), c = Math.round((c + o) * 255), d = Math.round((d + o) * 255), new R(u, c, d, s);
  }
}
var ee;
let ti = (ee = class {
  ...
  get hsva() {
    return this._hsva ? this._hsva : Wt.fromRGBA(this.rgba);
  }
  constructor(t) {
    if (t)
      if (t instanceof R)
        ...
        this._hsva = t, this.rgba = Wt.toRGBA(t);
      else
        throw new Error("Invalid color ctor argument");
    else throw new Error("Color needs a value");
  }
  equals(t) {
    return !!t && R.equals(this.rgba, t.rgba) && We.equals(this.hsla, t.hsla) && Wt.equals(this.hsva, t.hsva);
  }
    ...
    (function(n) {
      ...
      function d(p) {
        ...
        if (p.startsWith("rgba(")) {
          const L = p.match(/rgba\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+), *(?<a>(?:\+|-)?\d+(\.\d+)?)\)/);
          if (!L)
            throw new Error("Invalid color format " + p);
          const A = parseInt(L.groups?.r ?? "0"), w = parseInt(L.groups?.g ?? "0"), E = parseInt(L.groups?.b ?? "0"), H = parseFloat(L.groups?.a ?? "0");
          return new e(new R(A, w, E, H));
        }
        if (p.startsWith("rgb(")) {
          const L = p.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/);
          if (!L)
            throw new Error("Invalid color format " + p);
          const A = parseInt(L.groups?.r ?? "0"), w = parseInt(L.groups?.g ?? "0"), E = parseInt(L.groups?.b ?? "0");
          return new e(new R(A, w, E));
        }
        return m(p);
      }
      n.parse = d;
...
function Uh(e, t) {
  ...
  if (n)
    return {
      range: e,
      color: Sr(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
    };
}
function Ga(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = Bl(r);
  return {
    range: e,
    color: Sr(s[0], s[1], s[2], n ? s[3] : 1)
  };
}
function ja(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = Bl(r), a = new ti(new We(
    s[0],
    s[1] / 100,
    s[2] / 100,
    n ? s[3] : 1
  ...
  return {
    range: e,
    color: Sr(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a)
  };
}
function ln(e, t) {
...
function Ih(e) {
  const t = [], n = new RegExp(`\\b(rgb|rgba|hsl|hsla)(\\([0-9\\s,.\\%]*\\))|^(#)([A-Fa-f0-9]{3})\\b|^(#)([A-Fa-f0-9]{4})\\b|^(#)([A-Fa-f0-9]{6})\\b|^(#)([A-Fa-f0-9]{8})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{3})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{4})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{6})\\b|(?<=['"\\s])(#)([A-Fa-f0-9]{8})\\b`, "gm"), i = ln(e, n);
  if (i.length > 0)
    for (const r of i) {
      ...
      if (a === "rgb") {
        ...
        o = ja(on(e, r), ln(l, u), !0);
      } else a === "#" && (o = Uh(on(e, r), a + l));
      o && t.push(o);
    }
  return t;
}
function Fh(e) {
  return !e || typeof e.getValue != "function" || typeof e.positionAt != "function" ? [] : Ih(e);
}
const Ph = /^-+|-+$/g, $a = 100, Bh = 5;
function Hh(e, t) {
  let n = [];
...
function zh(e, t) {
  ...
  if (!t.markSectionHeaderRegex || t.markSectionHeaderRegex.trim() === "")
    return n;
  const r = Jc(t.markSectionHeaderRegex), s = new RegExp(t.markSectionHeaderRegex, `gdm${r ? "s" : ""}`);
  if (Gu(s))
    return n;
  for (let a = 1; a <= i; a += $a - Bh) {
    const l = Math.min(a + $a - 1, i), o = [];
    for (let d = a; d <= l; d++)
...
`) + 1, w = c.index - A + 1, E = _[_.length - 1], H = p === 1 ? w + c[0].length : E.length + 1, W = {
        ...
        endLineNumber: L,
        endColumn: H
      }, z = (c.groups ?? {}).label ?? "", b = ((c.groups ?? {}).separator ?? "") !== "", f = {
        range: W,
        text: z,
        hasSeparatorLine: b,
...
function Wh(e) {
  ...
  return e = e.replace(Ph, ""), { text: e, hasSeparatorLine: t };
}
function pt(e) {
  return e === N.Slash || e === N.Backslash;
}
function Hl(e) {
  return e.replace(/[\\/]/g, oe.sep);
}
function qh(e) {
  return e.indexOf("/") === -1 && (e = Hl(e)), /^[a-zA-Z]:(\/|$)/.test(e) && (e = "/" + e), e;
}
function Xa(e, t = oe.sep) {
  if (!e)
    return "";
  const n = e.length, i = e.charCodeAt(0);
  if (pt(i)) {
    if (pt(e.charCodeAt(1)) && !pt(e.charCodeAt(2))) {
      let s = 3;
      const a = s;
      for (; s < n && !pt(e.charCodeAt(s)); s++)
        ;
      if (a !== s && !pt(e.charCodeAt(s + 1))) {
        for (s += 1; s < n; s++)
          if (pt(e.charCodeAt(s)))
            return e.slice(0, s + 1).replace(/[\\/]/g, t);
      }
    }
    return t;
  } else if (Vh(i) && e.charCodeAt(1) === N.Colon)
    return pt(e.charCodeAt(2)) ? e.slice(0, 2) + t : e.slice(0, 2);
  let r = e.indexOf("://");
  if (r !== -1) {
    for (r += 3; r < n; r++)
      if (pt(e.charCodeAt(r)))
        return e.slice(0, r + 1);
  }
  return "";
}
function Ya(e, t, n, i = On) {
  if (e === t)
    return !0;
...
function Vh(e) {
  return e >= N.A && e <= N.Z || e >= N.a && e <= N.z;
}
var ye;
(function(e) {
...
class Gh {
  ...
  setServerRootPath(t, n) {
    this._serverRootPath = oe.join(n ?? "/", $h(t));
  }
  getServerRootPath() {
    return this._serverRootPath;
  }
  get _remoteResourcesPath() {
    return oe.join(this._serverRootPath, ye.vscodeRemoteResource);
  }
  set(t, n, i) {
  ...
  rewrite(t) {
    ...
    return typeof s == "string" && (a += `&${Ch}=${encodeURIComponent(s)}`), Fe.from({
      scheme: Pu ? this._preferredWebSchema : ye.vscodeRemoteResource,
      authority: `${i}:${r}`,
...
const Xh = "vscode-app", jt = class jt {
  constructor() {
  ...
  uriToBrowserUri(t) {
    return t.scheme === ye.vscodeRemote ? jh.rewrite(t) : t.scheme === ye.file && (Fu || Hu === `${ye.vscodeFileResource}://${jt.FALLBACK_AUTHORITY}`) ? t.with({
      scheme: ye.vscodeFileResource,
      authority: t.authority || jt.FALLBACK_AUTHORITY,
      query: null,
      fragment: null
  ...
  uriToFileUri(t) {
    return t.scheme === ye.vscodeFileResource ? t.with({
      scheme: ye.file,
      authority: t.authority !== jt.FALLBACK_AUTHORITY ? t.authority : null,
      query: null,
      fragment: null
    }) : t;
  }
  toUri(t) {
    ...
    if (globalThis._VSCODE_FILE_ROOT) {
      ...
      if (/^\w[\w\d+.-]*:\/\//.test(n))
        return Fe.joinPath(Fe.parse(n, !0), t);
      const i = Uc(n, t);
      return Fe.file(i);
    }
    return Fe.parse(this.toUrl(t));
  }
...
(function(e) {
  ...
  function i(s) {
    let a;
    typeof s == "string" ? a = new URL(s).searchParams : s instanceof URL ? a = s.searchParams : Fe.isUri(s) && (a = new URL(s.toString(!0)).searchParams);
    const l = a?.get(n);
    if (l)
      return t.get(l);
  }
...
class Yh {
  ...
  compare(t, n, i = !1) {
    return t === n ? 0 : Xu(this.getComparisonKey(t, i), this.getComparisonKey(n, i));
  }
  isEqual(t, n, i = !1) {
  ...
  isEqualOrParent(t, n, i = !1) {
    if (t.scheme === n.scheme) {
      if (t.scheme === ye.file)
        return Ya(st(t), st(n), this._ignorePathCasing(t)) && t.query === n.query && (i || t.fragment === n.fragment);
      if (Ja(t.authority, n.authority))
        return Ya(t.path, n.path, this._ignorePathCasing(t), "/") && t.query === n.query && (i || t.fragment === n.fragment);
    }
    return !1;
  }
  joinPath(t, ...n) {
    return Fe.joinPath(t, ...n);
  }
  basenameOrAuthority(t) {
    return Qh(t) || t.authority;
  }
  basename(t) {
  ...
  dirname(t) {
    if (t.path.length === 0)
      return t;
    let n;
    return t.scheme === ye.file ? n = Fe.file(Pc(st(t))).path : (n = oe.dirname(t.path), t.authority && n.length && n.charCodeAt(0) !== N.Slash && (console.error(`dirname("${t.toString})) resulted in a relative path`), n = "/")), t.with({
      path: n
    });
  }
  normalizePath(t) {
    if (!t.path.length)
      return t;
    let n;
    return t.scheme === ye.file ? n = Fe.file(Dc(st(t))).path : n = oe.normalize(t.path), t.with({
      path: n
    });
  }
  relativePath(t, n) {
    if (t.scheme !== n.scheme || !Ja(t.authority, n.authority))
      return;
    if (t.scheme === ye.file) {
      const s = Fc(st(t), st(n));
      return en ? Hl(s) : s;
    }
    let i = t.path || "/";
    const r = n.path || "/";
  ...
  resolvePath(t, n) {
    if (t.scheme === ye.file) {
      const i = Fe.file(Ic(st(t), n));
      return t.with({
        authority: i.authority,
        path: i.path
      });
    }
    return n = qh(n), t.with({
  ...
  isEqualAuthority(t, n) {
    return t === n || t !== void 0 && n !== void 0 && Qu(t, n);
  }
  hasTrailingPathSeparator(t, n = On) {
    if (t.scheme === ye.file) {
      const i = st(t);
      return i.length > Xa(i).length && i[i.length - 1] === n;
    } else {
      const i = t.path;
      return i.length > 1 && i.charCodeAt(i.length - 1) === N.Slash && !/^[a-zA-Z]:(\/$|\\$)/.test(t.fsPath);
    }
  }
  removeTrailingPathSeparator(t, n = On) {
    return Za(t, n) ? t.with({ path: t.path.substr(0, t.path.length - 1) }) : t;
  }
  addTrailingPathSeparator(t, n = On) {
    let i = !1;
    if (t.scheme === ye.file) {
      const r = st(t);
      i = r !== void 0 && r.length === Xa(r).length && r[r.length - 1] === n;
    } else {
      n = "/";
      const r = t.path;
      i = r.length === 1 && r.charCodeAt(r.length - 1) === N.Slash;
    }
    return !i && !Za(t, n) ? t.with({ path: t.path + "/" }) : t;
  }
}
const re = new Yh(() => !1);
re.isEqual.bind(re);
...
const Ja = re.isEqualAuthority.bind(re), Za = re.hasTrailingPathSeparator.bind(re);
...
const ke = class ke {
  ...
  constructor(t, n) {
    this._state = Ce.Initial, this._results = [], this._error = null, this._onReturn = n, this._onStateChanged = new ze(), queueMicrotask(async () => {
      const i = {
  ...
  [Symbol.asyncIterator]() {
    ...
    return {
      next: async () => {
        do {
          if (this._state === Ce.DoneError)
            throw this._error;
          if (t < this._results.length)
            return { done: !1, value: this._results[t++] };
          if (this._state === Ce.DoneOK)
            return { done: !0, value: void 0 };
          await Cn.toPromise(this._onStateChanged.event);
        } while (!0);
      },
  ...
  emitOne(t) {
    this._state === Ce.Initial && (this._results.push(t), this._onStateChanged.fire());
  }
  emitMany(t) {
    this._state === Ce.Initial && (this._results = this._results.concat(t), this._onStateChanged.fire());
  }
  resolve() {
    this._state === Ce.Initial && (this._state = Ce.DoneOK, this._onStateChanged.fire());
  }
  reject(t) {
    this._state === Ce.Initial && (this._state = Ce.DoneError, this._error = t, this._onStateChanged.fire());
  }
};
...
class Jh {
  ...
  setValue(t, n) {
    return t = Dt(t), n = Dt(n), this.values[t] === n ? !1 : (this.values[t] = n, t - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = t - 1), !0);
  }
  removeValues(t, n) {
    t = Dt(t), n = Dt(n);
...
const ed = "workerTextModelSync";
class td {
  constructor() {
    this._models = /* @__PURE__ */ Object.create(null);
  }
  bindToServer(t) {
    t.setChannel(ed, this);
  }
  getModel(t) {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new nd(Fe.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class nd extends Kh {
  ...
  getWordAtPosition(t, n) {
    const i = kr(t.column, Nl(n), this._lines[t.lineNumber - 1], 0);
    return i ? new X(
      t.lineNumber,
      i.startColumn,
      t.lineNumber,
...
class Ol {
  ...
  getLengthDelta() {
    return lu(this.replacements, (t) => t.getLengthDelta());
  }
  getNewDataLength(t) {
...
class zl extends Ol {
  ...
  normalizeEOL(t) {
    return new Ke(this.replacements.map((n) => n.normalizeEOL(t)));
  }
  normalizeOnSource(t) {
    const n = this.apply(t), r = pe.replace(j.ofLength(t.length), n).removeCommonSuffixAndPrefix(t);
    return r.isEmpty ? Ke.empty : r.toEdit();
  }
  ...
  mapData(t) {
    return new Ki(this.replacements.map((n) => new et(n.replaceRange, n.newText, t(n))));
  }
}
class Wl extends id {
  constructor(t, n) {
  ...
  removeCommonSuffixPrefix(t) {
    const n = t.substring(this.replaceRange.start, this.replaceRange.endExclusive), i = jn(n, this.newText), r = Math.min(n.length - i, this.newText.length - i, $n(n, this.newText)), s = new j(
  ...
  removeCommonPrefix(t) {
    const n = this.replaceRange.substring(t), i = jn(n, this.newText);
...
const Ee = class Ee extends zl {
  ...
  static replace(t, n) {
    return new Ee([new pe(t, n)]);
  }
  static insert(t, n) {
    return new Ee([new pe(j.emptyAt(t), n)]);
  }
  static delete(t) {
    return new Ee([new pe(t, "")]);
  }
  static fromJson(t) {
    return new Ee(t.map(pe.fromJson));
  }
  static compose(t) {
    if (t.length === 0)
      return Ee.empty;
  ...
  static composeSequentialReplacements(t) {
    ...
    for (const r of t) {
      const s = i.at(-1);
      !s || r.replaceRange.isBefore(s.replaceRange) ? i.push(r) : (n = n.compose(Ee.create(i.reverse())), i = [r]);
    }
    return n = n.compose(Ee.create(i.reverse())), n;
  }
  constructor(t) {
    super(t);
  }
...
const je = class je extends zl {
  ...
  static replace(t, n, i) {
    return new je([new et(t, n, i)]);
  }
  static insert(t, n, i) {
    return new je([new et(j.emptyAt(t), n, i)]);
  }
  static delete(t, n) {
    return new je([new et(t, "", n)]);
  }
  static compose(t) {
    if (t.length === 0)
      return je.empty;
  ...
  toStringEdit() {
    return new Ke(this.replacements.map((t) => new pe(t.replaceRange, t.newText)));
  }
};
je.empty = new je([]);
let Ki = je;
...
const wt = class wt {
  constructor(t = null) {
    this._foreignModule = t, this._workerTextModelSyncServer = new td();
  }
  dispose() {
  }
  async $ping() {
  ...
  async $computeUnicodeHighlights(t, n, i) {
    ...
    return r ? sh.computeUnicodeHighlights(r, n, i) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  ...
  static computeDiff(t, n, i, r) {
    const s = r === "advanced" ? an.getDefault() : an.getLegacy(), a = t.getLinesContent(), l = n.getLinesContent(), o = s.computeDiff(a, l, i), u = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function c(d) {
      return d.map(
        (m) => [m.original.startLineNumber, m.original.endLineNumberExclusive, m.modified.startLineNumber, m.modified.endLineNumberExclusive, m.innerChanges?.map((g) => [
  ...
  $computeStringDiff(t, n, i, r) {
    const s = r === "advanced" ? an.getDefault() : an.getLegacy(), a = new kn(t), l = a.getLines(), o = new kn(n), u = o.getLines(), c = s.computeDiff(l, u, { ignoreTrimWhitespace: !1, maxComputationTimeMs: i.maxComputationTimeMs, computeMoves: !1, extendToSubwords: !1 }), d = tt.toTextEdit(c.changes, o);
  ...
  async $computeMoreMinimalEdits(t, n, i) {
    ...
    for (let { range: o, text: u, eol: c } of n) {
      ...
      const m = dc(d, u, i), g = r.offsetAt(X.lift(o).getStartPosition());
      for (const _ of m) {
  ...
  $computeHumanReadableDiff(t, n, i) {
    ...
    for (let { range: l, text: o, eol: u } of n) {
      ...
      if (o = o.replace(/\r\n|\n|\r/g, r.eol), c === o)
        continue;
      if (Math.max(o.length, c.length) > wt._diffLimit) {
        s.push({ range: l, text: o });
        continue;
      }
      const d = c.split(/\r\n|\n|\r/), m = o.split(/\r\n|\n|\r/), g = an.getDefault().computeDiff(d, m, i), _ = X.lift(l).getStartPosition();
  ...
  async $textualSuggest(t, n, i, r) {
    const s = new _i(), a = new RegExp(i, r), l = /* @__PURE__ */ new Set();
    e: for (const o of t) {
  ...
  async $navigateValueSet(t, n, i, r, s) {
    ...
    return Bi.INSTANCE.navigateValueSet(n, o, u, c, i);
  }
  $fmr(t, n) {
...
wt._diffLimit = 1e5, wt._suggestionsLimit = 1e4;
let ni = wt;
typeof importScripts == "function" && (globalThis.monaco = Qc());
cc(() => new ni(null));
const wn = class wn {
  static getChannel(t) {
    return t.getChannel(wn.CHANNEL_NAME);
  }
  static setChannel(t, n) {
    t.setChannel(wn.CHANNEL_NAME, n);
  }
};
...
var ad = /{([^}]+)}/g;
function od(e, t) {
  return Object.keys(t).length === 0 ? e : e.replace(ad, (n, i) => t[i] ?? n);
}
var ro;
(function(e) {
  function t(n) {
...
(function(e) {
  function t(i, r) {
    return i === Number.MAX_VALUE && (i = ii.MAX_VALUE), r === Number.MAX_VALUE && (r = ii.MAX_VALUE), { line: i, character: r };
  }
  e.create = t;
  function n(i) {
    let r = i;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return D.objectLiteral(r) && ge.is(r.start) && ge.is(r.end);
  }
  e.is = n;
})(ie || (ie = {}));
var ri;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return D.objectLiteral(r) && ie.is(r.range) && (D.string(r.uri) || D.undefined(r.uri));
  }
  e.is = n;
})(ri || (ri = {}));
var ao;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return D.objectLiteral(r) && ie.is(r.targetRange) && D.string(r.targetUri) && ie.is(r.targetSelectionRange) && (ie.is(r.originSelectionRange) || D.undefined(r.originSelectionRange));
  }
  e.is = n;
})(ao || (ao = {}));
var nr;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return D.objectLiteral(r) && D.numberRange(r.red, 0, 1) && D.numberRange(r.green, 0, 1) && D.numberRange(r.blue, 0, 1) && D.numberRange(r.alpha, 0, 1);
  }
  e.is = n;
})(nr || (nr = {}));
var oo;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return D.objectLiteral(r) && ie.is(r.range) && nr.is(r.color);
  }
  e.is = n;
})(oo || (oo = {}));
var lo;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return D.objectLiteral(r) && D.string(r.label) && (D.undefined(r.textEdit) || we.is(r)) && (D.undefined(r.additionalTextEdits) || D.typedArray(r.additionalTextEdits, we.is));
  }
  e.is = n;
})(lo || (lo = {}));
var si;
...
(function(e) {
  function t(i, r, s, a, l, o) {
    ...
    return D.defined(s) && (u.startCharacter = s), D.defined(a) && (u.endCharacter = a), D.defined(l) && (u.kind = l), D.defined(o) && (u.collapsedText = o), u;
  }
  e.create = t;
  function n(i) {
    const r = i;
    return D.objectLiteral(r) && D.uinteger(r.startLine) && D.uinteger(r.startLine) && (D.undefined(r.startCharacter) || D.uinteger(r.startCharacter)) && (D.undefined(r.endCharacter) || D.uinteger(r.endCharacter)) && (D.undefined(r.kind) || D.string(r.kind));
  }
  e.is = n;
})(uo || (uo = {}));
var ir;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return D.defined(r) && ri.is(r.location) && D.string(r.message);
  }
  e.is = n;
})(ir || (ir = {}));
var co;
...
(function(e) {
  function t(i, r, s, a, l, o) {
    ...
    return D.defined(s) && (u.severity = s), D.defined(a) && (u.code = a), D.defined(l) && (u.source = l), D.defined(o) && (u.relatedInformation = o), u;
  }
  e.create = t;
  function n(i) {
    var r;
    let s = i;
    return D.defined(s) && ie.is(s.range) && D.string(s.message) && (D.number(s.severity) || D.undefined(s.severity)) && (D.integer(s.code) || D.string(s.code) || D.undefined(s.code)) && (D.undefined(s.codeDescription) || D.string((r = s.codeDescription) === null || r === void 0 ? void 0 : r.href)) && (D.string(s.source) || D.undefined(s.source)) && (D.undefined(s.relatedInformation) || D.typedArray(s.relatedInformation, ir.is));
  }
  e.is = n;
})(ai || (ai = {}));
var nn;
...
(function(e) {
  ...
  function r(s) {
    const a = s;
    return D.objectLiteral(a) && D.string(a.newText) && ie.is(a.range);
  }
  e.is = r;
})(we || (we = {}));
var rr;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return D.objectLiteral(r) && D.string(r.label) && (D.boolean(r.needsConfirmation) || r.needsConfirmation === void 0) && (D.string(r.description) || r.description === void 0);
  }
  e.is = n;
})(rr || (rr = {}));
var rn;
...
(function(e) {
  ...
  function r(s) {
    const a = s;
    return we.is(a) && (rr.is(a.annotationId) || rn.is(a.annotationId));
  }
  e.is = r;
})(fo || (fo = {}));
var sr;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return D.defined(r) && cr.is(r.textDocument) && Array.isArray(r.edits);
  }
  e.is = n;
})(sr || (sr = {}));
var ar;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && r.kind === "create" && D.string(r.uri) && (r.options === void 0 || (r.options.overwrite === void 0 || D.boolean(r.options.overwrite)) && (r.options.ignoreIfExists === void 0 || D.boolean(r.options.ignoreIfExists))) && (r.annotationId === void 0 || rn.is(r.annotationId));
  }
  e.is = n;
})(ar || (ar = {}));
var or;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && r.kind === "rename" && D.string(r.oldUri) && D.string(r.newUri) && (r.options === void 0 || (r.options.overwrite === void 0 || D.boolean(r.options.overwrite)) && (r.options.ignoreIfExists === void 0 || D.boolean(r.options.ignoreIfExists))) && (r.annotationId === void 0 || rn.is(r.annotationId));
  }
  e.is = n;
})(or || (or = {}));
var lr;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && r.kind === "delete" && D.string(r.uri) && (r.options === void 0 || (r.options.recursive === void 0 || D.boolean(r.options.recursive)) && (r.options.ignoreIfNotExists === void 0 || D.boolean(r.options.ignoreIfNotExists))) && (r.annotationId === void 0 || rn.is(r.annotationId));
  }
  e.is = n;
})(lr || (lr = {}));
var ur;
(function(e) {
  function t(n) {
    let i = n;
    return i && (i.changes !== void 0 || i.documentChanges !== void 0) && (i.documentChanges === void 0 || i.documentChanges.every((r) => D.string(r.kind) ? ar.is(r) || or.is(r) || lr.is(r) : sr.is(r)));
  }
  e.is = t;
})(ur || (ur = {}));
var po;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return D.defined(r) && D.string(r.uri) && D.string(r.languageId) && D.integer(r.version) && D.string(r.text);
  }
  e.is = n;
})(bo || (bo = {}));
var ct;
...
(function(e) {
  function t(n) {
    const i = n;
    return D.objectLiteral(n) && ct.is(i.kind) && D.string(i.value);
  }
  e.is = t;
})(Rn || (Rn = {}));
var Ue;
...
(function(e) {
  ...
  function n(i) {
    const r = i;
    return r && D.string(r.newText) && ie.is(r.insert) && ie.is(r.replace);
  }
  e.is = n;
})(wo || (wo = {}));
var vo;
...
(function(e) {
  function t(n) {
    const i = n;
    return i && (D.string(i.detail) || i.detail === void 0) && (D.string(i.description) || i.description === void 0);
  }
  e.is = t;
})(To || (To = {}));
var xo;
...
(function(e) {
  function t(n) {
    let i = n;
    return !!i && D.objectLiteral(i) && (Rn.is(i.contents) || oi.is(i.contents) || D.typedArray(i.contents, oi.is)) && (n.range === void 0 || ie.is(n.range));
  }
  e.is = t;
})(Ao || (Ao = {}));
var Lo;
...
(function(e) {
  function t(n, i, ...r) {
    let s = { label: n };
    return D.defined(i) && (s.documentation = i), D.defined(r) ? s.parameters = r : s.parameters = [], s;
  }
  e.create = t;
})(ko || (ko = {}));
var li;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return r && D.string(r.name) && D.number(r.kind) && ie.is(r.range) && ie.is(r.selectionRange) && (r.detail === void 0 || D.string(r.detail)) && (r.deprecated === void 0 || D.boolean(r.deprecated)) && (r.children === void 0 || Array.isArray(r.children)) && (r.tags === void 0 || Array.isArray(r.tags));
  }
  e.is = n;
})(mr || (mr = {}));
var No;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return D.defined(r) && D.typedArray(r.diagnostics, ai.is) && (r.only === void 0 || D.typedArray(r.only, D.string)) && (r.triggerKind === void 0 || r.triggerKind === ui.Invoked || r.triggerKind === ui.Automatic);
  }
  e.is = n;
})(Mo || (Mo = {}));
var Do;
(function(e) {
  function t(i, r, s) {
    let a = { title: i }, l = !0;
    return typeof r == "string" ? (l = !1, a.kind = r) : nn.is(r) ? a.command = r : a.edit = r, l && s !== void 0 && (a.kind = s), a;
  }
  e.create = t;
  function n(i) {
    let r = i;
    return r && D.string(r.title) && (r.diagnostics === void 0 || D.typedArray(r.diagnostics, ai.is)) && (r.kind === void 0 || D.string(r.kind)) && (r.edit !== void 0 || r.command !== void 0) && (r.command === void 0 || nn.is(r.command)) && (r.isPreferred === void 0 || D.boolean(r.isPreferred)) && (r.edit === void 0 || ur.is(r.edit));
  }
  e.is = n;
})(Do || (Do = {}));
var Uo;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return D.defined(r) && ie.is(r.range) && (D.undefined(r.command) || nn.is(r.command));
  }
  e.is = n;
})(Uo || (Uo = {}));
var Io;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return D.defined(r) && ie.is(r.range) && (D.undefined(r.target) || D.string(r.target));
  }
  e.is = n;
})(Fo || (Fo = {}));
var ci;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return D.objectLiteral(r) && ie.is(r.range) && (r.parent === void 0 || e.is(r.parent));
  }
  e.is = n;
})(ci || (ci = {}));
var Po;
...
(function(e) {
  function t(n) {
    const i = n;
    return D.objectLiteral(i) && (i.resultId === void 0 || typeof i.resultId == "string") && Array.isArray(i.data) && (i.data.length === 0 || typeof i.data[0] == "number");
  }
  e.is = t;
})(Ho || (Ho = {}));
var Oo;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return r != null && ie.is(r.range) && D.string(r.text);
  }
  e.is = n;
})(Oo || (Oo = {}));
var zo;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return r != null && ie.is(r.range) && D.boolean(r.caseSensitiveLookup) && (D.string(r.variableName) || r.variableName === void 0);
  }
  e.is = n;
})(zo || (zo = {}));
var Wo;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return r != null && ie.is(r.range) && (D.string(r.expression) || r.expression === void 0);
  }
  e.is = n;
})(Wo || (Wo = {}));
var qo;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return D.defined(r) && ie.is(i.stoppedLocation);
  }
  e.is = n;
})(qo || (qo = {}));
var fr;
...
(function(e) {
  ...
  function n(i) {
    const r = i;
    return D.objectLiteral(r) && (r.tooltip === void 0 || D.string(r.tooltip) || Rn.is(r.tooltip)) && (r.location === void 0 || ri.is(r.location)) && (r.command === void 0 || nn.is(r.command));
  }
  e.is = n;
})(pr || (pr = {}));
var Vo;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return D.objectLiteral(r) && ge.is(r.position) && (D.string(r.label) || D.typedArray(r.label, pr.is)) && (r.kind === void 0 || fr.is(r.kind)) && r.textEdits === void 0 || D.typedArray(r.textEdits, we.is) && (r.tooltip === void 0 || D.string(r.tooltip) || Rn.is(r.tooltip)) && (r.paddingLeft === void 0 || D.boolean(r.paddingLeft)) && (r.paddingRight === void 0 || D.boolean(r.paddingRight));
  }
  e.is = n;
})(Vo || (Vo = {}));
var Co;
...
(function(e) {
  function t(n) {
    const i = n;
    return D.objectLiteral(i) && tr.is(i.uri) && D.string(i.name);
  }
  e.is = t;
})(Qo || (Qo = {}));
var Jo;
(function(e) {
  function t(s, a, l, o) {
    return new ld(s, a, l, o);
  }
  e.create = t;
  function n(s) {
    let a = s;
    return !!(D.defined(a) && D.string(a.uri) && (D.undefined(a.languageId) || D.string(a.languageId)) && D.uinteger(a.lineCount) && D.func(a.getText) && D.func(a.positionAt) && D.func(a.offsetAt));
  }
  e.is = n;
  function i(s, a) {
...
var Zo = class gr {
  ...
  update(t, n) {
    for (let i of t)
      if (gr.isIncremental(i)) {
        const r = ql(i.range), s = this.offsetAt(r.start), a = this.offsetAt(r.end);
  ...
  getLineOffsets() {
    return this._lineOffsets === void 0 && (this._lineOffsets = Ko(this._content, !0)), this._lineOffsets;
  }
  positionAt(t) {
...
(function(e) {
  ...
  e.update = n;
  function i(r, s) {
    let a = r.getText(), l = _r(s.map(ud), (c, d) => {
      let m = c.range.start.line - d.range.start.line;
      return m === 0 ? c.range.start.character - d.range.start.character : m;
    }), o = 0;
    const u = [];
...
var cd = class {
  ...
  skipWhitespace() {
    return this.advanceWhileChar((t) => t === bd || t === _d || t === fd || t === gd || t === pd) > 0;
  }
  advanceWhileChar(e) {
...
}, tl = 33, Ht = 45, In = 60, Qe = 62, Li = 47, hd = 61, dd = 34, md = 39, fd = 10, pd = 13, gd = 12, bd = 32, _d = 9, wd = {
  "text/x-handlebars-template": !0,
  // Fix for https://github.com/microsoft/vscode/issues/77977
  "text/html": !0
};
function He(e, t = 0, n = J.WithinContent, i = !1) {
  const r = new cd(e, t);
  let s = n, a = 0, l = O.Unknown, o, u, c, d, m;
  function g() {
  ...
  function L() {
    ...
    return H !== O.EOS && w === r.pos() && !(i && (H === O.StartTagClose || H === O.EndTagClose)) ? (console.warn("Scanner.scan has not advanced at offset " + w + ", state before: " + E + " after: " + s), r.advance(1), p(w, O.Unknown)) : H;
  }
  function A() {
    const w = r.pos();
    if (r.eos())
    ...
    switch (s) {
      case J.WithinComment:
        return r.advanceIfChars([Ht, Ht, Qe]) ? (s = J.WithinContent, p(w, O.EndCommentTag)) : (r.advanceUntilChars([Ht, Ht, Qe]), p(w, O.Comment));
      case J.WithinDoctype:
        return r.advanceIfChar(Qe) ? (s = J.WithinContent, p(w, O.EndDoctypeTag)) : (r.advanceUntilChar(Qe), p(w, O.Doctype));
      case J.WithinContent:
        if (r.advanceIfChar(In)) {
          if (!r.eos() && r.peekChar() === tl) {
            if (r.advanceIfChars([tl, Ht, Ht]))
              return s = J.WithinComment, p(w, O.StartCommentTag);
            if (r.advanceIfRegExp(/^!doctype/i))
              return s = J.WithinDoctype, p(w, O.StartDoctypeTag);
          }
          return r.advanceIfChar(Li) ? (s = J.AfterOpeningEndTag, p(w, O.EndTagOpen)) : (s = J.AfterOpeningStartTag, p(w, O.StartTagOpen));
        }
        return r.advanceUntilChar(In), p(w, O.Content);
      case J.AfterOpeningEndTag:
        return g().length > 0 ? (s = J.WithinEndTag, p(w, O.EndTag)) : r.skipWhitespace() ? p(w, O.Whitespace, $e("Tag name must directly follow the open bracket.")) : (s = J.WithinEndTag, r.advanceUntilChar(Qe), w < r.pos() ? p(w, O.Unknown, $e("End tag name expected.")) : A());
      case J.WithinEndTag:
        if (r.skipWhitespace())
          return p(w, O.Whitespace);
        if (r.advanceIfChar(Qe))
          return s = J.WithinContent, p(w, O.EndTagClose);
        if (i && r.peekChar() === In)
          return s = J.WithinContent, p(w, O.EndTagClose, $e("Closing bracket missing."));
        E = $e("Closing bracket expected.");
        break;
      case J.AfterOpeningStartTag:
        return c = g(), m = void 0, d = void 0, c.length > 0 ? (u = !1, s = J.WithinTag, p(w, O.StartTag)) : r.skipWhitespace() ? p(w, O.Whitespace, $e("Tag name must directly follow the open bracket.")) : (s = J.WithinTag, r.advanceUntilChar(Qe), w < r.pos() ? p(w, O.Unknown, $e("Start tag name expected.")) : A());
      case J.WithinTag:
        return r.skipWhitespace() ? (u = !0, p(w, O.Whitespace)) : u && (d = _(), d.length > 0) ? (s = J.AfterAttributeName, u = !1, p(w, O.AttributeName)) : r.advanceIfChars([Li, Qe]) ? (s = J.WithinContent, p(w, O.StartTagSelfClose)) : r.advanceIfChar(Qe) ? (c === "script" ? m && wd[m] ? s = J.WithinContent : s = J.WithinScriptContent : c === "style" ? s = J.WithinStyleContent : s = J.WithinContent, p(w, O.StartTagClose)) : i && r.peekChar() === In ? (s = J.WithinContent, p(w, O.StartTagClose, $e("Closing bracket missing."))) : (r.advance(1), p(w, O.Unknown, $e("Unexpected character in tag.")));
      case J.AfterAttributeName:
        return r.skipWhitespace() ? (u = !0, p(w, O.Whitespace)) : r.advanceIfChar(hd) ? (s = J.BeforeAttributeValue, p(w, O.DelimiterAssign)) : (s = J.WithinTag, A());
      case J.BeforeAttributeValue:
        if (r.skipWhitespace())
          return p(w, O.Whitespace);
        let W = r.advanceIfRegExp(/^[^\s"'`=<>]+/);
        if (W.length > 0 && (r.peekChar() === Qe && r.peekChar(-1) === Li && (r.goBack(1), W = W.substring(0, W.length - 1)), d === "type" && (m = W), W.length > 0))
          return s = J.WithinTag, u = !1, p(w, O.AttributeValue);
        const z = r.peekChar();
        return z === md || z === dd ? (r.advance(1), r.advanceUntilChar(z) && r.advance(1), d === "type" && (m = r.getSource().substring(w + 1, r.pos() - 1)), s = J.WithinTag, u = !1, p(w, O.AttributeValue)) : (s = J.WithinTag, u = !1, A());
      case J.WithinScriptContent:
        let b = 1;
        for (; !r.eos(); ) {
          const f = r.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
          if (f.length === 0)
            return r.goToEnd(), p(w, O.Script);
          if (f === "<!--")
            b === 1 && (b = 2);
          else if (f === "-->")
            b = 1;
        ...
        return s = J.WithinContent, w < r.pos() ? p(w, O.Script) : A();
      case J.WithinStyleContent:
        return r.advanceUntilRegExp(/<\/style/i), s = J.WithinContent, w < r.pos() ? p(w, O.Styles) : A();
    }
    return r.advance(1), s = J.WithinContent, p(w, O.Unknown, E);
  }
  return {
    scan: L,
    getTokenType: () => l,
...
var il = class {
  ...
  findNodeBefore(e) {
    const t = nl(this.children, (n) => e <= n.start) - 1;
    if (t >= 0) {
  ...
  parse(e, t) {
    const n = He(e, void 0, void 0, !0), i = new il(0, e.length, [], void 0);
    let r = i, s = -1, a, l = null, o = n.scan();
    for (; o !== O.EOS; ) {
      switch (o) {
        case O.StartTagOpen:
          const u = new il(n.getTokenOffset(), e.length, [], r);
          r.children.push(u), r = u;
          break;
        case O.StartTag:
          r.tag = n.getTokenText();
          break;
        case O.StartTagClose:
        ...
        case O.EndTagClose:
          ...
          break;
        case O.AttributeName: {
          l = n.getTokenText();
          let d = r.attributes;
          d || (r.attributes = d = {}), d[l] = null;
          break;
        }
        case O.AttributeValue: {
...
var yd = 97, Ad = 122, Ld = 65, kd = 90, Ed = 48, Rd = 57;
function un(e, t) {
  const n = e.charCodeAt(t);
  return yd <= n && n <= Ad || Ld <= n && n <= kd || Ed <= n && n <= Rd;
}
function hi(e) {
  return typeof e < "u";
}
...
var Nd = class {
  ...
  async computeCompletions(e, t) {
    ...
    for (const i of this.atributeCompletions) {
      const r = Dd(e.getText(i.range));
      if (Ud(r))
        if (r === "." || r === "..")
          n.isIncomplete = !0;
        else {
          const s = Id(i.value, r, i.range), a = await this.providePathSuggestions(i.value, s, e, t);
          for (const l of a)
            n.items.push(l);
        }
    }
  ...
  async providePathSuggestions(e, t, n, i) {
    ...
    if (s)
      try {
        ...
        for (const [o, u] of l)
          o.charCodeAt(0) !== Md && a.push(Fd(o, u === wr.Directory, t));
        return a;
      } catch {
      }
    return [];
...
function Id(e, t, n) {
  ...
  if (r === -1)
    ...
    const s = t.slice(r + 1), a = bn(n.end, -1 - s.length), l = s.indexOf(" ");
    let o;
    l !== -1 ? o = bn(a, l) : o = bn(n.end, -1), i = ie.create(a, o);
  }
  return i;
}
function Fd(e, t, n) {
...
function Pd(e, t, n) {
  const i = bn(e.start, t), r = bn(e.end, n);
...
var Bd = class {
  ...
  async doComplete2(e, t, n, i, r) {
    ...
    const s = new Nd(this.dataManager, this.lsOptions.fileSystemProvider.readDirectory), a = this.completionParticipants;
  ...
  _doComplete(e, t, n, i) {
    const r = {
      isIncomplete: !1,
      items: []
    }, s = this.completionParticipants, a = this.dataManager.getDataProviders().filter((y) => y.isApplicable(e.languageId) && (!i || i[y.getId()] !== !1)), l = this.dataManager.getVoidElements(a), o = this.doesSupportMarkdown(), u = e.getText(), c = e.offsetAt(t), d = n.findNodeBefore(c);
    if (!d)
      return r;
    const m = He(u, d.start);
    let g = "", _;
    function p(y, M = c) {
      return y > c && (y = c), { start: e.positionAt(y), end: e.positionAt(M) };
    }
    function L(y, M) {
      const I = p(y, M);
      return a.forEach((F) => {
        F.provideTags().forEach((C) => {
          r.items.push({
            label: C.name,
            kind: Ue.Property,
            documentation: St(C, void 0, o),
            textEdit: we.replace(I, C.name),
    ...
    function A(y) {
      let M = y;
      for (; M > 0; ) {
        const I = u.charAt(M - 1);
        if (`
\r`.indexOf(I) >= 0)
          return u.substring(M, y);
        if (!di(I))
          return null;
        M--;
      }
    ...
    function w(y, M, I = c) {
      const F = p(y, I), C = sl(u, I, J.WithinEndTag, O.EndTagClose) ? "" : ">";
      let q = d;
      for (M && (q = q.parent); q; ) {
        const V = q.tag;
        if (V && (!q.closed || q.endTagStart && q.endTagStart > c)) {
          const Z = {
            ...
            kind: Ue.Property,
            filterText: "/" + V,
            textEdit: we.replace(F, "/" + V + C),
            insertTextFormat: Ge.PlainText
          }, se = A(q.start), be = A(y - 1);
          if (se !== null && be !== null && se !== be) {
            const Oe = se + "</" + V + C;
            Z.textEdit = we.replace(p(y - 1 - be.length), Oe), Z.filterText = be + "</" + V;
          }
          return r.items.push(Z), r;
        }
        q = q.parent;
      }
      return M || a.forEach((V) => {
        V.provideTags().forEach((Z) => {
          r.items.push({
            label: "/" + Z.name,
            kind: Ue.Property,
            documentation: St(Z, void 0, o),
            filterText: "/" + Z.name + C,
            textEdit: we.replace(F, "/" + Z.name + C),
            insertTextFormat: Ge.PlainText
          });
        });
      }), r;
    ...
    const E = (y, M) => {
      if (i && i.hideAutoCompleteProposals)
        return r;
      if (!this.dataManager.isVoidElement(M, l)) {
        const I = e.positionAt(y);
        r.items.push({
          label: "</" + M + ">",
          kind: Ue.Property,
          filterText: "</" + M + ">",
          textEdit: we.insert(I, "$0</" + M + ">"),
    ...
    function z(y, M = c) {
      ...
      for (; I < M && u[I] !== "<"; )
        I++;
      const F = u.substring(y, M), C = p(y, I);
      let q = "";
      if (!sl(u, M, J.AfterAttributeName, O.DelimiterAssign)) {
        const Z = i?.attributeDefaultValue ?? "doublequotes";
      ...
      return V[F] = !1, a.forEach((Z) => {
        Z.provideAttributes(g).forEach((se) => {
          ...
          V[se.name] = !0;
          let be = se.name, Oe;
          se.valueSet !== "v" && q.length && (be = be + q, (se.valueSet || se.name === "style") && (Oe = {
            title: "Suggest",
            command: "editor.action.triggerSuggest"
          })), r.items.push({
            label: se.name,
            kind: se.valueSet === "handler" ? Ue.Function : Ue.Value,
            documentation: St(se, void 0, o),
            textEdit: we.replace(C, be),
            insertTextFormat: Ge.Snippet,
            command: Oe
          });
        });
    ...
    function f(y, M = c) {
      ...
      if (c > y && c <= M && Hd(u[y])) {
        ...
        let V = M;
        M > y && u[M - 1] === u[y] && V--;
        const Z = Od(u, c, q), se = zd(u, c, V);
        I = p(Z, se), C = c >= q && c <= V ? u.substring(q, c) : "", F = !1;
      } else
        I = p(y, M), C = u.substring(y, c), F = !0;
      if (s.length > 0) {
        const q = g.toLowerCase(), V = _.toLowerCase(), Z = p(y, M);
        for (const se of s)
      ...
      return a.forEach((q) => {
        q.provideValues(g, _).forEach((V) => {
          ...
          r.items.push({
            ...
            filterText: Z,
            kind: Ue.Unit,
            documentation: St(V, void 0, o),
            textEdit: we.replace(I, Z),
            insertTextFormat: Ge.PlainText
          });
        });
      }), S(), r;
    ...
    function v(y) {
      return c === m.getTokenEnd() && (U = m.scan(), U === y && m.getTokenOffset() === c) ? m.getTokenEnd() : c;
    }
    function P() {
      for (const y of s)
    ...
    function S() {
      let y = c - 1, M = t.character;
      for (; y >= 0 && un(u, y); )
        y--, M--;
      if (y >= 0 && u[y] === "&") {
        const I = ie.create(ge.create(t.line, M - 1), t);
        for (const F in gn)
          if (xd(F, ";")) {
            const C = "&" + F;
            r.items.push({
              label: C,
              kind: Ue.Keyword,
              documentation: $e("Character entity representing '{0}'", gn[F]),
              textEdit: we.replace(I, C),
              insertTextFormat: Ge.PlainText
            });
          }
      }
    ...
    function k(y, M) {
      ...
      r.items.push({
        ...
        textEdit: we.replace(I, "!DOCTYPE html>"),
        insertTextFormat: Ge.PlainText
      });
    }
    let U = m.scan();
    for (; U !== O.EOS && m.getTokenOffset() <= c; ) {
      switch (U) {
        case O.StartTagOpen:
          if (m.getTokenEnd() === c) {
            const y = v(O.StartTag);
            return t.line === 0 && k(c, y), H(c, y);
          }
          break;
        case O.StartTag:
        ...
        case O.AttributeName:
          if (m.getTokenOffset() <= c && c <= m.getTokenEnd())
            return z(m.getTokenOffset(), m.getTokenEnd());
          _ = m.getTokenText();
          break;
        case O.DelimiterAssign:
          if (m.getTokenEnd() === c) {
            const y = v(O.AttributeValue);
            return f(c, y);
          }
          break;
        case O.AttributeValue:
        ...
        case O.Whitespace:
          if (c <= m.getTokenEnd())
            switch (m.getScannerState()) {
              case J.AfterOpeningStartTag:
                const y = m.getTokenOffset(), M = v(O.StartTag);
                return H(y, M);
              case J.WithinTag:
              case J.AfterAttributeName:
                return z(m.getTokenEnd());
              case J.BeforeAttributeValue:
        ...
        case O.EndTagOpen:
          if (c <= m.getTokenEnd()) {
            const y = m.getTokenOffset() + 1, M = v(O.EndTag);
            return w(y, !1, M);
          }
          break;
        case O.EndTag:
  ...
  doQuoteComplete(e, t, n, i) {
    ...
    if (o && o.attributes && o.start < r && (!o.endTagStart || o.endTagStart > r)) {
      const u = He(e.getText(), o.start);
      let c = u.scan();
      for (; c !== O.EOS && u.getTokenEnd() <= r; ) {
        if (c === O.AttributeName && u.getTokenEnd() === r - 1)
          return c = u.scan(), c !== O.DelimiterAssign || (c = u.scan(), c === O.Unknown || c === O.AttributeValue) ? null : l;
        c = u.scan();
      }
    }
    return null;
  ...
  doTagComplete(e, t, n) {
    ...
    if (r === ">") {
      ...
      if (a && a.tag && !this.dataManager.isVoidElement(a.tag, s) && a.start < i && (!a.endTagStart || a.endTagStart > i)) {
        const l = He(e.getText(), a.start);
        let o = l.scan();
        for (; o !== O.EOS && l.getTokenEnd() <= i; ) {
          if (o === O.StartTagClose && l.getTokenEnd() === i)
            return `$0</${a.tag}>`;
          o = l.scan();
        }
      }
      ...
      for (; s && s.closed && !(s.endTagStart && s.endTagStart > i); )
        s = s.parent;
      if (s && s.tag) {
        const a = He(e.getText(), s.start);
        let l = a.scan();
        for (; l !== O.EOS && a.getTokenEnd() <= i; ) {
          if (l === O.EndTagOpen && a.getTokenEnd() === i)
  ...
  doesSupportMarkdown() {
    if (!hi(this.supportsMarkdown)) {
      if (!hi(this.lsOptions.clientCapabilities))
      ...
      this.supportsMarkdown = Array.isArray(e) && e.indexOf(ct.Markdown) !== -1;
    }
...
var Wd = class {
  ...
  doHover(e, t, n, i) {
    ...
    if (!l || !l.tag)
      return null;
    const u = this.dataManager.getDataProviders().filter((z) => z.isApplicable(e.languageId));
    function c(z, b, f) {
      for (const v of u) {
        let P = null;
        if (v.provideTags().forEach((S) => {
          if (S.name.toLowerCase() === z.toLowerCase()) {
            let k = St(S, i, s);
            k || (k = {
    ...
    function d(z, b, f) {
      for (const v of u) {
        let P = null;
        if (v.provideAttributes(z).forEach((S) => {
    ...
    function m(z, b, f, v) {
      for (const P of u) {
        let S = null;
        if (P.provideValues(z, b).forEach((k) => {
          if (f === k.name && k.description) {
            const U = St(k, i, s);
            U ? S = { contents: U, range: v } : S = null;
          }
        }), S)
    ...
    function g(z, b) {
      ...
      for (const v in gn) {
        ...
        const S = "&" + v;
        if (f === S) {
          let k = gn[v].charCodeAt(0).toString(16).toUpperCase(), U = "U+";
          if (k.length < 4) {
            const M = 4 - k.length;
            let I = 0;
            for (; I < M; )
          ...
          U += k;
          const y = $e("Character entity representing '{0}', unicode equivalent '{1}'", gn[v], U);
          y ? P = { contents: y, range: b } : P = null;
        }
        if (P)
          return P.contents = r(P.contents), P;
      }
    ...
    function _(z, b) {
      const f = He(e.getText(), b);
      let v = f.scan();
      for (; v !== O.EOS && (f.getTokenEnd() < a || f.getTokenEnd() === a && v !== z); )
        v = f.scan();
      return v === z && a <= f.getTokenEnd() ? { start: e.positionAt(f.getTokenOffset()), end: e.positionAt(f.getTokenEnd()) } : null;
    }
    function p() {
      let z = a - 1, b = t.character;
      for (; z >= 0 && un(o, z); )
        z--, b--;
      let f = z + 1, v = b;
      for (; un(o, f); )
    ...
    if (l.endTagStart && a >= l.endTagStart) {
      const z = _(O.EndTag, l.endTagStart);
      return z ? c(l.tag, z) : null;
    }
    const A = _(O.StartTag, l.start);
    if (A)
      return c(l.tag, A);
    const w = _(O.AttributeName, l.start);
    if (w) {
      const z = l.tag, b = e.getText(w);
      return d(z, b, w);
    }
    const E = p();
    if (E)
      return g(o, E);
    function H(z, b) {
      const f = He(e.getText(), z);
      let v = f.scan(), P;
      for (; v !== O.EOS && f.getTokenEnd() <= b; )
        v = f.scan(), v === O.AttributeName && (P = f.getTokenText());
      return P;
    }
    const W = _(O.AttributeValue, l.start);
    if (W) {
      const z = l.tag, b = qd(e.getText(W)), f = H(l.start, e.offsetAt(W.start));
      if (f)
        return m(z, f, b, W);
    }
    return null;
...
`);
        ...
        for (var z = 0, b = !1, f = !1, v = !1, P = !1, S = !1, k = this._ch, U = !1, y, M, I; y = this._input.read(p), M = y !== "", I = k, this._ch = this._input.next(), this._ch === "\\" && this._input.hasNext() && (this._ch += this._input.next()), k = this._ch, this._ch; )
          if (this._ch === "/" && this._input.peek() === "*") {
            ...
            q.match(/[ :]$/) && (q = this.eatString(": ").replace(/\s+$/, ""), this.print_string(q), this._output.space_before_token = !0), z === 0 && q.indexOf(":") !== -1 && (f = !0, this.indent());
          } else if (this._ch === "@")
            if (this.preserveSingleSpace(M), this._input.peek() === "{")
              ...
              V.match(/[ :]$/) && (V = this.eatString(": ").replace(/\s+$/, ""), this.print_string(V), this._output.space_before_token = !0), z === 0 && V.indexOf(":") !== -1 ? (f = !0, this.indent()) : V in this.NESTED_AT_RULE ? (this._nestedLevel += 1, V in this.CONDITIONAL_GROUP_RULE && (v = !0)) : z === 0 && !f && (P = !0);
            }
          else if (this._ch === "#" && this._input.peek() === "{")
            ...
            (b || v) && !(this._input.lookBack("&") || this.foundNestedPseudoClass()) && !this._input.lookBack("(") && !P && z === 0 ? (this.print_string(":"), f || (f = !0, this._output.space_before_token = !0, this.eatWhitespace(!0), this.indent())) : (this._input.lookBack(" ") && (this._output.space_before_token = !0), this._input.peek() === ":" ? (this._ch = this._input.next(), this.print_string("::")) : this.print_string(":"));
          } else if (this._ch === '"' || this._ch === "'") {
            var se = I === '"' || I === "'";
            this.preserveSingleSpace(se || M), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0);
          } else if (this._ch === ";")
            U = !1, z === 0 ? (f && (this.outdent(), f = !1), P = !1, this.print_string(this._ch), this.eatWhitespace(!0), this._input.peek() !== "/" && this._output.add_new_line()) : (this.print_string(this._ch), this.eatWhitespace(!0), this._output.space_before_token = !0);
          else if (this._ch === "(")
            if (this._input.lookBack("url"))
              this.print_string(this._ch), this.eatWhitespace(), z++, this.indent(), this._ch = this._input.next(), this._ch === ")" || this._ch === '"' || this._ch === "'" ? this._input.back() : this._ch && (this.print_string(this._ch + this.eatString(")")), z && (z--, this.outdent()));
            else {
              var be = !1;
              this._input.lookBack("with") && (be = !0), this.preserveSingleSpace(M || be), this.print_string(this._ch), f && I === "$" && this._options.selector_separator_newline ? (this._output.add_new_line(), S = !0) : (this.eatWhitespace(), z++, this.indent());
            }
          else if (this._ch === ")")
            z && (z--, this.outdent()), S && this._input.peek() === ";" && this._options.selector_separator_newline && (S = !1, this.outdent(), this._output.add_new_line()), this.print_string(this._ch);
          else if (this._ch === ",")
            this.print_string(this._ch), this.eatWhitespace(!0), this._options.selector_separator_newline && (!f || S) && z === 0 && !P ? this._output.add_new_line() : this._output.space_before_token = !0;
          else if ((this._ch === ">" || this._ch === "+" || this._ch === "~") && !f && z === 0)
            ...
            var Oe = I === '"' || I === "'";
            this.preserveSingleSpace(Oe || M), this.print_string(this._ch), !this._output.just_added_newline() && this._input.peek() === `
` && U && this._output.add_new_line();
          }
        var wi = this._output.get_code(H);
        return wi;
...
`);
        var v = b.match(/^[\t ]*/)[0], P = {
          text: "",
          type: ""
        }, S = new H(), k = new g(this._options, v), U = new u(b, this._options).tokenize();
        this._tag_stack = new w(k);
        for (var y = null, M = U.next(); M.type !== c.EOF; )
          M.type === c.TAG_OPEN || M.type === c.COMMENT ? (y = this._handle_tag_open(k, M, S, P, U), S = y) : M.type === c.ATTRIBUTE || M.type === c.EQUALS || M.type === c.VALUE || M.type === c.TEXT && !S.tag_complete ? y = this._handle_inside_tag(k, M, S, P) : M.type === c.TAG_CLOSE ? y = this._handle_tag_close(k, M, S) : M.type === c.TEXT ? y = this._handle_text(k, M, S) : M.type === c.CONTROL_FLOW_OPEN ? y = this._handle_control_flow_open(k, M) : M.type === c.CONTROL_FLOW_CLOSE ? y = this._handle_control_flow_close(k, M) : k.add_raw_token(M), P = y, M = U.next();
        ...
        var S = v.has_wrapped_attrs, k = {
          text: f.text,
          type: f.type
        };
        return b.set_space_before_token(f.newlines || f.whitespace_before !== "", !0), v.is_unformatted ? b.add_raw_token(f) : v.tag_start_char === "{" && f.type === c.TEXT ? b.print_preserved_newlines(f) ? (f.newlines = 0, b.add_raw_token(f)) : b.print_token(f) : (f.type === c.ATTRIBUTE ? b.set_space_before_token(!0) : (f.type === c.EQUALS || f.type === c.VALUE && f.previous.type === c.EQUALS) && b.set_space_before_token(!1), f.type === c.ATTRIBUTE && v.tag_start_char === "<" && ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) && (b.traverse_whitespace(f), S = S || f.newlines !== 0), this._is_wrap_attributes_force && v.attr_count >= this._options.wrap_attributes_min_attrs && (P.type !== c.TAG_OPEN || // ie. second attribute and beyond
        this._is_wrap_attributes_force_expand_multiline) && (b.print_newline(!1), S = !0)), b.print_token(f), S = S || b.previous_token_wrapped(), v.has_wrapped_attrs = S), k;
        ...
        if (f.text !== "") {
          ...
          v.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function" ? k = this._js_beautify : v.custom_beautifier_name === "css" && typeof this._css_beautify == "function" ? k = this._css_beautify : v.custom_beautifier_name === "html" && (k = function(Z, se) {
            ...
            return be.beautify();
          }), this._options.indent_scripts === "keep" ? U = 0 : this._options.indent_scripts === "separate" && (U = -b.indent_level);
          var I = b.get_full_indent(U);
...
`;
              ...
              V && (S = S.replace(new RegExp(`
(` + V + ")?", "g"), `
`)), S = I + S.replace(/\n/g, `
` + I);
            }
          y && (S ? S = y + S + `
` + M : S = y + M), b.print_newline(!1), S && (f.text = S, f.whitespace_before = "", f.newlines = 0, b.add_raw_token(f), b.print_newline(!0));
        }
      }, E.prototype._handle_tag_open = function(b, f, v, P, S) {
        ...
        if ((v.is_unformatted || v.is_content_unformatted) && !v.is_empty_element && f.type === c.TAG_OPEN && !k.is_start_tag ? (b.add_raw_token(f), k.start_tag_token = this._tag_stack.try_pop(k.tag_name)) : (b.traverse_whitespace(f), this._set_tag_position(b, f, k, v, P), k.is_inline_element || b.set_wrap_point(), b.print_token(f)), k.is_start_tag && this._is_wrap_attributes_force) {
          var U = 0, y;
          do
            y = S.peek(U), y.type === c.ATTRIBUTE && (k.attr_count += 1), U += 1;
      ...
      E.prototype._get_tag_open_token = function(b) {
      ...
      }, E.prototype._set_tag_position = function(b, f, v, P, S) {
        if (v.is_empty_element || (v.is_end_tag ? v.start_tag_token = this._tag_stack.try_pop(v.tag_name) : (this._do_optional_end_element(v) && (v.is_inline_element || b.print_newline(!1)), this._tag_stack.record_tag(v), (v.tag_name === "script" || v.tag_name === "style") && !(v.is_unformatted || v.is_content_unformatted) && (v.custom_beautifier_name = p(v.tag_check, f)))), L(v.tag_check, this._options.extra_liners) && (b.print_newline(!1), b._output.just_added_blankline() || b.print_newline(!0)), v.is_empty_element) {
          ...
          v.tag_name === "!--" && S.type === c.TAG_CLOSE && P.is_end_tag && v.text.indexOf(`
`) === -1 || (v.is_inline_element || v.is_unformatted || b.print_newline(!1), this._calcluate_parent_multiline(b, v));
        } else if (v.is_end_tag) {
          var U = !1;
          U = v.start_tag_token && v.start_tag_token.multiline_content, U = U || !v.is_inline_element && !(P.is_inline_element || P.is_unformatted) && !(S.type === c.TAG_CLOSE && v.start_tag_token === P) && S.type !== "TK_CONTENT", (v.is_content_unformatted || v.is_unformatted) && (U = !1), U && b.print_newline(!1);
        } else
          v.indent_content = !v.custom_beautifier_name, v.tag_start_char === "<" && (v.tag_name === "html" ? v.indent_content = this._options.indent_inner_html : v.tag_name === "head" ? v.indent_content = this._options.indent_head_inner_html : v.tag_name === "body" && (v.indent_content = this._options.indent_body_inner_html)), !(v.is_inline_element || v.is_unformatted) && (S.type !== "TK_CONTENT" || v.is_content_unformatted) && b.print_newline(!1), this._calcluate_parent_multiline(b, v);
      ...
      var W = ["address", "article", "aside", "blockquote", "details", "div", "dl", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hr", "main", "menu", "nav", "ol", "p", "pre", "section", "table", "ul"], z = ["a", "audio", "del", "ins", "map", "noscript", "video"];
      E.prototype._do_optional_end_element = function(b) {
        ...
        if (!(b.is_empty_element || !b.is_start_tag || !b.parent)) {
          if (b.tag_name === "body")
            ...
            (!v || z.indexOf(v.tag_name) === -1) && (f = f || this._tag_stack.try_pop("p"));
...
function jd(e, t, n) {
  ...
  if (t) {
    ...
    for (; c > 0 && ol(i, c - 1); )
      c--;
    c === 0 || al(i, c - 1) ? u = c : c < u && (u = c + 1);
    let d = e.offsetAt(t.end), m = d;
    for (; m < i.length && ol(i, m); )
      m++;
    (m === i.length || al(i, m)) && (d = m), t = ie.create(e.positionAt(u), e.positionAt(d));
...
`,
  ...
  let o = Gd($d(i), l);
  if (s > 0) {
    const u = n.insertSpaces ? rl(" ", a * s) : rl("	", s);
    o = o.split(`
`).join(`
...
(() => {
  ...
  (() => {
    ...
    class m {
      ...
      constructor(k, U, y, M, I, F = !1) {
        typeof k == "object" ? (this.scheme = k.scheme || u, this.authority = k.authority || u, this.path = k.path || u, this.query = k.query || u, this.fragment = k.fragment || u) : (this.scheme = /* @__PURE__ */ function(C, q) {
          return C || q ? C : "file";
        }(k, F), this.authority = U || u, this.path = function(C, q) {
          switch (C) {
            case "https":
            case "http":
            case "file":
          ...
          return q;
        }(this.scheme, y || u), this.query = M || u, this.fragment = I || u, o(this, F));
      }
      get fsPath() {
        return w(this);
      }
      with(k) {
        if (!k)
          return this;
        let { scheme: U, authority: y, path: M, query: I, fragment: F } = k;
        return U === void 0 ? U = this.scheme : U === null && (U = u), y === void 0 ? y = this.authority : y === null && (y = u), M === void 0 ? M = this.path : M === null && (M = u), I === void 0 ? I = this.query : I === null && (I = u), F === void 0 ? F = this.fragment : F === null && (F = u), U === this.scheme && y === this.authority && M === this.path && I === this.query && F === this.fragment ? this : new _(U, y, M, I, F);
      }
      static parse(k, U = !1) {
        const y = d.exec(k);
        return y ? new _(y[2] || u, z(y[4] || u), z(y[5] || u), z(y[7] || u), z(y[9] || u), U) : new _(u, u, u, u, u);
      }
      static file(k) {
        let U = u;
        if (r && (k = k.replace(/\\/g, c)), k[0] === c && k[1] === c) {
          const y = k.indexOf(c, 2);
          y === -1 ? (U = k.substring(2), k = c) : (U = k.substring(2, y), k = k.substring(y) || c);
        }
        return new _("file", U, k, u, u);
      }
      static from(k) {
        const U = new _(k.scheme, k.authority, k.path, k.query, k.fragment);
        return o(U, !0), U;
      }
      toString(k = !1) {
        return E(this, k);
      ...
      static revive(k) {
        if (k) {
          ...
          {
            const U = new _(k);
            return U._formatted = k.external, U._fsPath = k._sep === g ? k.fsPath : null, U;
          }
        }
        return k;
      }
    ...
    class _ extends m {
      ...
      toString(k = !1) {
        return k ? E(this, !0) : (this._formatted || (this._formatted = E(this, !1)), this._formatted);
      }
      toJSON() {
        const k = { $mid: 1 };
        return this._fsPath && (k.fsPath = this._fsPath, k._sep = g), this._formatted && (k.external = this._formatted), this.path && (k.path = this.path), this.scheme && (k.scheme = this.scheme), this.authority && (k.authority = this.authority), this.query && (k.query = this.query), this.fragment && (k.fragment = this.fragment), k;
      }
    }
    ...
    function L(S, k, U) {
      ...
      for (let I = 0; I < S.length; I++) {
        ...
        if (F >= 97 && F <= 122 || F >= 65 && F <= 90 || F >= 48 && F <= 57 || F === 45 || F === 46 || F === 95 || F === 126 || k && F === 47 || U && F === 91 || U && F === 93 || U && F === 58)
          M !== -1 && (y += encodeURIComponent(S.substring(M, I)), M = -1), y !== void 0 && (y += S.charAt(I));
        else {
          y === void 0 && (y = S.substr(0, I));
          const C = p[F];
          C !== void 0 ? (M !== -1 && (y += encodeURIComponent(S.substring(M, I)), M = -1), y += C) : M === -1 && (M = I);
        }
      }
      return M !== -1 && (y += encodeURIComponent(S.substring(M))), y !== void 0 ? y : S;
    }
    function A(S) {
      let k;
      for (let U = 0; U < S.length; U++) {
        const y = S.charCodeAt(U);
        y === 35 || y === 63 ? (k === void 0 && (k = S.substr(0, U)), k += p[y]) : k !== void 0 && (k += S[U]);
      }
      return k !== void 0 ? k : S;
    }
    function w(S, k) {
      let U;
      return U = S.authority && S.path.length > 1 && S.scheme === "file" ? `//${S.authority}${S.path}` : S.path.charCodeAt(0) === 47 && (S.path.charCodeAt(1) >= 65 && S.path.charCodeAt(1) <= 90 || S.path.charCodeAt(1) >= 97 && S.path.charCodeAt(1) <= 122) && S.path.charCodeAt(2) === 58 ? S.path[1].toLowerCase() + S.path.substr(2) : S.path, r && (U = U.replace(/\//g, "\\")), U;
    }
    function E(S, k) {
      const U = k ? A : L;
      let y = "", { scheme: M, authority: I, path: F, query: C, fragment: q } = S;
      if (M && (y += M, y += ":"), (I || M === "file") && (y += c, y += c), I) {
        let V = I.indexOf("@");
        if (V !== -1) {
          const Z = I.substr(0, V);
          I = I.substr(V + 1), V = Z.lastIndexOf(":"), V === -1 ? y += U(Z, !1, !1) : (y += U(Z.substr(0, V), !1, !1), y += ":", y += U(Z.substr(V + 1), !1, !0)), y += "@";
        }
        I = I.toLowerCase(), V = I.lastIndexOf(":"), V === -1 ? y += U(I, !1, !0) : (y += U(I.substr(0, V), !1, !0), y += I.substr(V));
      }
      if (F) {
      ...
      return C && (y += "?", y += U(C, !1, !1)), q && (y += "#", y += k ? q : L(q, !1, !1)), y;
    }
    function H(S) {
      try {
    ...
    function z(S) {
      return S.match(W) ? S.replace(W, (k) => H(k)) : S;
    }
    var b = n(470);
    const f = b.posix || b, v = "/";
    var P;
    (function(S) {
      S.joinPath = function(k, ...U) {
        return k.with({ path: f.join(k.path, ...U) });
      }, S.resolvePath = function(k, ...U) {
        let y = k.path, M = !1;
        y[0] !== v && (y = v + y, M = !0);
        let I = f.resolve(y, ...U);
        return M && I[0] === v && !k.authority && (I = I.substring(1)), k.with({ path: I });
      }, S.dirname = function(k) {
        if (k.path.length === 0 || k.path === v)
          return k;
        let U = f.dirname(k.path);
        return U.length === 1 && U.charCodeAt(0) === 46 && (U = ""), k.with({ path: U });
      }, S.basename = function(k) {
        return f.basename(k.path);
      }, S.extname = function(k) {
        return f.extname(k.path);
      };
    })(P || (P = {}));
  })(), jl = i;
})();
var { URI: Qd, Utils: vm } = jl;
function vr(e) {
...
function Kd(e, t, n, i, r, s) {
  const a = vr(n);
  if (!Jd(a, e.languageId))
    return;
  a.length < n.length && (i++, r--);
  const l = Zd(e.uri, a, t, s);
  if (!l)
    return;
  const o = tm(l, e);
  return {
...
function tm(e, t) {
  try {
    ...
    return n.scheme === "file" && n.query && (n = n.with({ query: null }), e = n.toString(
      /* skipEncodig*/
      !0
    )), n.scheme === "file" && n.fragment && !(e.startsWith(t.uri) && e.charCodeAt(t.uri.length) === em) ? n.with({ fragment: null }).toString(
      /* skipEncodig*/
      !0
    ) : e;
  } catch {
      ...
      switch (r) {
        ...
        case O.AttributeValue:
          if (a && s && this.dataManager.isPathAttribute(a, s)) {
            ...
            if (!l) {
              const d = Kd(e, t, c, i.getTokenOffset(), i.getTokenEnd(), o);
              d && n.push(d);
            }
            l && typeof o > "u" && (o = vr(c), o && t && (o = t.resolveReference(o, e.uri))), l = !1, s = void 0;
          } else if (s === "id") {
            const c = vr(i.getTokenText());
...
function im(e, t, n) {
  ...
  if (!r.tag)
    return [];
  const s = [], a = cl(O.StartTag, e, r.start), l = typeof r.endTagStart == "number" && cl(O.EndTag, e, r.endTagStart);
  return (a && ul(a, t) || l && ul(l, t)) && (a && s.push({ kind: li.Read, range: a }), l && s.push({ kind: li.Read, range: l })), s;
}
function ll(e, t) {
  return e.line < t.line || e.line === t.line && e.character <= t.character;
}
function ul(e, t) {
  return ll(e.start, t) && ll(t, e.end);
}
function cl(e, t, n) {
  const i = He(t.getText(), n);
  let r = i.scan();
  for (; r !== O.EOS && r !== e; )
    r = i.scan();
  return r !== O.EOS ? { start: t.positionAt(i.getTokenOffset()), end: t.positionAt(i.getTokenEnd()) } : null;
}
function rm(e, t) {
  const n = [], i = $l(e, t);
  for (const s of i)
  ...
  return n;
  function r(s, a) {
    const l = dr.create(s.name, s.kind, s.range, e.uri, a?.name);
...
function Xl(e, t, n) {
  const i = sm(t), r = ie.create(e.positionAt(t.start), e.positionAt(t.end)), s = mr.create(i, void 0, hr.Field, r, r);
  n.push(s), t.children.forEach((a) => {
    s.children ?? (s.children = []), Xl(e, a, s.children);
  });
}
function sm(e) {
  let t = e.tag;
...
var um = class {
  ...
  getFoldingRanges(e, t) {
    const n = this.dataManager.getVoidElements(e.languageId), i = He(e.getText());
    let r = i.scan();
    const s = [], a = [];
    let l = null, o = -1;
    function u(d) {
          ...
          if (g)
            if (g[1])
              ...
              if (_ >= 0) {
                ...
                a.length = _;
                const L = d;
                d = p.startLine, L > d && o !== d && u({ startLine: d, endLine: L, kind: si.Region });
              }
            }
          else {
            const _ = e.positionAt(i.getTokenOffset() + i.getTokenLength()).line;
            d < _ && u({ startLine: d, endLine: _, kind: si.Comment });
          }
          break;
        }
      }
  ...
  getSelectionRange(e, t, n) {
    ...
    for (let a = i.length - 1; a >= 0; a--) {
      const l = i[a];
      (!r || l[0] !== r[0] || l[1] !== r[1]) && (s = ci.create(ie.create(t.positionAt(i[a][0]), t.positionAt(i[a][1])), s)), r = l;
    }
    return s || (s = ci.create(ie.create(e, e))), s;
  }
  ...
  getAttributeLevelRanges(e, t, n) {
    const i = ie.create(e.positionAt(t.start), e.positionAt(t.end)), r = e.getText(i), s = n - t.start, a = He(r);
    let l = a.scan();
    const o = t.start, u = [];
    let c = !1, d = -1;
    for (; l !== O.EOS; ) {
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`
  ...
  setDataProviders(e, t) {
    this.dataProviders = [], e && this.dataProviders.push(new Vl("html5", hm)), this.dataProviders.push(...t);
  }
  getDataProviders() {
    return this.dataProviders;
  }
  isVoidElement(e, t) {
    return !!e && vd(t, e.toLowerCase(), (n, i) => n.localeCompare(i)) >= 0;
  }
  getVoidElements(e) {
...
function pm(e = fm) {
  const t = new dm(e), n = new Wd(e, t), i = new Bd(e, t), r = new Td(t), s = new cm(r), a = new um(t), l = new nm(t);
  return {
    ...
    format: jd,
    findDocumentHighlights: im,
    findDocumentLinks: l.findDocumentLinks.bind(l),
    findDocumentSymbols: rm,
    findDocumentSymbols2: $l,
    ...
    doRename: am,
    findMatchingTagPosition: lm,
    findOnTypeRenameRanges: hl,
    findLinkedEditingRanges: hl
  };
}
function gm(e, t) {
  return new Vl(e, t);
  ...
  constructor(e, t) {
    ...
    if (n?.dataProviders)
      for (const s in n.dataProviders)
        r.push(gm(s, n.dataProviders[s]));
    this._languageService = pm({
