...
const Hn = "Canceled";
function ka(e) {
  return e instanceof Fa ? !0 : e instanceof Error && e.name === Hn && e.message === Hn;
}
...
class Ga {
  constructor() {
    this[Ti] = "LinkedMap", this._map = /* @__PURE__ */ new Map(), this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0;
  }
  clear() {
...
(function(e) {
  ...
  e.length = R;
  function* v(E, A, D = E.length) {
    for (A < -E.length && (A = 0), A < 0 && (A += E.length), D < 0 ? D += E.length : D > E.length && (D = E.length); A < D; A++)
      yield E[A];
  }
  e.slice = v;
  function F(E, A = Number.POSITIVE_INFINITY) {
    const D = [];
    if (A === 0)
      return [D, E];
...
(function(e) {
  ...
  function n(S) {
    return (M, y = null, I) => {
      ...
      return Y = S((K) => {
        if (!H)
          return Y ? Y.dispose() : H = !0, M.call(y, K);
      }, null, I), H && Y.dispose(), Y;
    };
  }
  e.once = n;
  function i(S, M) {
  ...
  e.onceIf = i;
  function r(S, M, y) {
    return h((I, H = null, Y) => S((K) => I.call(H, M(K)), null, Y), y);
  }
  e.map = r;
  function s(S, M, y) {
    return h((I, H = null, Y) => S((K) => {
      M(K), I.call(H, K);
    }, null, Y), y);
  }
  e.forEach = s;
  function a(S, M, y) {
    return h((I, H = null, Y) => S((K) => M(K) && I.call(H, K), null, Y), y);
  }
  e.filter = a;
  function u(S) {
    return S;
  ...
  function o(...S) {
    return (M, y = null, I) => {
      const H = Za(...S.map((Y) => Y((K) => M.call(y, K))));
      return f(H, I);
    };
  }
  e.any = o;
  ...
  function h(S, M) {
    ...
    return M?.add(H), H.event;
  }
  function f(S, M) {
    return M instanceof Array ? M.push(S) : M && M.add(S), S;
  }
  function _(S, M, y = 100, I = !1, H = !1, Y, K) {
    let ue, _e, st, rn = 0, Bt;
    const va = {
      leakWarningThreshold: Y,
      onWillAddFirstListener() {
        ue = S((Ta) => {
          rn++, _e = M(_e, Ta), I && !st && (sn.fire(_e), _e = void 0), Bt = () => {
            const Ma = _e;
            _e = void 0, st = void 0, (!I || rn > 1) && sn.fire(Ma), rn = 0;
          }, typeof y == "number" ? (st && clearTimeout(st), st = setTimeout(Bt, y)) : st === void 0 && (st = null, queueMicrotask(Bt));
        });
      },
  ...
  e.debounce = _;
  function L(S, M = 0, y) {
    return e.debounce(S, (I, H) => I ? (I.push(H), I) : [H], M, void 0, !0, void 0, y);
  }
  e.accumulate = L;
  function w(S, M = (I, H) => I === H, y) {
    let I = !0, H;
    return a(S, (Y) => {
      const K = I || !M(Y, H);
      return I = !1, H = Y, K;
  ...
  e.split = b;
  function x(S, M = !1, y = [], I) {
    let H = y.slice(), Y = S((_e) => {
  ...
  class v {
    ...
    filter(M) {
      return this.steps.push((y) => M(y) ? y : R), this;
    }
    reduce(M, y) {
      let I = y;
      return this.steps.push((H) => (I = M(I, H), I)), this;
    }
    latch(M = (y, I) => y === I) {
      let y = !0, I;
      return this.steps.push((H) => {
        const Y = y || !M(H, I);
        return y = !1, I = H, Y ? H : R;
      }), this;
    }
    evaluate(M) {
  ...
  function F(S, M, y = (I) => I) {
    const I = (...ue) => K.fire(y(...ue)), H = () => S.on(M, I), Y = () => S.removeListener(M, I), K = new Te(
      { onWillAddFirstListener: H, onDidRemoveLastListener: Y }
    );
    return K.event;
  }
  e.fromNodeEventEmitter = F;
  function B(S, M, y = (I) => I) {
    const I = (...ue) => K.fire(y(...ue)), H = () => S.addEventListener(M, I), Y = () => S.removeEventListener(M, I), K = new Te(
      { onWillAddFirstListener: H, onDidRemoveLastListener: Y }
    );
    return K.event;
  }
  ...
  function X(S, M) {
    let y;
    const I = new Promise((H, Y) => {
      const K = n(S)(H, null, M);
      y = () => K.dispose();
    });
    return I.cancel = y, I;
  }
  ...
  class W {
    constructor(M, y) {
      ...
      this.emitter = new Te(I), y && y.add(this.emitter);
    }
    beginUpdate(M) {
      this._counter++;
    }
  ...
  function G(S) {
    return (M, y, I) => {
      ...
      const K = {
        ...
        endUpdate() {
          H--, H === 0 && (S.reportChanges(), Y && (Y = !1, M.call(y)));
        },
      ...
      S.addObserver(K), S.reportChanges();
      const ue = {
        dispose() {
          S.removeObserver(K);
        }
      };
      return I instanceof Zt ? I.add(ue) : Array.isArray(I) && I.push(ue), ue;
    };
  }
...
const Et = class Et {
  ...
  start(t) {
    this._stopWatch = new In(), this.listenerCount = t;
  }
  stop() {
    if (this._stopWatch) {
...
let zn = Et, el = -1;
const kn = class kn {
  constructor(t, n, i = (kn._idPool++).toString(16).padStart(3, "0")) {
...
class Te {
  ...
  get event() {
    return this._event ??= (t, n, i) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        return (this._options?.onListenerError || Wt)(c), St.None;
      }
      if (this._disposed)
        return St.None;
      n && (t = t.bind(n));
      const r = new Pn(t);
      let s;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (r.stack = _i.create(), s = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof Pn ? (this._deliveryQueue ??= new sl(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
      const a = Jt(() => {
  ...
  fire(t) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof Pn)
...
function q(e, t, ...n) {
  return Mi(typeof e == "number" ? ul(e, t) : t, n);
}
function ul(e, t) {
  const n = al()?.[e];
  if (typeof n != "string") {
...
const wt = "en";
let Kt = !1, Ct = !1, cn = !1, ea = !1, bi = !1, ta = !1, an, hn = wt, Ui = wt, ol, ze;
const Qe = globalThis;
let Re;
...
const cl = typeof Re?.versions?.electron == "string", hl = cl && Re?.type === "renderer";
if (typeof Re == "object") {
  Kt = Re.platform === "win32", Ct = Re.platform === "darwin", cn = Re.platform === "linux", cn && Re.env.SNAP && Re.env.SNAP_REVISION, Re.env.CI || Re.env.BUILD_ARTIFACTSTAGINGDIRECTORY || Re.env.GITHUB_WORKSPACE, an = wt, hn = wt;
  const e = Re.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      an = t.userLocale, Ui = t.osLocale, hn = t.resolvedLanguage || wt, ol = t.languagePack?.translationsConfigFile;
    } catch {
    }
  ea = !0;
} else typeof navigator == "object" && !hl ? (ze = navigator.userAgent, Kt = ze.indexOf("Windows") >= 0, Ct = ze.indexOf("Macintosh") >= 0, ta = (ze.indexOf("Macintosh") >= 0 || ze.indexOf("iPad") >= 0 || ze.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, cn = ze.indexOf("Linux") >= 0, ze?.indexOf("Mobi") >= 0, bi = !0, hn = Cs() || wt, an = navigator.language.toLowerCase(), Ui = an) : console.error("Unable to resolve platform.");
var Mt;
(function(e) {
...
const It = Kt, fl = Ct, gl = ea, ml = bi, _l = bi && typeof Qe.importScripts == "function", bl = _l ? Qe.origin : void 0, He = ze, Ze = hn;
var Di;
(function(e) {
  function t() {
    return Ze;
...
const dl = typeof Qe.postMessage == "function" && !Qe.importScripts;
(() => {
  if (dl) {
    const e = [];
...
const wl = !!(He && He.indexOf("Chrome") >= 0);
He && He.indexOf("Firefox") >= 0;
!wl && He && He.indexOf("Safari") >= 0;
He && He.indexOf("Edg/") >= 0;
...
class fn {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? na : (this._emitter || (this._emitter = new Te()), this._emitter.event);
  }
  dispose() {
...
class pl {
  ...
  cancel() {
    this._token ? this._token instanceof fn && this._token.cancel() : this._token = pn.Cancelled;
  }
  dispose(t = !1) {
    t && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof fn && this._token.dispose() : this._token = pn.None;
  }
}
function Ll(e) {
  return e;
...
function Tl(e, t, n = 0, i = e.length, r = 0, s = t.length) {
  for (; n < i && r < s; n++, r++) {
...
function ra(e, t, n = 0, i = e.length, r = 0, s = t.length) {
  for (; n < i && r < s; n++, r++) {
    ...
    if (o === c)
      continue;
    if (o >= 128 || c >= 128)
      return Tl(e.toLowerCase(), t.toLowerCase(), n, i, r, s);
    Si(o) && (o -= 32), Si(c) && (c -= 32);
    const h = o - c;
    if (h !== 0)
      return h;
...
String.fromCharCode(p.UTF8_BOM);
var Ii;
(function(e) {
...
ye.ambiguousCharacterData = new ki(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,1523,96,8242,96,1370,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,118002,50,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,118003,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,118004,52,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,118005,53,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,118006,54,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,118007,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,118008,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,118009,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,117974,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,117975,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71913,67,71922,67,65315,67,8557,67,8450,67,8493,67,117976,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,117977,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,117978,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,117979,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,117980,71,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,117981,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,117983,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,117984,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,118001,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,117982,108,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,117985,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,117986,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,117987,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,118000,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,117988,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,117989,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,117990,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,117991,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,117992,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,117993,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,117994,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,117995,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71910,87,71919,87,117996,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,117997,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,117998,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,71909,90,66293,90,65338,90,8484,90,8488,90,117999,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65283,35,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"cs":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"es":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"fr":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"it":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ja":[8211,45,8218,44,65281,33,8216,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65292,44,65297,49,65307,59],"ko":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pt-BR":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ru":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"zh-hans":[160,32,65374,126,8218,44,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65297,49],"zh-hant":[8211,45,65374,126,8218,44,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89]}')), ye.cache = new Nl({ getCacheKey: JSON.stringify }, (t) => {
  ...
  return new ye(c);
}), ye._locales = new ki(() => Object.keys(ye.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
let en = ye;
const lt = class lt {
  static getRawData() {
...
lt._data = void 0;
let zt = lt;
const yn = "default", Pl = "$initialize";
var Ee;
(function(e) {
...
class ql {
  ...
  sendMessage(t, n, i) {
    ...
    return new Promise((s, a) => {
      this._pendingReplies[r] = {
        resolve: s,
        reject: a
      }, this._send(new yl(this._workerId, r, t, n, i));
    });
  }
  listen(t, n, i) {
    let r = null;
  ...
  createProxyToRemoteChannel(t, n) {
    const i = {
      get: (r, s) => (typeof s == "string" && !r[s] && (la(s) ? r[s] = (a) => this.listen(t, s, a) : aa(s) ? r[s] = this.listen(t, s, void 0) : s.charCodeAt(0) === p.DollarSign && (r[s] = async (...a) => (await n?.(), this.sendMessage(t, s, a)))), r[s])
    };
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.channel, t.method, t.args).then((r) => {
      ...
      r.detail instanceof Error && (r.detail = qn(r.detail)), this._send(new Pi(this._workerId, n, void 0, qn(r)));
    });
  }
...
class Hl {
  ...
  _handleMessage(t, n, i) {
    ...
    const r = t === yn ? this.requestHandler : this._localChannels.get(t);
    if (!r)
...
class nt {
  ...
  ComputeDiffRecursive(t, n, i, r, s) {
    ...
    if (t > n || i > r) {
      let f;
      return i <= r ? (gt.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), f = [
        new Ce(t, 0, i, r - i + 1)
      ]) : t <= n ? (gt.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"), f = [
        new Ce(t, n - t + 1, i, 0)
      ]) : (gt.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), gt.Assert(i === r + 1, "modifiedStart should only be one more than modifiedEnd"), f = []), f;
    }
  ...
  WALKTRACE(t, n, i, r, s, a, u, o, c, h, f, _, L, w, b, x, T, R) {
    let v = null, F = null, B = new Vi(), X = n, E = i, A = L[0] - x[0] - r, D = De.MIN_SAFE_SMALL_INTEGER, W = this.m_forwardHistory.length - 1;
    do {
      const z = A + t;
      z === X || z < E && c[z - 1] < c[z + 1] ? (f = c[z + 1], w = f - A - r, f < D && B.MarkNextChange(), D = f, B.AddModifiedElement(f + 1, w), A = z + 1 - t) : (f = c[z - 1] + 1, w = f - A - r, f < D && B.MarkNextChange(), D = f - 1, B.AddOriginalElement(f, w + 1), A = z - 1 - t), W >= 0 && (c = this.m_forwardHistory[W], t = c[0], X = 1, E = c.length - 1);
    } while (--W >= -1);
    if (v = B.getReverseChanges(), R[0]) {
      let z = L[0] + 1, G = x[0] + 1;
      if (v !== null && v.length > 0) {
        const S = v[v.length - 1];
        z = Math.max(z, S.getOriginalEnd()), G = Math.max(G, S.getModifiedEnd());
      }
      F = [
        new Ce(
          z,
      ...
      B = new Vi(), X = a, E = u, A = L[0] - x[0] - o, D = De.MAX_SAFE_SMALL_INTEGER, W = T ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const z = A + s;
        z === X || z < E && h[z - 1] >= h[z + 1] ? (f = h[z + 1] - 1, w = f - A - o, f > D && B.MarkNextChange(), D = f + 1, B.AddOriginalElement(f + 1, w + 1), A = z + 1 - s) : (f = h[z - 1], w = f - A - o, f > D && B.MarkNextChange(), D = f, B.AddModifiedElement(f + 1, w + 1), A = z - 1 - s), W >= 0 && (h = this.m_reverseHistory[W], s = h[0], X = 1, E = h.length - 1);
      } while (--W >= -1);
      F = B.getChanges();
    }
  ...
  ComputeRecursionPoint(t, n, i, r, s, a, u) {
    let o = 0, c = 0, h = 0, f = 0, _ = 0, L = 0;
    t--, i--, s[0] = 0, a[0] = 0, this.m_forwardHistory = [], this.m_reverseHistory = [];
    const w = n - t + (r - i), b = w + 1, x = new Int32Array(b), T = new Int32Array(b), R = r - i, v = n - t, F = t - i, B = n - r, E = (v - R) % 2 === 0;
    x[R] = t, T[v] = n, u[0] = !1;
    for (let A = 1; A <= w / 2 + 1; A++) {
      let D = 0, W = 0;
      h = this.ClipDiagonalBound(R - A, A, R, b), f = this.ClipDiagonalBound(R + A, A, R, b);
      for (let G = h; G <= f; G += 2) {
        G === h || G < f && x[G - 1] < x[G + 1] ? o = x[G + 1] : o = x[G - 1] + 1, c = o - (G - R) - F;
        const S = o;
        for (; o < n && c < r && this.ElementsAreEqual(o + 1, c + 1); )
          o++, c++;
        if (x[G] = o, o + c > D + W && (D = o, W = c), !E && Math.abs(G - v) <= A - 1 && o >= T[G])
          return s[0] = o, a[0] = c, S <= T[G] && je.MaxDifferencesHistory > 0 && A <= je.MaxDifferencesHistory + 1 ? this.WALKTRACE(R, h, f, F, v, _, L, B, x, T, o, n, s, c, r, a, E, u) : null;
      }
      const z = (D - t + (W - i) - A) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(D, z))
        return u[0] = !0, s[0] = D, a[0] = W, z > 0 && je.MaxDifferencesHistory > 0 && A <= je.MaxDifferencesHistory + 1 ? this.WALKTRACE(R, h, f, F, v, _, L, B, x, T, o, n, s, c, r, a, E, u) : (t++, i++, [
          new Ce(
            t,
            n - t + 1,
            i,
      ...
      _ = this.ClipDiagonalBound(v - A, A, v, b), L = this.ClipDiagonalBound(v + A, A, v, b);
      for (let G = _; G <= L; G += 2) {
        G === _ || G < L && T[G - 1] >= T[G + 1] ? o = T[G + 1] - 1 : o = T[G - 1], c = o - (G - v) - B;
        const S = o;
        for (; o > t && c > i && this.ElementsAreEqual(o, c); )
          o--, c--;
        if (T[G] = o, E && Math.abs(G - R) <= A && o <= x[G])
          return s[0] = o, a[0] = c, S >= x[G] && je.MaxDifferencesHistory > 0 && A <= je.MaxDifferencesHistory + 1 ? this.WALKTRACE(R, h, f, F, v, _, L, B, x, T, o, n, s, c, r, a, E, u) : null;
      }
      if (A <= je.MaxDifferencesHistory) {
        let G = new Int32Array(f - h + 2);
        G[0] = R - h + 1, mt.Copy2(x, h, G, 1, f - h + 1), this.m_forwardHistory.push(G), G = new Int32Array(L - _ + 2), G[0] = v - _ + 1, mt.Copy2(T, _, G, 1, L - _ + 1), this.m_reverseHistory.push(G);
      }
    }
    return this.WALKTRACE(R, h, f, F, v, _, L, B, x, T, o, n, s, c, r, a, E, u);
  }
  PrettifyChanges(t) {
    for (let n = 0; n < t.length; n++) {
    ...
    for (let n = t.length - 1; n >= 0; n--) {
      ...
      for (let f = 1; ; f++) {
        const _ = i.originalStart - f, L = i.modifiedStart - f;
        if (_ < r || L < s || a && !this.OriginalElementsAreEqual(_, _ + i.originalLength) || u && !this.ModifiedElementsAreEqual(L, L + i.modifiedLength))
          break;
        const b = (_ === r && L === s ? 5 : 0) + this._boundaryScore(_, i.originalLength, L, i.modifiedLength);
        b > c && (c = b, o = f);
      }
    ...
    if (this._hasStrings)
      for (let n = 1, i = t.length; n < i; n++) {
        ...
        if (a < 5 && c < 20 && _ < 20) {
          const L = this._findBetterContiguousSequence(u, c, h, _, a);
          if (L) {
            const [w, b] = L;
            (w !== r.originalStart + r.originalLength || b !== r.modifiedStart + r.modifiedLength) && (r.originalLength = w - r.originalStart, r.modifiedLength = b - r.modifiedStart, s.originalStart = w + a, s.modifiedStart = b + a, s.originalLength = o - s.originalStart, s.modifiedLength = f - s.modifiedStart);
          }
        }
      }
    return t;
  ...
  _findBetterContiguousSequence(t, n, i, r, s) {
    ...
    for (let f = t; f < a; f++)
      for (let _ = i; _ < u; _++) {
        const L = this._contiguousSequenceScore(f, _, s);
        L > 0 && L > o && (o = L, c = f, h = _);
      }
    return o > 0 ? [c, h] : null;
  }
  ...
  ConcatenateChanges(t, n) {
    ...
    if (this.ChangesOverlap(t[t.length - 1], n[0], i)) {
      ...
      return mt.Copy(t, 0, r, 0, t.length - 1), r[t.length - 1] = i[0], mt.Copy(n, 1, r, t.length, n.length - 1), r;
    } else {
      const r = new Array(t.length + n.length);
      return mt.Copy(t, 0, r, 0, t.length), mt.Copy(n, 0, r, t.length, n.length), r;
    }
  }
...
class di {
  constructor(t) {
    const n = Fi(t);
    this._defaultValue = n, this._asciiMap = di._createAsciiMap(n), this._map = /* @__PURE__ */ new Map();
  }
...
function Yl() {
  return Bn === null && (Bn = new Xl([
    ...
    [V.HTT, p.p, V.HTTP],
    [V.HTT, p.P, V.HTTP],
    [V.HTTP, p.s, V.BeforeColon],
    [V.HTTP, p.S, V.BeforeColon],
    [V.HTTP, p.Colon, V.AfterColon],
    [V.F, p.i, V.FI],
    [V.F, p.I, V.FI],
    [V.FI, p.l, V.FIL],
    [V.FI, p.L, V.FIL],
    [V.FIL, p.e, V.BeforeColon],
    [V.FIL, p.E, V.BeforeColon],
    [V.BeforeColon, p.Colon, V.AfterColon],
    [V.AfterColon, p.Slash, V.AlmostThere],
    [V.AlmostThere, p.Slash, V.End]
  ])), Bn;
}
var ne;
(function(e) {
...
class xn {
  static _createLink(t, n, i, r, s) {
    ...
    if (r > 0) {
      ...
      (u === p.OpenParen && o === p.CloseParen || u === p.OpenSquareBracket && o === p.CloseSquareBracket || u === p.OpenCurlyBrace && o === p.CloseCurlyBrace) && a--;
    }
    return {
      range: {
        startLineNumber: i,
  ...
  static computeLinks(t, n = Yl()) {
    ...
    for (let s = 1, a = t.getLineCount(); s <= a; s++) {
      ...
      let c = 0, h = 0, f = 0, _ = V.Start, L = !1, w = !1, b = !1, x = !1;
      for (; c < o; ) {
        let T = !1;
        ...
        if (_ === V.Accept) {
          ...
          switch (R) {
            ...
            case p.CloseParen:
              ...
              break;
            case p.OpenSquareBracket:
              b = !0, w = !0, v = ne.None;
              break;
            case p.CloseSquareBracket:
              b = !1, v = w ? ne.None : ne.ForceTermination;
              break;
            case p.OpenCurlyBrace:
              x = !0, v = ne.None;
              break;
            case p.CloseCurlyBrace:
              v = x ? ne.None : ne.ForceTermination;
              break;
            case p.SingleQuote:
            case p.DoubleQuote:
            case p.BackTick:
              f === R ? v = ne.ForceTermination : f === p.SingleQuote || f === p.DoubleQuote || f === p.BackTick ? v = ne.None : v = ne.ForceTermination;
              break;
            case p.Asterisk:
              v = f === p.Asterisk ? ne.ForceTermination : ne.None;
              break;
            case p.Space:
          ...
          v === ne.ForceTermination && (r.push(xn._createLink(i, u, s, h, c)), T = !0);
        } else if (_ === V.End) {
          let v;
          R === p.OpenSquareBracket ? (w = !0, v = ne.None) : v = i.get(R), v === ne.ForceTermination ? T = !0 : _ = V.Accept;
        } else
          _ = n.nextState(_, R), _ === V.Invalid && (T = !0);
        T && (_ = V.Start, L = !1, w = !1, x = !1, h = c + 1, f = R), c++;
      }
      _ === V.Accept && r.push(xn._createLink(i, u, s, h, o));
    }
    return r;
  }
}
...
const gn = new wi(), Zn = new wi(), Kn = new wi(), Zl = new Array(230), Kl = /* @__PURE__ */ Object.create(null), Cl = /* @__PURE__ */ Object.create(null), Cn = [];
for (let e = 0; e <= m.MAX_VALUE; e++)
  g.DependsOnKbLayout;
for (let e = 0; e <= g.MAX_VALUE; e++)
  Cn[e] = m.DependsOnKbLayout;
(function() {
  const e = "", t = [
  ...
  for (const r of t) {
    const [s, a, u, o, c, h, f, _, L] = r;
    if (i[a] || (i[a] = !0, Kl[u] = a, Cl[u.toLowerCase()] = a, s && o !== g.Unknown && o !== g.Enter && o !== g.Ctrl && o !== g.Shift && o !== g.Alt && o !== g.Meta && (Cn[o] = a)), !n[o]) {
      if (n[o] = !0, !c)
        throw new Error(
          `String representation missing for key code ${o} around scan code ${u}`
        );
      gn.define(o, c), Zn.define(o, _ || c), Kn.define(o, L || _ || c);
    }
    h && (Zl[h] = o);
  }
  Cn[g.Enter] = m.Enter;
...
(function(e) {
  function t(u) {
    return gn.keyCodeToStr(u);
  }
  e.toString = t;
  function n(u) {
    return gn.strToKeyCode(u);
  }
  e.fromString = n;
  function i(u) {
...
if (typeof On < "u" && typeof On.process < "u") {
  ...
  get platform() {
    return It ? "win32" : fl ? "darwin" : "linux";
  },
  get arch() {
  },
  get env() {
...
ct.arch;
const iu = 65, ru = 97, su = 90, au = 122, ht = 46, oe = 47, Ne = 92, We = 58, lu = 63;
...
const he = {
    ...
    for (let r = e.length - 1; r >= -1; r--) {
      ...
      if (a === 1)
        ...
        if (c = !0, j(s.charCodeAt(1))) {
          let f = 2, _ = f;
          for (; f < a && !j(s.charCodeAt(f)); )
            f++;
          if (f < a && f !== _) {
            const L = s.slice(_, f);
            for (_ = f; f < a && j(s.charCodeAt(f)); )
              f++;
            if (f < a && f !== _) {
              for (_ = f; f < a && !j(s.charCodeAt(f)); )
                f++;
              (f === a || f !== _) && (o = `\\\\${L}\\${s.slice(_, f)}`, u = f);
            }
          }
        } else
          u = 1;
      else Ge(h) && s.charCodeAt(1) === We && (o = s.slice(0, 2), u = 2, a > 2 && j(s.charCodeAt(2)) && (c = !0, u = 3));
      if (o.length > 0)
        if (t.length > 0) {
  ...
  relative(e, t) {
    ...
    if (n.length !== e.length || i.length !== t.length) {
      const w = n.split("\\"), b = i.split("\\");
      w[w.length - 1] === "" && w.pop(), b[b.length - 1] === "" && b.pop();
      const x = w.length, T = b.length, R = x < T ? x : T;
      let v;
      for (v = 0; v < R && w[v].toLowerCase() === b[v].toLowerCase(); v++)
        ;
      return v === 0 ? i : v === R ? T > R ? b.slice(v).join("\\") : x > R ? "..\\".repeat(x - 1 - v) + ".." : "" : "..\\".repeat(x - v) + b.slice(v).join("\\");
    }
    let r = 0;
    ...
    let f = -1, _ = 0;
    for (; _ < h; _++) {
      const w = e.charCodeAt(r + _);
      if (w !== t.charCodeAt(u + _))
        break;
      w === Ne && (f = _);
    }
    if (_ !== h) {
      ...
      a > h && (e.charCodeAt(r + _) === Ne ? f = _ : _ === 2 && (f = 3)), f === -1 && (f = 0);
    }
    let L = "";
    for (_ = r + f + 1; _ <= s; ++_)
      (_ === s || e.charCodeAt(_) === Ne) && (L += L.length === 0 ? ".." : "\\..");
    return u += f, L.length > 0 ? `${L}${i.slice(u, o)}` : (i.charCodeAt(u) === Ne && ++u, i.slice(u, o));
  },
  toNamespacedPath(e) {
  ...
  parse(e) {
    ...
    if (j(r)) {
      if (i = 1, j(e.charCodeAt(1))) {
        let f = 2, _ = f;
        for (; f < n && !j(e.charCodeAt(f)); )
          f++;
        if (f < n && f !== _) {
          for (_ = f; f < n && j(e.charCodeAt(f)); )
            f++;
          if (f < n && f !== _) {
            for (_ = f; f < n && !j(e.charCodeAt(f)); )
              f++;
    ...
    for (; c >= i; --c) {
      ...
      u === -1 && (o = !1, u = c + 1), r === ht ? s === -1 ? s = c : h !== 1 && (h = 1) : s !== -1 && (h = -1);
    }
  ...
  parse(e) {
    ...
    for (; o >= i; --o) {
      ...
      a === -1 && (u = !1, a = o + 1), h === ht ? r === -1 ? r = o : c !== 1 && (c = 1) : r !== -1 && (c = -1);
    }
    if (a !== -1) {
      const h = s === 0 && n ? 1 : s;
...
const hu = Pe ? he.normalize : ee.normalize;
Pe ? he.isAbsolute : ee.isAbsolute;
const fu = Pe ? he.join : ee.join, gu = Pe ? he.resolve : ee.resolve, mu = Pe ? he.relative : ee.relative, _u = Pe ? he.dirname : ee.dirname;
Pe ? he.basename : ee.basename;
Pe ? he.extname : ee.extname;
Pe ? he.parse : ee.parse;
const mn = Pe ? he.sep : ee.sep, bu = /^\w[\w\d+.-]*$/, du = /^\//, wu = /^\/\//;
function pu(e, t) {
  if (!e.scheme && t)
    throw new Error(
      `[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`
    );
  if (e.scheme && !bu.test(e.scheme))
...
class ce {
  ...
  constructor(t, n, i, r, s, a = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || C, this.authority = t.authority || C, this.path = t.path || C, this.query = t.query || C, this.fragment = t.fragment || C) : (this.scheme = Lu(t, a), this.authority = n || C, this.path = Nu(this.scheme, i || C), this.query = r || C, this.fragment = s || C, pu(this, a));
  }
  get fsPath() {
    return An(this, !1);
  }
  ...
  static joinPath(t, ...n) {
    ...
    let i;
    return It && t.scheme === "file" ? i = ce.file(he.join(An(t, !0), ...n)).path : i = ee.join(t.path, ...n), t.with({ path: i });
  }
  toString(t = !1) {
    return ni(this, t);
  }
...
const ha = {
  ...
  [p.QuestionMark]: "%3F",
  [p.Hash]: "%23",
  [p.OpenSquareBracket]: "%5B",
  [p.CloseSquareBracket]: "%5D",
  [p.AtSign]: "%40",
  [p.ExclamationMark]: "%21",
  [p.DollarSign]: "%24",
  [p.Ampersand]: "%26",
  [p.SingleQuote]: "%27",
  [p.OpenParen]: "%28",
...
function Wi(e, t, n) {
  ...
  for (let s = 0; s < e.length; s++) {
    ...
    if (a >= p.a && a <= p.z || a >= p.A && a <= p.Z || a >= p.Digit0 && a <= p.Digit9 || a === p.Dash || a === p.Period || a === p.Underline || a === p.Tilde || t && a === p.Slash || n && a === p.OpenSquareBracket || n && a === p.CloseSquareBracket || n && a === p.Colon)
...
function Ru(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const i = e.charCodeAt(n);
    i === p.Hash || i === p.QuestionMark ? (t === void 0 && (t = e.substr(0, n)), t += ha[i]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function An(e, t) {
  let n;
  return e.authority && e.path.length > 1 && e.scheme === "file" ? n = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === p.Slash && (e.path.charCodeAt(1) >= p.A && e.path.charCodeAt(1) <= p.Z || e.path.charCodeAt(1) >= p.a && e.path.charCodeAt(1) <= p.z) && e.path.charCodeAt(2) === p.Colon ? t ? n = e.path.substr(1) : n = e.path[1].toLowerCase() + e.path.substr(2) : n = e.path, It && (n = n.replace(/\//g, "\\")), n;
}
function ni(e, t) {
  const n = t ? Ru : Wi;
  ...
  if (a) {
    if (a.length >= 3 && a.charCodeAt(0) === p.Slash && a.charCodeAt(2) === p.Colon) {
      const c = a.charCodeAt(1);
      c >= p.A && c <= p.Z && (a = `/${String.fromCharCode(c + 32)}:${a.substr(3)}`);
    } else if (a.length >= 2 && a.charCodeAt(1) === p.Colon) {
      const c = a.charCodeAt(0);
      c >= p.A && c <= p.Z && (a = `${String.fromCharCode(c + 32)}:${a.substr(2)}`);
    }
    i += n(a, !0, !1);
  }
...
function fa(e) {
  try {
    ...
    return e.length > 3 ? e.substr(0, 3) + fa(e.substr(3)) : e;
  }
}
const Gi = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function ln(e) {
  return e.match(Gi) ? e.replace(Gi, (t) => fa(t)) : e;
}
var et;
(function(e) {
...
class vu {
  constructor() {
    this._tokenizationSupports = /* @__PURE__ */ new Map(), this._factories = /* @__PURE__ */ new Map(), this._onDidChange = new Te(), this.onDidChange = this._onDidChange.event, this._colorMap = null;
  }
  handleChange(t) {
...
U.Array + "", q(815, "array"), U.Boolean + "", q(816, "boolean"), U.Class + "", q(817, "class"), U.Constant + "", q(818, "constant"), U.Constructor + "", q(819, "constructor"), U.Enum + "", q(820, "enumeration"), U.EnumMember + "", q(821, "enumeration member"), U.Event + "", q(822, "event"), U.Field + "", q(823, "field"), U.File + "", q(824, "file"), U.Function + "", q(825, "function"), U.Interface + "", q(826, "interface"), U.Key + "", q(827, "key"), U.Method + "", q(828, "method"), U.Module + "", q(829, "module"), U.Namespace + "", q(830, "namespace"), U.Null + "", q(831, "null"), U.Number + "", q(832, "number"), U.Object + "", q(833, "object"), U.Operator + "", q(834, "operator"), U.Package + "", q(835, "package"), U.Property + "", q(836, "property"), U.String + "", q(837, "string"), U.Struct + "", q(838, "struct"), U.TypeParameter + "", q(839, "type parameter"), U.Variable + "", q(840, "variable");
var lr;
(function(e) {
  e[e.Deprecated = 1] = "Deprecated";
})(lr || (lr = {}));
...
(function(e) {
  ...
  i.set(U.File, N.File), i.set(U.Module, N.Module), i.set(U.Namespace, N.Module), i.set(U.Package, N.Module), i.set(U.Class, N.Class), i.set(U.Method, N.Method), i.set(U.Property, N.Property), i.set(U.Field, N.Field), i.set(U.Constructor, N.Constructor), i.set(U.Enum, N.Enum), i.set(U.Interface, N.Interface), i.set(U.Function, N.Function), i.set(U.Variable, N.Variable), i.set(U.Constant, N.Constant), i.set(U.String, N.Text), i.set(U.Number, N.Value), i.set(U.Boolean, N.Value), i.set(U.Array, N.Value), i.set(U.Object, N.Value), i.set(U.Key, N.Keyword), i.set(U.Null, N.Value), i.set(U.EnumMember, N.EnumMember), i.set(U.Struct, N.Struct), i.set(U.Event, N.Event), i.set(U.Operator, N.Operator), i.set(U.TypeParameter, N.TypeParameter);
  function r(s) {
    let a = i.get(s);
...
At.CtrlCmd = pt.CtrlCmd, At.Shift = pt.Shift, At.Alt = pt.Alt, At.WinCtrl = pt.WinCtrl;
let li = At;
function Uu() {
  return {
    editor: void 0,
    languages: void 0,
    CancellationTokenSource: pl,
    Emitter: Te,
    KeyCode: ii,
    KeyMod: li,
    Position: $,
...
function ku(e, t, n, i, r) {
  ...
  if (e.get(s) !== Pt.Regular || s === p.CarriageReturn || s === p.LineFeed)
    return !0;
  if (r > 0) {
...
function Su(e, t, n, i, r) {
  return ku(e, t, n, i, r) && Fu(e, t, n, i, r);
}
class Iu {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (r === this._prevMatchStartIndex && s === this._prevMatchLength) {
        if (s === 0) {
          Fl(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = r, this._prevMatchLength = s, !this._wordSeparators || Su(this._wordSeparators, t, n, r, s))
        return i;
    } while (i);
    return null;
  }
...
function pi(e, t, n, i, r) {
  if (t = ma(t), r || (r = dn.first(_a)), n.length > r.maxLen) {
    let c = e - r.maxLen / 2;
...
class Ou {
  static computeUnicodeHighlights(t, n, i) {
    ...
    const c = new Iu(null, o), h = [];
    let f = !1, _, L = 0, w = 0, b = 0;
    e: for (let x = r, T = s; x <= T; x++) {
      ...
      do
        if (_ = c.next(R), _) {
          ...
          if (F > 0) {
            const D = R.charCodeAt(F - 1);
            Xn(D) && F--;
          }
          if (B + 1 < v) {
            const D = R.charCodeAt(B - 1);
            Xn(D) && B++;
          }
          const X = R.substring(F, B);
          let E = pi(F + 1, ga, R, 0);
          E && E.endColumn <= F + 1 && (E = null);
          const A = a.shouldHighlightNonBasicASCII(X, E ? E.word : null);
          if (A !== de.None) {
            if (A === de.Ambiguous ? L++ : A === de.Invisible ? w++ : A === de.NonBasicASCII ? b++ : Xa(), h.length >= 1e3) {
              f = !0;
              break e;
            }
            h.push(new k(x, F + 1, x, B + 1));
          }
        }
      while (_);
    }
...
class Ns {
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const a of n) {
        const u = a.codePointAt(0), o = Il(a);
...
class tn extends da {
  constructor(t) {
    super(), this.value = t, this._t = new ba(this.value);
  }
  getValueOfRange(t) {
...
class Se {
  ...
  static insert(t, n) {
    return new Se([new ge(k.fromPositions(t, t), n)]);
  }
  static fromParallelReplacementsUnsorted(t) {
    const n = t.slice().sort(Tt((i) => i.range, k.compareRangesUsingStarts));
    return new Se(n);
  }
  constructor(t) {
    this.replacements = t, Qt(() => mi(t, (n, i) => n.range.getEndPosition().isBeforeOrEqual(i.range.getStartPosition())));
  }
  normalize() {
    const t = [];
  ...
  toReplacement(t) {
    ...
    return new ge(k.fromPositions(n, i), r);
  }
  equals(t) {
...
`) : typeof t == "string" ? this.toString(new tn(t)) : this.replacements.length === 0 ? "" : this.replacements.map((n) => {
      const r = t.getValueOfRange(n.range), s = k.fromPositions(new $(Math.max(1, n.range.startLineNumber - 1), 1), n.range.getStartPosition());
      let a = t.getValueOfRange(s);
      a.length > 10 && (a = "..." + a.substring(a.length - 10));
      const u = k.fromPositions(n.range.getEndPosition(), new $(n.range.endLineNumber + 1, 1));
...
class ge {
  static joinReplacements(t, n) {
    ...
    return new ge(k.fromPositions(i, r), s);
  }
...
`, `
`), r = Ln(n, i), s = rt.ofText(n.substring(0, r)).addToPosition(this.range.getStartPosition()), a = i.substring(r), u = k.fromPositions(s, this.range.getEndPosition());
    return new ge(u, a);
  }
...
`), i = this.text.replaceAll(`\r
`, `
`), r = Nn(n, i), s = rt.ofText(n.substring(0, n.length - r)).addToPosition(this.range.getStartPosition()), a = i.substring(0, i.length - r), u = k.fromPositions(this.range.getStartPosition(), s);
    return new ge(u, a);
  }
...
class Ue {
  static inverse(t, n, i) {
    ...
    let s = 1, a = 1;
    for (const o of t) {
      const c = new Ue(new J(s, o.original.startLineNumber), new J(a, o.modified.startLineNumber));
      c.modified.isEmpty || r.push(c), s = o.original.endLineNumberExclusive, a = o.modified.endLineNumberExclusive;
    }
    const u = new Ue(new J(s, n + 1), new J(a, i + 1));
  ...
  static clip(t, n, i) {
    ...
    for (const s of t) {
      ...
      a && !a.isEmpty && u && !u.isEmpty && r.push(new Ue(a, u));
    }
    return r;
  }
  constructor(t, n) {
  ...
  toRangeMapping() {
    ...
    if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
      ...
      return new Le(new k(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new k(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    } else
      return new Le(new k(
  ...
  toRangeMapping2(t, n) {
    ...
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new Le(k.fromPositions(new $(this.original.startLineNumber, 1), bt(new $(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), k.fromPositions(new $(this.modified.startLineNumber, 1), bt(new $(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new Le(k.fromPositions(bt(new $(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), bt(new $(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), k.fromPositions(bt(new $(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), bt(new $(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new ae();
  }
}
function bt(e, t) {
...
function Es(e, t, n, i = !1) {
  const r = [];
  for (const s of Pa(e.map((a) => Gu(a, t, n)), (a, u) => a.original.intersectsOrTouches(u.original) || a.modified.intersectsOrTouches(u.modified))) {
  ...
  return Qt(() => !i && r.length > 0 && (r[0].modified.startLineNumber !== r[0].original.startLineNumber || n.length.lineCount - r[r.length - 1].modified.endLineNumberExclusive !== t.length.lineCount - r[r.length - 1].original.endLineNumberExclusive) ? !1 : mi(r, (s, a) => a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive && s.original.endLineNumberExclusive < a.original.startLineNumber && s.modified.endLineNumberExclusive < a.modified.startLineNumber)), r;
}
function Gu(e, t, n) {
  let i = 0, r = 0;
...
class zu {
  computeDiff(t, n, i) {
    ...
    for (const o of s.changes) {
      ...
      let h;
      o.modifiedEndLineNumber === 0 ? h = new J(o.modifiedStartLineNumber + 1, o.modifiedStartLineNumber + 1) : h = new J(o.modifiedStartLineNumber, o.modifiedEndLineNumber + 1);
      let f = new qe(c, h, o.charChanges?.map((_) => new Le(new k(
      ...
      u && (u.modified.endLineNumberExclusive === f.modified.startLineNumber || u.original.endLineNumberExclusive === f.original.startLineNumber) && (f = new qe(
        u.original.join(f.original),
        u.modified.join(f.modified),
        u.innerChanges && f.innerChanges ? u.innerChanges.concat(f.innerChanges) : void 0
      ), a.pop()), a.push(f), u = f;
    }
    return Qt(() => mi(a, (o, c) => c.original.startLineNumber - o.original.endLineNumberExclusive === c.modified.startLineNumber - o.modified.endLineNumberExclusive && o.original.endLineNumberExclusive < c.original.startLineNumber && o.modified.endLineNumberExclusive < c.modified.startLineNumber)), new _n(a, [], s.quitEarly);
  }
}
function wa(e, t, n, i) {
...
let As = class {
  ...
  createCharSequence(t, n, i) {
    ...
    for (let o = n; o <= i; o++) {
      ...
      !t && o < i && (r[u] = p.LineFeed, s[u] = o + 1, a[u] = c.length + 1, u++);
    }
    return new ju(r, s, a);
  }
};
class ju {
  ...
  getEndLineNumber(t) {
    return t === -1 ? this.getStartLineNumber(t + 1) : (this._assertIndex(t, this._lineNumbers), this._charCodes[t] === p.LineFeed ? this._lineNumbers[t] + 1 : this._lineNumbers[t]);
  }
  getStartColumn(t) {
    return t > 0 && t === this._columns.length ? this.getEndColumn(t - 1) : (this._assertIndex(t, this._columns), this._columns[t]);
  }
  getEndColumn(t) {
    return t === -1 ? this.getStartColumn(t + 1) : (this._assertIndex(t, this._columns), this._charCodes[t] === p.LineFeed ? 1 : this._columns[t] + 1);
  }
}
class Ut {
...
class Xt {
  ...
  static createFromDiffResult(t, n, i, r, s, a, u) {
    ...
    if (n.originalLength === 0 ? (o = i.getStartLineNumber(n.originalStart) - 1, c = 0) : (o = i.getStartLineNumber(n.originalStart), c = i.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (h = r.getStartLineNumber(n.modifiedStart) - 1, f = 0) : (h = r.getStartLineNumber(n.modifiedStart), f = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
      const L = i.createCharSequence(t, n.originalStart, n.originalStart + n.originalLength - 1), w = r.createCharSequence(t, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1);
      if (L.getElements().length > 0 && w.getElements().length > 0) {
        let b = wa(L, w, s, !0).changes;
        u && (b = Xu(b)), _ = [];
        for (let x = 0, T = b.length; x < T; x++)
          _.push(Ut.createFromDiffChange(b[x], L, w));
      }
    }
    return new Xt(
      o,
...
class pa {
  ...
  computeDiff() {
    ...
    const t = wa(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, i = t.quitEarly;
    ...
    for (let u = -1, o = n.length; u < o; u++) {
      ...
      for (; s < h && a < f; ) {
        ...
        if (_ !== L) {
          {
            let w = ui(_, 1), b = ui(L, 1);
            for (; w > 1 && b > 1; ) {
              const x = _.charCodeAt(w - 2), T = L.charCodeAt(b - 2);
              if (x !== T)
                break;
              w--, b--;
            }
            (w > 1 || b > 1) && this._pushTrimWhitespaceCharChange(r, s + 1, 1, w, a + 1, 1, b);
          }
          {
            let w = oi(_, 1), b = oi(L, 1);
            const x = _.length + 1, T = L.length + 1;
            for (; w < x && b < T; ) {
              const R = _.charCodeAt(w - 1), v = _.charCodeAt(b - 1);
              if (R !== v)
                break;
              w++, b++;
            }
            (w < x || b < T) && this._pushTrimWhitespaceCharChange(r, s + 1, w, x, a + 1, b, T);
          }
        }
        s++, a++;
      }
  ...
  compute(t, n, i = nn.instance, r) {
    ...
    for (let w = 0; w < t.length; w++)
      for (let b = 0; b < n.length; b++) {
        ...
        const x = w === 0 ? 0 : s.get(w - 1, b), T = b === 0 ? 0 : s.get(w, b - 1);
        let R;
        t.getElement(w) === n.getElement(b) ? (w === 0 || b === 0 ? R = 0 : R = s.get(w - 1, b - 1), w > 0 && b > 0 && a.get(w - 1, b - 1) === 3 && (R += u.get(w - 1, b - 1)), R += r ? r(w, b) : 1) : R = -1;
        const v = Math.max(x, T, R);
        if (v === R) {
          const F = w > 0 && b > 0 ? u.get(w - 1, b - 1) : 0;
          u.set(w, b, F + 1), a.set(w, b, 3);
        } else v === x ? (u.set(w, b, 0), a.set(w, b, 1)) : v === T && (u.set(w, b, 0), a.set(w, b, 2));
        s.set(w, b, v);
      }
    const o = [];
    let c = t.length, h = n.length;
    function f(w, b) {
      (w + 1 !== c || b + 1 !== h) && o.push(new re(new P(w + 1, c), new P(b + 1, h))), c = w, h = b;
    }
    let _ = t.length - 1, L = n.length - 1;
    for (; _ >= 0 && L >= 0; )
      a.get(_, L) === 3 ? (f(_, L), _--, L--) : a.get(_, L) === 1 ? _-- : L--;
    return f(-1, -1), o.reverse(), new Je(o, !1);
  }
}
class La {
  compute(t, n, i = nn.instance) {
    ...
    const r = t, s = n;
    function a(b, x) {
      for (; b < r.length && x < s.length && r.getElement(b) === s.getElement(x); )
        b++, x++;
      return b;
    }
    let u = 0;
    ...
    o.set(0, a(0, 0));
    const c = new Zu();
    c.set(0, o.get(0) === 0 ? null : new Ts(null, 0, 0, o.get(0)));
    let h = 0;
    e: for (; ; ) {
      if (u++, !i.isValid())
        return Je.trivialTimedOut(r, s);
      const b = -Math.min(u, s.length + u % 2), x = Math.min(u, r.length + u % 2);
      for (h = b; h <= x; h += 2) {
        const T = h === x ? -1 : o.get(h + 1), R = h === b ? -1 : o.get(h - 1) + 1, v = Math.min(Math.max(T, R), r.length), F = v - h;
        if (v > r.length || F > s.length)
          continue;
        const B = a(v, F);
        o.set(h, B);
        const X = v === T ? c.get(h + 1) : c.get(h - 1);
        if (c.set(h, B !== v ? new Ts(X, v, F, B - v) : X), o.get(h) === r.length && o.get(h) - h === s.length)
          break e;
      }
    }
    let f = c.get(h);
    const _ = [];
    let L = r.length, w = s.length;
    for (; ; ) {
      const b = f ? f.x + f.length : 0, x = f ? f.y + f.length : 0;
      if ((b !== L || x !== w) && _.push(new re(new P(b, L), new P(x, w))), !f)
        break;
      L = f.x, w = f.y, f = f.prev;
    }
...
class Mn {
  ...
  getBoundaryScore(t) {
    const n = Ds(t > 0 ? this.elements[t - 1] : -1), i = Ds(t < this.elements.length ? this.elements[t] : -1);
    if (n === ie.LineBreakCR && i === ie.LineBreakLF)
      return 0;
    if (n === ie.LineBreakLF)
      return 150;
    let r = 0;
    return n !== i && (r += 10, n === ie.WordLower && i === ie.WordUpper && (r += 1)), r += Us(n), r += Us(i), r;
  }
  ...
  findSubWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !dt(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && dt(this.elements[n - 1]) && !Ms(this.elements[n]); )
      n--;
    let i = t;
    for (; i < this.elements.length && dt(this.elements[i]) && !Ms(this.elements[i]); )
      i++;
    return new P(n, i);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = kt(this.firstElementOffsetByLineIdx, (r) => r <= t.start) ?? 0, i = Ia(this.firstElementOffsetByLineIdx, (r) => t.endExclusive <= r) ?? this.elements.length;
    return new P(n, i);
  }
}
function dt(e) {
  return e >= p.a && e <= p.z || e >= p.A && e <= p.Z || e >= p.Digit0 && e <= p.Digit9;
}
function Ms(e) {
  return e >= p.A && e <= p.Z;
}
...
function Ds(e) {
  return e === p.LineFeed ? ie.LineBreakLF : e === p.CarriageReturn ? ie.LineBreakCR : ci(e) ? ie.Space : e >= p.a && e <= p.z ? ie.WordLower : e >= p.A && e <= p.Z ? ie.WordUpper : e >= p.Digit0 && e <= p.Digit9 ? ie.WordNumber : e === -1 ? ie.End : e === p.Comma || e === p.Semicolon ? ie.Separator : ie.Other;
}
function Cu(e, t, n, i, r, s) {
  let { moves: a, excludedChanges: u } = to(e, t, n, s);
  if (!s.isValid())
    return [];
  const o = e.filter((h) => !u.has(h)), c = no(o, i, r, t, n, s);
  return Oa(a, c), a = io(a), a = a.filter((h) => {
    const f = h.original.toOffsetRange().slice(t).map((L) => L.trim());
    return f.join(`
`).length >= 15 && eo(f, (L) => L.length >= 2) >= 2;
  }), a = ro(e, a), a;
}
function eo(e, t) {
  let n = 0;
...
function to(e, t, n, i) {
  const r = [], s = e.filter((o) => o.modified.isEmpty && o.original.length >= 3).map((o) => new Tn(o.original, t, o)), a = new Set(e.filter((o) => o.original.isEmpty && o.modified.length >= 3).map((o) => new Tn(o.modified, n, o))), u = /* @__PURE__ */ new Set();
  for (const o of s) {
    let c = -1, h;
    for (const f of a) {
    ...
    if (c > 0.9 && h && (a.delete(h), r.push(new Ue(o.range, h.range)), u.add(o.source), u.add(h.source)), !i.isValid())
...
function no(e, t, n, i, r, s) {
  ...
  for (const _ of e)
    for (let L = _.original.startLineNumber; L < _.original.endLineNumberExclusive - 2; L++) {
      const w = `${t[L - 1]}:${t[L + 1 - 1]}:${t[L + 2 - 1]}`;
      u.add(w, { range: new J(L, L + 3) });
    }
  const o = [];
  e.sort(Tt((_) => _.modified.startLineNumber, Gt));
  for (const _ of e) {
    let L = [];
    for (let w = _.modified.startLineNumber; w < _.modified.endLineNumberExclusive - 2; w++) {
      const b = `${n[w - 1]}:${n[w + 1 - 1]}:${n[w + 2 - 1]}`, x = new J(w, w + 3), T = [];
      u.forEach(b, ({ range: R }) => {
        for (const F of L)
          if (F.originalLineRange.endLineNumberExclusive + 1 === R.endLineNumberExclusive && F.modifiedLineRange.endLineNumberExclusive + 1 === x.endLineNumberExclusive) {
            F.originalLineRange = new J(
              F.originalLineRange.startLineNumber,
              R.endLineNumberExclusive
            ), F.modifiedLineRange = new J(
  ...
  o.sort(Va(Tt((_) => _.modifiedLineRange.length, Gt)));
  const c = new Be(), h = new Be();
  for (const _ of o) {
    const L = _.modifiedLineRange.startLineNumber - _.originalLineRange.startLineNumber, w = c.subtractFrom(_.modifiedLineRange), b = h.subtractFrom(_.originalLineRange).getWithDelta(L), x = w.getIntersection(b);
    for (const T of x.ranges) {
      if (T.length < 3)
        continue;
      const R = T, v = T.delta(-L);
      a.push(new Ue(v, R)), c.addRange(R), h.addRange(v);
    }
  }
  a.sort(Tt((_) => _.original.startLineNumber, Gt));
  const f = new bn(e);
  for (let _ = 0; _ < a.length; _++) {
    const L = a[_], w = f.findLastMonotonous((X) => X.original.startLineNumber <= L.original.startLineNumber), b = kt(e, (X) => X.modified.startLineNumber <= L.modified.startLineNumber), x = Math.max(L.original.startLineNumber - w.original.startLineNumber, L.modified.startLineNumber - b.modified.startLineNumber), T = f.findLastMonotonous((X) => X.original.startLineNumber < L.original.endLineNumberExclusive), R = kt(e, (X) => X.modified.startLineNumber < L.modified.endLineNumberExclusive), v = Math.max(T.original.endLineNumberExclusive - L.original.endLineNumberExclusive, R.modified.endLineNumberExclusive - L.modified.endLineNumberExclusive);
    let F;
    for (F = 0; F < x; F++) {
      const X = L.original.startLineNumber - F - 1, E = L.modified.startLineNumber - F - 1;
      if (X > i.length || E > r.length || c.contains(E) || h.contains(X) || !ks(i[X - 1], r[E - 1], s))
        break;
    }
    F > 0 && (h.addRange(new J(L.original.startLineNumber - F, L.original.startLineNumber)), c.addRange(new J(L.modified.startLineNumber - F, L.modified.startLineNumber)));
    let B;
    for (B = 0; B < v; B++) {
    ...
    ))), (F > 0 || B > 0) && (a[_] = new Ue(new J(
      L.original.startLineNumber - F,
      L.original.endLineNumberExclusive + B
    ), new J(
      L.modified.startLineNumber - F,
      L.modified.endLineNumberExclusive + B
    )));
  }
  return a;
...
function ks(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const r = new La().compute(new Mn([e], new k(1, 1, 1, e.length), !1), new Mn([t], new k(1, 1, 1, t.length), !1), n);
  let s = 0;
...
function ro(e, t) {
  const n = new bn(e);
  return t = t.filter((i) => {
    const r = n.findLastMonotonous((u) => u.original.startLineNumber < i.original.endLineNumberExclusive) || new Ue(new J(1, 1), new J(1, 1)), s = kt(e, (u) => u.modified.startLineNumber < i.modified.endLineNumberExclusive);
    return r !== s;
  }), t;
}
function Fs(e, t, n) {
  let i = n;
  return i = Ss(e, t, i), i = Ss(e, t, i), i = so(e, t, i), i;
}
function Ss(e, t, n) {
  if (n.length === 0)
    return n;
...
function so(e, t, n) {
  ...
  for (let i = 0; i < n.length; i++) {
    ...
    s.seq1Range.isEmpty ? n[i] = Is(s, e, t, u, o) : s.seq2Range.isEmpty && (n[i] = Is(s.swap(), t, e, o, u).swap());
  }
  return n;
}
function Is(e, t, n, i, r) {
  ...
  let o = 0, c = -1;
  for (let h = -a; h <= u; h++) {
    const f = e.seq2Range.start + h, _ = e.seq2Range.endExclusive + h, L = e.seq1Range.start + h, w = t.getBoundaryScore(L) + n.getBoundaryScore(f) + n.getBoundaryScore(_);
    w > c && (c = w, o = h);
  }
  return e.delta(o);
}
...
function Ps(e, t, n, i, r = !1) {
  ...
  function o(h, f) {
    if (h.offset1 < u.offset1 || h.offset2 < u.offset2)
      return;
    const _ = i(e, h.offset1), L = i(t, h.offset2);
    if (!_ || !L)
      return;
    let w = new re(_, L);
    const b = w.intersect(f);
    let x = b.seq1Range.length, T = b.seq2Range.length;
    for (; s.length > 0; ) {
      const R = s[0];
      if (!(R.seq1Range.intersects(w.seq1Range) || R.seq2Range.intersects(w.seq2Range)))
        break;
      const F = i(e, R.seq1Range.start), B = i(t, R.seq2Range.start), X = new re(F, B), E = X.intersect(R);
      if (x += E.seq1Range.length, T += E.seq2Range.length, w = w.join(X), w.seq1Range.endExclusive >= R.seq1Range.endExclusive)
        s.shift();
      else
        break;
    }
    (r && x + T < w.seq1Range.length + w.seq2Range.length || x + T < (w.seq1Range.length + w.seq2Range.length) * 2 / 3) && a.push(w), u = w.getEndExclusives();
  }
  for (; s.length > 0; ) {
    const h = s.shift();
...
function uo(e, t, n) {
  ...
  do {
    ...
    for (let u = 1; u < i.length; u++) {
      let h = function(_, L) {
        const w = new P(c.seq1Range.endExclusive, o.seq1Range.start);
        return e.getText(w).replace(/\s/g, "").length <= 4 && (_.seq1Range.length + _.seq2Range.length > 5 || L.seq1Range.length + L.seq2Range.length > 5);
      };
...
function oo(e, t, n) {
    ...
    for (let o = 1; o < i.length; o++) {
      let f = function(L, w) {
        ...
        if (T.length > 20 || T.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const R = e.countLinesIn(L.seq1Range), v = L.seq1Range.length, F = t.countLinesIn(L.seq2Range), B = L.seq2Range.length, X = e.countLinesIn(w.seq1Range), E = w.seq1Range.length, A = t.countLinesIn(w.seq2Range), D = w.seq2Range.length, W = 2 * 40 + 50;
        function z(G) {
          return Math.min(G, W);
        }
        return Math.pow(Math.pow(z(R * 40 + v), 1.5) + Math.pow(z(F * 40 + B), 1.5), 1.5) + Math.pow(Math.pow(z(X * 40 + E), 1.5) + Math.pow(z(A * 40 + D), 1.5), 1.5) > (W ** 1.5) ** 1.5 * 1.3;
      };
  ...
  return Ba(i, (u, o, c) => {
    ...
    f(L) && (h = h.deltaStart(-L.length));
    const w = e.getText(new P(o.seq1Range.endExclusive, _.endExclusive));
    f(w) && (h = h.deltaEnd(w.length));
    const b = re.fromOffsetPairs(u ? u.getEndExclusives() : Ye.zero, c ? c.getStarts() : Ye.max), x = h.intersect(b);
...
function Bs(e) {
  let t = 0;
  for (; t < e.length && (e.charCodeAt(t) === p.Space || e.charCodeAt(t) === p.Tab); )
    t++;
  return t;
}
class co {
  ...
  computeDiff(t, n, i) {
    ...
    const o = t.map((E) => u(E.trim())), c = n.map((E) => u(E.trim())), h = new ys(o, t), f = new ys(c, n), _ = h.length + f.length < 1700 ? this.dynamicProgrammingDiffing.compute(h, f, r, (E, A) => t[E] === n[A] ? n[A].length === 0 ? 0.1 : 1 + Math.log(1 + n[A].length) : 0.99) : this.myersDiffingAlgorithm.compute(h, f, r);
    let L = _.diffs, w = _.hitTimeout;
    L = Fs(h, f, L), L = uo(h, f, L);
    const b = [], x = (E) => {
      if (s)
        for (let A = 0; A < E; A++) {
          const D = T + A, W = R + A;
          if (t[D] !== n[W]) {
            const z = this.refineDiff(t, n, new re(new P(D, D + 1), new P(W, W + 1)), r, s, i);
    ...
    let T = 0, R = 0;
    for (const E of L) {
      Qt(() => E.seq1Range.start - T === E.seq2Range.start - R);
      const A = E.seq1Range.start - T;
      x(A), T = E.seq1Range.endExclusive, R = E.seq2Range.endExclusive;
      const D = this.refineDiff(t, n, E, r, s, i);
      D.hitTimeout && (w = !0);
      for (const W of D.mappings)
        b.push(W);
    }
    x(t.length - T);
    const v = new un(t), F = new un(n), B = Es(b, v, F);
    let X = [];
    return i.computeMoves && (X = this.computeMoves(B, t, n, o, c, r, s, i)), Qt(() => {
      function E(D, W) {
        if (D.lineNumber < 1 || D.lineNumber > W.length)
          return !1;
        const z = W[D.lineNumber - 1];
        return !(D.column < 1 || D.column > z.length + 1);
      }
      function A(D, W) {
        return !(D.startLineNumber < 1 || D.startLineNumber > W.length + 1 || D.endLineNumberExclusive < 1 || D.endLineNumberExclusive > W.length + 1);
      }
      for (const D of B) {
        if (!D.innerChanges)
          return !1;
        for (const W of D.innerChanges)
          if (!(E(W.modifiedRange.getStartPosition(), n) && E(W.modifiedRange.getEndPosition(), n) && E(W.originalRange.getStartPosition(), t) && E(W.originalRange.getEndPosition(), t)))
            return !1;
        if (!A(D.modified, n) || !A(D.original, t))
          return !1;
      }
      return !0;
    }), new _n(B, X, w);
  ...
  computeMoves(t, n, i, r, s, a, u, o) {
    return Cu(t, n, i, r, s, a).map((f) => {
      const _ = this.refineDiff(n, i, new re(f.original.toOffsetRange(), f.modified.toOffsetRange()), a, u, o), L = Es(_.mappings, new un(n), new un(i), !0);
      return new Li(f, L);
    });
  }
  refineDiff(t, n, i, r, s, a) {
    const o = ho(i).toRangeMapping2(t, n), c = new Mn(t, o.originalRange, s), h = new Mn(n, o.modifiedRange, s), f = c.length + h.length < 500 ? this.dynamicProgrammingDiffing.compute(c, h, r) : this.myersDiffingAlgorithm.compute(c, h, r);
    let _ = f.diffs;
    return _ = Fs(c, h, _), _ = Ps(c, h, _, (w, b) => w.findWordContaining(b)), a.extendToSubwords && (_ = Ps(c, h, _, (w, b) => w.findSubWordContaining(b), !0)), _ = ao(c, h, _), _ = oo(c, h, _), {
      mappings: _.map((w) => new Le(c.translateRange(w.seq1Range), h.translateRange(w.seq2Range))),
      hitTimeout: f.hitTimeout
    };
  }
}
function ho(e) {
  return new Ue(new J(e.seq1Range.start + 1, e.seq1Range.endExclusive + 1), new J(e.seq2Range.start + 1, e.seq2Range.endExclusive + 1));
}
const Vt = {
  getLegacy: () => new zu(),
  getDefault: () => new co()
...
class Me {
  ...
  static toRGBA(t) {
    ...
    if (i === 0)
      ...
      a = Me._hue2rgb(h, c, n + 1 / 3), u = Me._hue2rgb(h, c, n), o = Me._hue2rgb(h, c, n - 1 / 3);
    }
...
class Lt {
  ...
  static toRGBA(t) {
    ...
    let [c, h, f] = [0, 0, 0];
    return n < 60 ? (c = a, h = u) : n < 120 ? (c = u, h = a) : n < 180 ? (h = a, f = u) : n < 240 ? (h = u, f = a) : n < 300 ? (c = u, f = a) : n <= 360 && (c = a, f = u), c = Math.round((c + o) * 255), h = Math.round((h + o) * 255), f = Math.round((f + o) * 255), new d(c, h, f, s);
  }
}
const Q = class Q {
  static fromHex(t) {
  ...
  constructor(t) {
    if (t)
      if (t instanceof d)
        ...
        this._hsla = t, this.rgba = Me.toRGBA(t);
  ...
  equals(t) {
    return !!t && d.equals(this.rgba, t.rgba) && Me.equals(this.hsla, t.hsla) && Lt.equals(this.hsva, t.hsva);
  }
  ...
  lighten(t) {
    return new Q(new Me(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
  }
  darken(t) {
    return new Q(new Me(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
  }
...
(function(e) {
  (function(t) {
    (function(n) {
      ...
      n.formatHex = o;
      function c(b, x = !1) {
        return x && b.rgba.a === 1 ? e.Format.CSS.formatHex(b) : `#${u(b.rgba.r)}${u(b.rgba.g)}${u(b.rgba.b)}${u(Math.round(b.rgba.a * 255))}`;
      }
      n.formatHexA = c;
      function h(b) {
      ...
      function f(b) {
        ...
        if (b.startsWith("rgba(")) {
          const x = b.match(/rgba\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+), *(?<a>(?:\+|-)?\d+(\.\d+)?)\)/);
          if (!x)
            throw new Error("Invalid color format " + b);
          const T = parseInt(x.groups?.r ?? "0"), R = parseInt(x.groups?.g ?? "0"), v = parseInt(x.groups?.b ?? "0"), F = parseFloat(x.groups?.a ?? "0");
          return new e(new d(T, R, v, F));
        }
        if (b.startsWith("rgb(")) {
          const x = b.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/);
          if (!x)
            throw new Error("Invalid color format " + b);
          const T = parseInt(x.groups?.r ?? "0"), R = parseInt(x.groups?.g ?? "0"), v = parseInt(x.groups?.b ?? "0");
          return new e(new d(T, R, v));
        }
        return _(b);
      }
      n.parse = f;
      ...
      function L(b) {
        const x = b.length;
        if (x === 0 || b.charCodeAt(0) !== p.Hash)
          return null;
        if (x === 7) {
          const T = 16 * w(b.charCodeAt(1)) + w(b.charCodeAt(2)), R = 16 * w(b.charCodeAt(3)) + w(b.charCodeAt(4)), v = 16 * w(b.charCodeAt(5)) + w(b.charCodeAt(6));
          return new e(new d(T, R, v, 1));
        }
        if (x === 9) {
          const T = 16 * w(b.charCodeAt(1)) + w(b.charCodeAt(2)), R = 16 * w(b.charCodeAt(3)) + w(b.charCodeAt(4)), v = 16 * w(b.charCodeAt(5)) + w(b.charCodeAt(6)), F = 16 * w(b.charCodeAt(7)) + w(b.charCodeAt(8));
          return new e(new d(T, R, v, F / 255));
        }
        if (x === 4) {
          const T = w(b.charCodeAt(1)), R = w(b.charCodeAt(2)), v = w(b.charCodeAt(3));
          return new e(new d(16 * T + T, 16 * R + R, 16 * v + v));
        }
        if (x === 5) {
          const T = w(b.charCodeAt(1)), R = w(b.charCodeAt(2)), v = w(b.charCodeAt(3)), F = w(b.charCodeAt(4));
          return new e(new d(16 * T + T, 16 * R + R, 16 * v + v, (16 * F + F) / 255));
        }
        return null;
      }
      n.parseHex = L;
...
function fo(e, t) {
  if (!e)
    return;
  const n = yt.Format.CSS.parseHex(t);
  if (n)
    return {
      range: e,
...
function Vs(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = Na(r), a = new yt(new Me(
    s[0],
    s[1] / 100,
    s[2] / 100,
    n ? s[3] : 1
...
function go(e) {
  ...
  if (i.length > 0)
    for (const r of i) {
      ...
      } else a === "#" && (o = fo(qt(e, r), a + u));
      o && t.push(o);
    }
  return t;
}
function mo(e) {
  return !e || typeof e.getValue != "function" || typeof e.positionAt != "function" ? [] : go(e);
}
const _o = /^-+|-+$/g, qs = 100, bo = 5;
function wo(e, t) {
  let n = [];
...
function Lo(e, t) {
  ...
  if (!t.markSectionHeaderRegex || t.markSectionHeaderRegex.trim() === "")
    return n;
  const r = Du(t.markSectionHeaderRegex), s = new RegExp(t.markSectionHeaderRegex, `gdm${r ? "s" : ""}`);
  if (Rl(s))
    return n;
  for (let a = 1; a <= i; a += qs - bo) {
...
`);
    ...
    let h;
    for (; (h = s.exec(c)) !== null; ) {
      const f = c.substring(0, h.index), _ = (f.match(/\n/g) || []).length, L = a + _, w = h[0].split(`
`), b = w.length, x = L + b - 1, T = f.lastIndexOf(`
`) + 1, R = h.index - T + 1, v = w[w.length - 1], F = b === 1 ? R + h[0].length : v.length + 1, B = {
        startLineNumber: L,
        startColumn: R,
        endLineNumber: x,
        endColumn: F
      }, X = (h.groups ?? {}).label ?? "", E = ((h.groups ?? {}).separator ?? "") !== "", A = {
        range: B,
        text: X,
        hasSeparatorLine: E,
...
function Ke(e) {
  return e === p.Slash || e === p.Backslash;
}
function xa(e) {
...
function Hs(e, t = ee.sep) {
  ...
  if (Ke(i)) {
    ...
    return t;
  } else if (Ro(i) && e.charCodeAt(1) === p.Colon)
...
class Ao {
  ...
  setServerRootPath(t, n) {
    this._serverRootPath = ee.join(n ?? "/", To(t));
  }
  getServerRootPath() {
    return this._serverRootPath;
  }
  get _remoteResourcesPath() {
    return ee.join(this._serverRootPath, me.vscodeRemoteResource);
  }
  set(t, n, i) {
  ...
  rewrite(t) {
    ...
    return typeof s == "string" && (a += `&${Eo}=${encodeURIComponent(s)}`), ce.from({
      scheme: ml ? this._preferredWebSchema : me.vscodeRemoteResource,
      authority: `${i}:${r}`,
...
const Mo = "vscode-app", vt = class vt {
  constructor() {
  ...
  uriToBrowserUri(t) {
    return t.scheme === me.vscodeRemote ? vo.rewrite(t) : t.scheme === me.file && (gl || bl === `${me.vscodeFileResource}://${vt.FALLBACK_AUTHORITY}`) ? t.with({
  ...
  uriToFileUri(t) {
    return t.scheme === me.vscodeFileResource ? t.with({
      scheme: me.file,
...
class Uo {
  ...
  dirname(t) {
    if (t.path.length === 0)
      return t;
    let n;
    return t.scheme === me.file ? n = ce.file(_u($e(t))).path : (n = ee.dirname(t.path), t.authority && n.length && n.charCodeAt(0) !== p.Slash && (console.error(`dirname("${t.toString})) resulted in a relative path`), n = "/")), t.with({
      path: n
    });
  }
  normalizePath(t) {
    if (!t.path.length)
      return t;
    let n;
    return t.scheme === me.file ? n = ce.file(hu($e(t))).path : n = ee.normalize(t.path), t.with({
      path: n
    });
  }
  relativePath(t, n) {
  ...
  isEqualAuthority(t, n) {
    return t === n || t !== void 0 && n !== void 0 && Ml(t, n);
  }
  hasTrailingPathSeparator(t, n = mn) {
    if (t.scheme === me.file) {
      const i = $e(t);
      return i.length > Hs(i).length && i[i.length - 1] === n;
    } else {
      const i = t.path;
      return i.length > 1 && i.charCodeAt(i.length - 1) === p.Slash && !/^[a-zA-Z]:(\/$|\\$)/.test(t.fsPath);
    }
  }
  removeTrailingPathSeparator(t, n = mn) {
    return zs(t, n) ? t.with({ path: t.path.substr(0, t.path.length - 1) }) : t;
  }
  addTrailingPathSeparator(t, n = mn) {
    let i = !1;
    if (t.scheme === me.file) {
      const r = $e(t);
      ...
      n = "/";
      const r = t.path;
      i = r.length === 1 && r.charCodeAt(r.length - 1) === p.Slash;
    }
...
const we = class we {
  ...
  constructor(t, n) {
    this._state = ke.Initial, this._results = [], this._error = null, this._onReturn = n, this._onStateChanged = new Te(), queueMicrotask(async () => {
      const i = {
    ...
    return {
      next: async () => {
        do {
          ...
          await wn.toPromise(this._onStateChanged.event);
        } while (!0);
      },
...
const Io = "workerTextModelSync";
class Po {
  constructor() {
    this._models = /* @__PURE__ */ Object.create(null);
  }
  bindToServer(t) {
    t.setChannel(Io, this);
  }
  getModel(t) {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new yo(ce.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class yo extends So {
  ...
  getWordAtPosition(t, n) {
    const i = pi(t.column, ma(n), this._lines[t.lineNumber - 1], 0);
    return i ? new k(
      t.lineNumber,
      i.startColumn,
      t.lineNumber,
  ...
  compose(t) {
    ...
    for (const u of i.replacements) {
      ...
      if (!c)
        ...
        if (_ > 0) {
          const x = c.slice(P.emptyAt(f), new P(0, _));
          s.push(x);
        }
        if (!h)
          throw new ae("Invariant violation: lastIntersecting is undefined");
        const L = h.replaceRange.endExclusive + a - u.replaceRange.endExclusive;
        if (L > 0) {
          const x = h.slice(P.ofStartAndLength(h.replaceRange.endExclusive, 0), new P(
            h.getNewLength() - L,
            h.getNewLength()
          ));
          r.unshift(x), a -= x.getNewLength() - x.replaceRange.length;
        }
        const w = new P(f, u.replaceRange.endExclusive - a), b = u.slice(w, new P(0, u.getNewLength()));
        s.push(b);
      }
    }
    for (; ; ) {
...
class Ea extends Ra {
  ...
  mapData(t) {
    return new fi(this.replacements.map((n) => new Ve(n.replaceRange, n.newText, t(n))));
  }
}
class Aa extends Bo {
  constructor(t, n) {
...
const pe = class pe extends Ea {
  ...
  static replace(t, n) {
    return new pe([new le(t, n)]);
  }
  static insert(t, n) {
    return new pe([new le(P.emptyAt(t), n)]);
  }
  static delete(t) {
    return new pe([new le(t, "")]);
  }
  static fromJson(t) {
    return new pe(t.map(le.fromJson));
  }
  static compose(t) {
    if (t.length === 0)
      return pe.empty;
  ...
  static composeSequentialReplacements(t) {
    ...
    for (const r of t) {
      const s = i.at(-1);
      !s || r.replaceRange.isBefore(s.replaceRange) ? i.push(r) : (n = n.compose(pe.create(i.reverse())), i = [r]);
    }
    return n = n.compose(pe.create(i.reverse())), n;
  }
  constructor(t) {
    super(t);
  }
...
const Fe = class Fe extends Ea {
  ...
  static replace(t, n, i) {
    return new Fe([new Ve(t, n, i)]);
  }
  static insert(t, n, i) {
    return new Fe([new Ve(P.emptyAt(t), n, i)]);
  }
  static delete(t, n) {
    return new Fe([new Ve(t, "", n)]);
  }
  static compose(t) {
    if (t.length === 0)
      return Fe.empty;
...
const tt = class tt {
  constructor(t = null) {
    this._foreignModule = t, this._workerTextModelSyncServer = new Po();
  }
  dispose() {
  }
  async $ping() {
  ...
  $computeStringDiff(t, n, i, r) {
    const s = r === "advanced" ? Vt.getDefault() : Vt.getLegacy(), a = new tn(t), u = a.getLines(), o = new tn(n), c = o.getLines(), h = s.computeDiff(u, c, { ignoreTrimWhitespace: !1, maxComputationTimeMs: i.maxComputationTimeMs, computeMoves: !1, extendToSubwords: !1 }), f = qe.toTextEdit(h.changes, o);
  ...
  async $computeMoreMinimalEdits(t, n, i) {
    ...
    for (let { range: o, text: c, eol: h } of n) {
      ...
      if (c = c.replace(/\r\n|\n|\r/g, r.eol), f === c)
        continue;
      if (Math.max(c.length, f.length) > tt._diffLimit) {
        s.push({ range: o, text: c });
        continue;
      }
      const _ = zl(f, c, i), L = r.offsetAt(k.lift(o).getStartPosition());
      for (const w of _) {
        const b = r.positionAt(L + w.originalStart), x = r.positionAt(L + w.originalStart + w.originalLength), T = {
          text: c.substr(w.modifiedStart, w.modifiedLength),
  ...
  $computeHumanReadableDiff(t, n, i) {
    ...
    for (let { range: u, text: o, eol: c } of n) {
      ...
      const f = h.split(/\r\n|\n|\r/), _ = o.split(/\r\n|\n|\r/), L = Vt.getDefault().computeDiff(f, _, i), w = k.lift(u).getStartPosition();
      for (const T of L.changes)
        if (T.innerChanges)
          for (const R of T.innerChanges)
            s.push({
              range: k.fromPositions(b(w, R.originalRange.getStartPosition()), b(w, R.originalRange.getEndPosition())),
  ...
  async $textualSuggest(t, n, i, r) {
    const s = new In(), a = new RegExp(i, r), u = /* @__PURE__ */ new Set();
    e: for (const o of t) {
      const c = this._getModel(o);
      if (c) {
        for (const h of c.words(a))
          if (!(h === n || !isNaN(Number(h))) && (u.add(h), u.size > tt._suggestionsLimit))
            break e;
      }
    }
...
let gi = tt;
typeof importScripts == "function" && (globalThis.monaco = Uu());
Gl(() => new gi(null));
